            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                            <video width="inherit" style="width:inherit" controls>
                              <source src="<?=base_url("assets/uploads/".get_current_url()).'/'.$detail_info->video ?>" type="video/mp4">
                            </video>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                            <div class="form-group">
                              <label>Video Sub-Title</label><span style="color:red;vertical-align:middle;">  *</span>
                      ...
                      <div class="editcontent2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $detail_info->action_button_link == 'image_popup' ? 'display:block' : 'display:none' ?>">
                            ...
                            <div class="form-group action_fields action_event_forms" style="<?= $detail_info->action_button_link == 'eventForms' ? 'display:block' : 'display:none' ?>">
