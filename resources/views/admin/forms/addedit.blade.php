                        ...
                        <tr data-type="{{ $sngl['type'] }}" data-id="{{$sngl['id']}}">
                            <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link" name="action_button_link[]">
                                                <option value="link" <?= $sngl['action_type'] == 'link' ? 'selected' : '' ?>>Link to Outside Site</option>
                                                <option value="call" <?= $sngl['action_type'] == 'call' ? 'selected' : '' ?>>Call</option>
                                                <option value="sms" <?= $sngl['action_type'] == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                                <option value="email" <?= $sngl['action_type'] == 'email' ? 'selected' : '' ?>>Email</option>
                                                <option value="address" <?= $sngl['action_type'] == 'address' ? 'selected' : '' ?>>Business Address</option>
                                                <option value="customforms" <?= $sngl['action_type'] == 'customforms' ? 'selected' : '' ?>>Link to Form</option>
                                                <option value="image_popup" <?= $sngl['action_type'] == 'image_popup' ? 'selected' : '' ?>>Popup - Image</option>
                                                <option value="text_popup" <?= $sngl['action_type'] == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                                <option value="video" <?= $sngl['action_type'] == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                                <option value="stripe" <?= $sngl['action_type'] == 'stripe' ? 'selected' : '' ?>>Popup - Payment</option>
                                    ...
                                    <div class="col-md-1">
                                                                        <br>
                                                                        <button type="button" class="btn btn-primary btnremovecantactformfield remove-form-btn" data-id="{{$sngl['id']}}">X</button>
                                                                    </div>
