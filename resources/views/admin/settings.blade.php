  ...
  <?php if (check_auth_permission('contact_forms')) { ?>
    <div class="contentdiv">
      ...
      <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'contact_forms_bluebar' ? 'display:block;' : '' ?>">
        ...
        <form action="{{url('savecontactform')}}" class="data-form" method="post" enctype="multipart/form-data">
          @csrf
          <div class="content2">
            <div class="row">
              <div class="col-md-12">
                <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                  <div class="d-flex align-items-center">
                    <div class="title-2">Terms of Service</div>
                  </div>
                  <img src="{{url('assets')}}/admin2/img/arrow-down-grey.png" alt="" width="12px" class="">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group quilleditor-div ">
                    <label>Terms of Sevice Text</label>
                    <textarea name="terms_of_service" class="myinput2 editordata hidden" rows="10"><?= $formsSettings->terms_of_service ?></textarea>
                    <div class="quilleditor">
                      <?= $formsSettings->terms_of_service ?>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="editcontent2">
                    <div class="singlecontactform">
                      <div class="row">
                        ...
                        <div class="col-md-3" align="center">
                          <div class="form-group">
                            <label for="bannertext"> Contact Permission</label>
                            <br>
                            <label class="switch">
                              <input type="checkbox" class="show_map" name="permission[<?= $single->id ?>]" <?= $single->permission ? 'checked' : '' ?>>
                              <span class="slider round"></span>
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3 mt-3">
                          <div class="form-group quilleditor-div ">
                            <label>Terms of Service Check Box Text</label>
                            <textarea name="tos_chkbox_text[]" class="myinput2 editordata hidden" rows="10"><?= $single->tos_chkbox_text ?></textarea>
                            <div class="quilleditor">
                              <?= $single->tos_chkbox_text ?>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="row mb-17">
              ...
              <div class="col-md-3 ">
                <div class="form-group seo_block_bg_picker" style="display:<?php echo  $seoSettings->seo_block_override_bg ? 'block' : 'none' ?>">
                  ...
                  <label>SEO Block Background Color</label>
  ...
  <?php if (check_auth_permission('nav_bar')) { ?>
    <div class="contentdiv">
      ...
      <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'nav_bar_bluebar' ? 'display:block;' : '' ?>">
        <?php if (check_auth_permission(['navbar'])) { ?>
          <div class="row mb-17">
                ...
                <div class="col-md-3">
                  <div class="form-group mb-30">
                    ...
                    <select name="section[{{$navBarItem->id}}]" class="myinput2 link_section_option action_button_selection">
                      <option value="link" <?= $navBarItem->link_type == 'link' ? 'selected' : '' ?>>Link to Outside Site</option>
                      <option value="call" <?= $navBarItem->link_type == 'call' ? 'selected' : '' ?>>Call</option>
                      <option value="sms" <?= $navBarItem->link_type == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                      <option value="email" <?= $navBarItem->link_type == 'email' ? 'selected' : '' ?>>Email</option>
                      <option value="address" <?= $navBarItem->link_type == 'address' ? 'selected' : '' ?>>Business Address</option>
                      <option value="customforms" <?= $navBarItem->link_type == "customforms" ? 'selected' : '' ?>>Link to Form</option>
                      <option value="image_popup" <?= $navBarItem->link_type == "image_popup" ? 'selected' : '' ?>>Popup - Image</option>
                      <option value="text_popup" <?= $navBarItem->link_type == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                      <option value="video" <?= $navBarItem->link_type == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                      <option value="google_map" <?= $navBarItem->link_type == 'google_map' ? 'selected' : '' ?>>Map</option>
                      <?php foreach ($front_sections as $single) { ?>
                        <option value="<?= $single->slug ?>" <?= $single->slug == $navBarItem->link_type ? 'selected' : '' ?>><?= $single->name ?></option>
                      <?php } ?>
                    </select>
                    <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $navBarItem->link_type == 'image_popup' ? 'display:block' : 'display:none' ?>">
                      <label for="customFile">Upload Images</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="popup_action_images[{{$navBarItem->id}}][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                    ...
                    <div class="form-group action_fields audio_upload" name="feature_action_audio" style="<?= $navBarItem->link_type == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                      <label for="customFile">Select File</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="audio_file[{{$navBarItem->id}}]" id="customFile" accept=".mp3">
                    ...
                    <div class="form-group action_fields action_event_forms" style="<?= $navBarItem->link_type == 'attendhub' ? 'display:block' : 'display:none' ?>">
                      <select class="myinput2" name="left_action_button_event_form[]" id="customforms">
