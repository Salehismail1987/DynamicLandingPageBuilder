        ...
        <div class="card mb-4 card-border">
            <div class="card-body card-body-padding-border">
              <div class="d-flex justify-content-between align-items-center">
                ...
                @if (false)
                    <button type="button" class="btn btn-sm btn-primary mb-10" data-toggle="modal" data-is_custom_modal="YES" data-target="#modalcustomforms<?=getCustomformEncodedID($formdata->form_id)?>">Open Form</button>
                @endif
            </div>
          </div>
        </div>
