                      ...
                      <?php foreach ($reviews_staff as $single) { ?>
                        <tr class="review_rows">
                          ...
                          <div class="row reviewdiv" data-sectionid="<?= $single->id ?>">
                            ...
                            <div class="col-md-3 review_s_img_div<?= $single->id ?>" style="@if ($single->image) display: none; @endif">
                              <div class="col-md-12 col-xs-12 review_staff_image_upload_btn review_s_img_btn<?= $single->id ?>" style="@if ($single->image) display: none; @endif">
                              ...
                              <?php if (check_auth_permission('review_staff')) { ?>
                                ...
                                <?php if (check_auth_permission(['review_staff', 'review_staff_delete'])) { ?>
                                  <div class="col-md-3 col-xs-4">
                                    <br>
                                    <button type="button" class="btn btn-primary btnremovereview" data-reviewid="<?= $single->id ?>">Delete Reviews</button>
                                  </div>
                                <?php } ?>
                                <div class="col-md-3 col-xs-12">
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            ...
                                            <select class="myinput2 news_post_action_button action_button_selection" id="left_action_button_link" name="left_action_button_link[]">
                                              ...
                                              <option value="sms" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                              <option value="email" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'email' ? 'selected' : '' ?>>Email</option>
                                              <option value="address" <?= isset($single->left_action_button_link) && $single->left_action_button_link == "address" ? 'selected' : '' ?>>Business Address</option>
                                              <option value="customforms" <?= isset($single->left_action_button_link) && $single->left_action_button_link ==  "customforms" ? 'selected' : '' ?>>Link to Form</option>
                                              <option value="image_popup" <?= isset($single->left_action_button_link) && $single->left_action_button_link ==  "image_popup" ? 'selected' : '' ?>>Popup - Image</option>
                                              <option value="text_popup" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                              <option value="video" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                              <option value="stripe" <?= isset($single->left_action_button_link) && $single->left_action_button_link == "stripe" ? 'selected' : '' ?>>Popup - Payment</option>
                                              ...
                                              <option value="leftaudioiconfeature" <?= isset($single->left_action_button_link) && $single->left_action_button_link == "leftaudioiconfeature" ? 'selected' : '' ?>>Audio File with Icon</option>
                                            ...
                                            <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $single->left_action_button_link == 'image_popup' ? 'display:block' : 'display:none' ?>">
                                              <label for="customFile">Upload Images</label>
                                              <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="left_popup_action_images[<?= $single->id ?>][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                                            ...
                                            <div class="form-group action_fields left_audio_icon_feature" name="left_audio_icon_feature" style="<?= $single->left_action_button_link == 'leftaudioiconfeature' ? 'display:block' : 'display:none' ?>">
                                              <label for="customFile">Select File</label>
                                              <div class="custom-file">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select class="myinput2 news_post_action_button action_button_selection" id="right_action_button_link" name="right_action_button_link[]">
                                            ...
                                            <option value="sms" <?= isset($single->right_action_button_link) && $single->right_action_button_link == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                            <option value="email" <?= isset($single->right_action_button_link) && $single->right_action_button_link == 'email' ? 'selected' : '' ?>>Email</option>
                                            <option value="address" <?= isset($single->right_action_button_link) && $single->right_action_button_link == "address" ? 'selected' : '' ?>>Business Address</option>
                                            <option value="customforms" <?= isset($single->right_action_button_link) && $single->right_action_button_link ==  "customforms" ? 'selected' : '' ?>>Link to Form</option>
                                            <option value="image_popup" <?= isset($single->right_action_button_link) && $single->right_action_button_link ==  "image_popup" ? 'selected' : '' ?>>Popup - Image</option>
                                            <option value="text_popup" <?= isset($single->right_action_button_link) && $single->right_action_button_link == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                            <option value="video" <?= isset($single->right_action_button_link) && $single->right_action_button_link == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                            <option value="stripe" <?= isset($single->right_action_button_link) && $single->right_action_button_link == "stripe" ? 'selected' : '' ?>>Popup - Payment</option>
                                            ...
                                            <option value="audioiconfeature" <?= isset($single->right_action_button_link) && $single->right_action_button_link == "audioiconfeature" ? 'selected' : '' ?>>Audio File with Icon</option>
                                            <?php foreach ($front_sections as $single2) { ?>
                                          ...
                                          <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $single->right_action_button_link == 'image_popup' ? 'display:block' : 'display:none' ?>">
                                            <label for="customFile">Upload Images</label>
                                            <div class="custom-file">
                                              <input type="file" class="custom-file-input" name="right_popup_action_images[<?= $single->id ?>][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                                              <label class="custom-file-label" for="customFile">Choose files</label>
                                            </div>
                                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="action_button_link">Action Button Application</label>
                              <select class="myinput2 news_post_action_button action_button_selection" id="left_action_button_link" name="left_action_button_link[]">
                                <option value="link">Link to Outsdie Site</option>
      ...
      <div class="dynamic_review_sites">
            ...
            <div class="form-group">
              ...
              <select class="myinput2 siteNamefield" name="review_site_name[2]">
                <?php if (count($review_sites) == 0) { ?>
                  ...
                  <option value="Google Reviews" selected>Google Reviews</option>
                  <option value="Trustpilot">Trustpilot</option>
                <?php } ?>
                <option value="Other">Other</option>
                <?php foreach ($review_sites as $review_site) { ?>
                  <option value="<?= $review_site->review_site_name ?>" <?= (isset($review_sites[1])) ? (($review_sites[1]->review_site_name == $review_site->review_site_name) ? 'selected' : '') : (($review_site->review_site_name == 'Google Reviews' && !isset($review_sites[1])) ? 'selected' : ($review_site->review_site_name == 'Trustpilot' && !isset($review_sites[1]) ? 'selected' : '')) ?>>
        ...
        <div class="row static_review_3">
          <div class="col-md-4 col-xs-12">
            <div class="form-group">
              ...
              <select class="myinput2 siteNamefield" name="review_site_name[3]">
                ...
                <option value="Other">Other</option>
                <?php foreach ($review_sites as $review_site) { ?>
                  <option value="<?= $review_site->review_site_name ?>" <?= (isset($review_sites[2])) ? (($review_sites[2]->review_site_name == $review_site->review_site_name) ? 'selected' : '') : (($review_site->review_site_name == 'Google Reviews' && !isset($review_sites[1])) ? 'selected' : ($review_site->review_site_name == 'Trustpilot' && !isset($review_sites[1]) ? 'selected' : '')) ?>>
                    <?= $review_site->review_site_name ?></option>
                <?php } ?>
              </select>
            </div>
          ...
          <div class="col-md-4 col-xs-12">
            <div class="form-group">
              <label>Review site link</label><br>
              <input type="text" class="myinput2 " name="review_site_link[3]" value="{{ isset($review_sites[2]) ? $review_sites[2]->review_site_link : 'https://www.trustpilot.com' }}" placeholder="Review Site link">
            </div>
          </div>
          <div class="col-md-4 col-xs-12">
            <button type="button" class="btn btn-primary" style="margin-top:1.9rem;" onclick="delete_review('static_review_3')">X</button>
          </div>
        </div>
        @php
        }
...
<?php if (check_auth_permission(['staff_products_promos', 'staff_products_promos_text', 'staff_products_promos_add_new', 'staff_products_promos_delete'])) { ?>
  <div class="contentdiv">
    ...
    <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'staff_products_promos_bluebar' ? 'display:block;' : '' ?>">
      <form action="{{url('updatestaffproductspromos')}}" class="data-form" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row mb-17">
          <div class="col-md-3">
            <div class="form-group d-flex">
            ...
            <div class="content2">
              ...
              <div class="editcontent2 staff_promo_sortable">
                ...
                if (count($StaffProductsPromos) > 0) {
                  $i = 0;
                ?>
                  <?php foreach ($StaffProductsPromos as $staff_itr => $single) { ?>
                      ...
                      <div class="row staff_div" data-sectionid="<?= $single->id ?>">
                        ...
                        <div class="col-md-3 col-xs-12 staff_products_promos_image_div<?= $single->id ?>">
                          ...
                          <div class="col-md-12 mt-3">
                                  <div class="form-group d-flex" style="align-items: center;"> 
                                    <label class="">Cropped vs Full size</label>
                                    <label class="switch ml-7">
                                    <input type="checkbox" class="notificationswitch" name="is_round[<?= $single->id ?>]"  <?= $single->is_round ? 'checked' : '' ?>>
                        ...
                        <div class="col-md-9 wrap">
                          ...
                          <?php if (check_auth_permission('staff_products_promos')) { ?>
                            ...
                            <div class="col-md-3 col-xs-8">
                              <br>
                              <button type="button " class="btn btn-primary sort-handle">Grab here & sort</button>
                            </div>
                          <?php
                          } ?>
                      ...
                      <div class="col-md-12">
                        <div class="content3 mb-2">
                          ...
                          <div class="editcontent3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <select class="myinput2 news_post_action_button action_button_selection" id="left_action_button_link" name="left_action_button_link[]">
                                        ...
                                        <option value="video" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                        <option value="stripe" <?= isset($single->left_action_button_link) && $single->left_action_button_link == "stripe" ? 'selected' : '' ?>>Popup - Payment</option>
                                        <option value="audioiconfeature" <?= isset($single->left_action_button_link) && $single->left_action_button_link == "audioiconfeature" ? 'selected' : '' ?>>Audio File with Icon</option>
                                        <option value="google_map" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'google_map' ? 'selected' : '' ?>>Map</option>
                                        <?php foreach ($front_sections as $single2) { ?>
                                          <option value="<?= $single2->slug ?>" <?= isset($single->left_action_button_link) && $single->left_action_button_link == $single2->slug ? 'selected' : '' ?>><?= $single2->name ?></option>
                                        <?php } ?>
                                      ...
                                      <div class="form-group action_fields action_link" style="<?= empty($single->left_action_button_link) || $single->left_action_button_link == 'link' ? 'display:block' : 'display:none' ?>">
                                        <input type="text" class="myinput2 news_post_link" name="left_action_button_link_text[]" id="news_post_link" value="<?= isset($single->left_action_button_link_text) && $single->left_action_button_link_text ? $single->left_action_button_link_text : '' ?>" placeholder="http://google.com">
                                      </div>
                                      <div class="form-group action_fields audio_upload" name="left_feature_action_audio" style="<?= $single->left_action_button_link == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                                        <label for="customFile">Select File</label>
                                      ...
                                      <div class="form-group action_fields video_upload" name="feature_action_video" style="<?= $single->left_action_button_link == 'video' ? 'display:block' : 'display:none' ?>">
                                        ...
                                        <div class=" position-relative d-flex review_left_action_button_video_{{$single->id}}">
                                          ...
                                          <a class="remove_video_action btn btn-primary" href="<?php echo base_url('deletestaffvideo/' . $single->id . '/?type=left&staff=1'); ?>" onclick="return confirm('Are You Sure?');" title="Click to Remove" data-type='review_left_action_button_video' data-id="{{$single->id}}" data-file="{{$single->lft_action_button_video}}">X</a>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    ...
                                    <div class="form-group action_fields action_link" style="<?= empty($single->right_action_button_link) || $single->right_action_button_link == 'link' ? 'display:block' : 'display:none' ?>">
                                      <input type="text" class="myinput2 news_post_link" name="right_action_button_link_text[]" id="news_post_link" value="<?= isset($single->right_action_button_link_text) && $single->right_action_button_link_text ? $single->right_action_button_link_text : '' ?>" placeholder="http://google.com">
                                    </div>
                                    <div class="form-group action_fields audio_upload" name="right_feature_action_audio" style="<?= $single->right_action_button_link == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                                      <label for="customFile">Select File</label>
                                    ...
                                    <div class="form-group action_fields video_upload" name="feature_action_video" style="<?= $single->right_action_button_link == 'video' ? 'display:block' : 'display:none' ?>">
                                      ...
                                      <div class=" position-relative d-flex review_right_action_button_video_{{$single->id}}">
                                        ...
                                        <a class="remove_video_action btn btn-primary" href="<?php echo base_url('deletestaffvideo/' . $single->id . '/?type=right&staff=1'); ?>" onclick="return confirm('Are You Sure?');" title="Click to Remove" data-type='review_right_action_button_video' data-id="{{$single->id}}" data-file="{{$single->right_action_button_video}}">X
                                        </a>
                                      </div>
                                      @endif
                                    </div>
                            ...
                            <!-- <div class="editcontent4 "> -->
                            @if(isset($staffPromoActionButtons[$single->id]) && isset($staffPromoActionButtons[$single->id]))
                            <div class="action_button_container ">
                              @foreach($staffPromoActionButtons[$single->id] as $ind => $button)
                              @php
                              $key = $staff_itr;
                              @endphp
                              <div class="row action_button_single">
                                <div class="col-md-12">
                                  <input type="hidden" name="action_button_id_old[{{$key}}][]" value="{{$button->id}}">
                                  <div class="form-group">
                                    <label for="bannertext">Action button active</label><br>
                                    <label class="switch">
                                      <input type="checkbox" class="notificationswitch" name="action_buttons[{{ $key }}][]"
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="action_button_discription">Action Button Name</label>
                                    <input type="text" class="myinput2" name="action_button_discription[{{ $key }}][]"
                                      id="action_button_discription"
                                      value="{{ $button->text }}" placeholder="Type here...">
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label for="text_color">Action Button Text Color</label>
                                    <input type="color" class="myinput2" name="action_button_discription_color[{{ $key }}][]"
                                      id="text_color_{{ $key }}"
                                      value="{{ $button->text_color }}" placeholder="#ffffff">
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label for="bg_color">Action Button Color</label>
                                    <input type="color" class="myinput2" name="action_button_bg_color[{{ $key }}][]"
                                      id="bg_color_{{ $key }}"
                                      value="{{ $button->bg_color }}" placeholder="#000000">
                                  </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="action_type">Action Button Application</label>
                                    <select class="myinput2 news_post_action_button action_button_selection"
                                      id="action_type_{{ $key }}"
                                      name="action_type[{{ $key }}][]">
                                      <option value="link" {{ $button->action_type == 'link' ? 'selected' : '' }}>Link to Outside Site</option>
                                      <option value="call" {{ $button->action_type == 'call' ? 'selected' : '' }}>Call</option>
                                      <option value="sms" {{ $button->action_type == 'sms' ? 'selected' : '' }}>SMS Text</option>
                                      <option value="address" {{ $button->action_type == 'address' ? 'selected' : '' }}>Business Address</option>
                                      <option value="customforms" {{ $button->action_type == 'customforms' ? 'selected' : '' }}>Link to Forms</option>
                                      <option value="image_popup" {{ $button->action_type == 'image_popup' ? 'selected' : '' }}>Popup - Image</option>
                                      <option value="text_popup" {{ $button->action_type == 'text_popup' ? 'selected' : '' }}>Popup - Text</option>
                                      <option value="video" {{ $button->action_type == 'video' ? 'selected' : '' }}>Popup - Video</option>
                                      <option value="email" {{ $button->action_type == 'email' ? 'selected' : '' }}>Email</option>
                                      <option value="stripe" {{ $button->action_type == 'stripe' ? 'selected' : '' }}>Stripe</option>
                                      ...
                                      @foreach ($front_sections as $s)
                                      <option value="{{ $s->slug }}" {{ $button->action_type == $s->slug ? 'selected' : '' }}>
                                        {{ $s->name }}
                                      </option>
                                      @endforeach
                                    </select>
                                  </div>
                                  <div class="form-group action_fields video_upload" name="action_button_video1" style="<?= $button->action_type == 'video' ? 'display:block' : 'display:none' ?>">
                                    <label for="customFile">Upload Video</label>
                                    <div class="custom-file">
                                      <input type="file" class="custom-file-input" name="action_button_video[{{ $key }}][]" id="customFile" accept=".mp4">
                                      <label class="custom-file-label" for="customFile">Upload Video</label>
                                    </div>
                                    @if(isset($button->action_button_video) && $button->action_button_video !='')
                                    <div class=" position-relative d-flex newspost_action_button">
                                      <video height="80" controls>
                                        <source src="<?= isset($button->action_button_video) ? base_url('assets/uploads/' . get_current_url() . ($button->action_button_video)) : '' ?>" type="video/mp4">
                                      </video>

                                      <a class="remove_video_action btn btn-primary" href="<?php echo base_url('deletestaffvideo/' . $button->id); ?>" onclick="return confirm('Are You Sure?');" title="Click to Remove" data-type='newspost_action_button' data-id="{{$button->id}}" data-file="{{$button->action_button_video}}">X
                                      </a>
                                    </div>
                                    @endif
                                  </div>
                                  <div class="form-group action_fields phone_no_calls" style="<?= $button->action_type == 'call' ? 'display:block' : 'display:none' ?>">
                                    <label for="">Phone number for calls</label>
                                    <input type="text" class="myinput2" name="action_button_phone_no_calls[{{$key}}][]" value="<?= $button->action_button_phone_no_calls ?>">
                                  </div>
                                  <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $button->action_type == 'image_popup' ? 'display:block' : 'display:none' ?>">
                                    <label for="customFile">Upload Images</label>
                                    <div class="custom-file">
                                      <input type="file" class="custom-file-input" name="popup_action_images[{{ $key }}][{{$ind}}][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                                      <label class="custom-file-label" for="customFile">Choose files</label>
                                    </div>
                                  </div>
                                  <div class="form-group action_fields audio_icon_feature" name="headerbtn3_audio_icon_feature" style="<?= $button->action_type == 'audioiconfeature' ? 'display:block' : 'display:none' ?>">
                                    <label for="customFile">Select File</label>
                                    <div class="custom-file">
                                      <input type="file" class="custom-file-input" name="audio_icon_file[{{ $key }}][]" id="customFile" accept=".mp3">
                                      <label class="custom-file-label" for="customFile">Select File</label>
                                    </div>
                                    <div class="row">
                                      <?php if ($button->action_type == 'audioiconfeature' && $button->audio_icon_file) {

                                      ?>
                                        <div class="col-md-10 imgdiv">
                                          <h4><?= $button->audio_icon_file ?></h4>
                                          <button type="button" class="btn d-none btn-primary btnaudioiconfiledel" data-slug="blog_btn" data-id="<?= $button->id ?>" data-imgname="<?= $button->audio_icon_file ?>">X</button>
                                        </div>
                                      <?php
                                      } ?>
                                    </div>
                                  </div>
                                  <div class="form-group action_fields phone_no_sms" style="<?= $button->action_type == 'sms' ? 'display:block' : 'display:none' ?>">
                                    <label for="">Phone number for sms</label>
                                    <input type="text" class="myinput2" name="action_button_phone_no_sms[{{ $key }}][]" value="<?= $button->action_button_phone_no_sms ?>">
                                  </div>
                                  <div class="form-group action_fields action_email" style="<?= $button->action_type == 'email' ? 'display:block' : 'display:none' ?>">
                                    <label for="">Email</label>
                                    <input type="text" class="myinput2" name="action_button_action_email[{{ $key }}][]" value="<?= $button->action_button_action_email ?>">
                                  </div>
                                  <div class="form-group action_fields audio_upload" name="feature_action_audio" style="<?= $button->action_type == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                                    <label for="customFile">Select File</label>
                                    <div class="custom-file">
                                      <input type="file" class="custom-file-input" name="action_button_audio[{{$key}}][]" id="customFile" accept=".mp3,.mp4">
                                      <label class="custom-file-label" for="customFile">Select File</label>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <?php if ($button->action_button_action_audio) {

                                    ?>
                                      <div class="col-md-10 imgdiv">
                                        <h4><?= $button->action_button_action_audio ?></h4>
                                        <button type="button" class="btn btn-primary btnaudiofiledel" data-slug="news_post" data-id="<?= $button->id ?>" data-imgname="<?= $button->action_button_action_audio ?>">X</button>
                                      </div>
                                    <?php
                                  ...
                                  <br>
                                  <div class="form-group action_fields action_link" style="<?= $button->action_type == 'link' ? 'display:block' : 'display:none' ?>">
                                    <input type="text" class="myinput2 news_post_link" name="action_button_link_text[{{ $key }}][]" id="news_post_link" value="<?= $button->link ?>" placeholder="http://google.com">
                                  </div>
                                  <div class="form-group action_fields action_forms" style="<?= $button->action_type == 'customforms' ? 'display:block' : 'display:none' ?>">
                                    <select class="myinput2 customforms" name="action_button_customform[{{ $key }}][]">
                                      <?php if (count($customForms) > 0) { ?>
                                        <?php foreach ($customForms as $s) { ?>
                                          <option value="<?= $s->id ?>" <?= $button->custom_form_id == $s->id ? 'selected' : '' ?>><?= $s->title ?></option>
                                        <?php } ?>
                                      <?php } ?>
                                    </select>
                                  </div>
                                  <div class=" action_fields action_map" style="<?= $button->action_type == 'google_map' ? 'display:block' : 'display:none' ?>">
                                    <div class="form-group ">
                                      <label for="address">Enter Address</label>
                                      <input type="text" class="myinput2 " name="action_button_map_address[{{ $key }}][]" value="<?= isset($button->map_address) && $button->map_address ? $button->map_address : '' ?>" placeholder=" 105 Krome Ave, Miami, FL, 3700 USA">
                                    </div>
                                  </div>
                                  <div class="form-group action_fields action_address" style="<?= $button->action_type == 'address' ? 'display:block' : 'display:none' ?>">
                                    <label for="addressbtn1">Select an Address</label>
                                ...
                                <div class="col-md-12 d-flex justify-content-end">
                                  <div class="col-md-6 col-sm-12 p-0">
                                    <div class="form-group">
                                      <div class="form-group quilleditor-div action_fields  action_textpopup" style="<?= $button->action_type == 'text_popup' ? 'display:block' : 'display:none' ?>">
                                        <label>Popup Text </label>
                                        <textarea class="myinput2 editordata hidden" name="action_button_textpopup[{{ $key }}][]"><?php echo $button->action_button_textpopup; ?></textarea>
                                        <div class="quilleditor">
                                          <?php echo $button->action_button_textpopup; ?>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
          ...
          <div class="row">
              ...
              <div class="uploadImageDiv">
                ...
                <div class="col-md-12 mt-3">
                              <div class="form-group d-flex" style="align-items: center;"> 
                                <label class="">Cropped vs Full size</label>
                                <label class="switch ml-7">
                                  <input type="checkbox" class="notificationswitch override_bg_enable review_override_bg" name="is_round_new[]">
                                  <span class="slider round"></span>
                                </label>
                              </div>
                            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="myinput2 width-60px" name="staff_products_promos_stars[]">
                  <?php if (count($stars) > 0) { ?>
                    <?php foreach ($stars as $star) { ?>
                      <option value="<?= $star ?>"><?= $star ?></option>
                    <?php } ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="bannertext">Left Side Action button active</label><br>
                          <label class="switch">
                            <input type="checkbox" class="notificationswitch" name="left_action_button_active_new[]">
                            <span class="slider round"></span>
                          </label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="action_button_discription">Action Button Name</label>
                          <input type="text" class="myinput2" name="left_action_button_name_new[]" id="left_action_button_name" value="" placeholder="Type here...">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                          <label for="action_button_text_color">Action Button Text Color</label>
                          <input type="color" class="myinput2" name="left_action_button_text_color_new[]" id="left_action_button_text_color" value="" placeholder="#ffffff">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                          <label for="action_button_bg_color">Action Button Color</label>
                          <input type="color" class="myinput2" name="left_action_button_bg_color_new[]" id="left_action_button_bg_color" value="" placeholder="#000000">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="action_button_link">Action Button Application</label>
                          <select class="myinput2 news_post_action_button action_button_selection" id="left_action_button_link" name="left_action_button_link_new[]">
                            <option value="link">Link to Outside Site</option>
                            <option value="call">Call</option>
                            <option value="sms">SMS Text</option>
                            <option value="email">Email</option>
                          ...
                          <div class="form-group action_fields image_upload" name="feature_action_video2" style="display:none">
                            <label for="customFile">Upload Images</label>
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="left_popup_action_images_new[][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                              <label class="custom-file-label" for="customFile">Choose files</label>
                            </div>
                          </div>
                          <div class="form-group action_fields phone_no_calls" style="display:none">
                            <label for="">Phone number for calls</label>
                            <input type="text" class="myinput2" name="left_action_button_phone_no_calls_new[]" value="">
                          </div>
                          <div class="form-group action_fields phone_no_sms" style="display:none">
                            <label for="">Phone number for sms</label>
                            <input type="text" class="myinput2" name="left_action_button_phone_no_sms_new[]" value="">
                          </div>
                          <div class="form-group quilleditor-div action_fields  action_textpopup" style="display:none">
                            <label>Popup Text </label>
                            <textarea class="myinput2 editordata hidden" name="left_action_button_textpopup_new[]"></textarea>
                            <div class="quilleditor"></div>
                          </div>
                          <div class="form-group action_fields action_email" style="display:none">
                            <label for="">Email</label>
                            <input type="text" class="myinput2" name="left_action_button_action_email_new[]" value="">
                          </div>
                          <div class="form-group action_fields action_link">
                            <input type="text" class="myinput2 news_post_link" name="left_action_button_link_text_new[]" id="news_post_link" value="" placeholder="http://google.com">
                          </div>
                          <div class="form-group action_fields audio_upload" name="left_feature_action_audio" style="display:none">
                            <label for="customFile">Select File</label>
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="left_audio_file_new[]" id="customFile" accept=".mp3">
                              <label class="custom-file-label" for="customFile">Select File</label>
                            </div>
                          </div>
                          <div class="form-group action_fields audio_icon_feature" name="left_audio_icon_feature" style="display:none">
                            <label for="customFile">Select File</label>
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="left_audio_icon_file_new[]" id="customFile" accept=".mp3">
                              <label class="custom-file-label" for="customFile">Select File</label>
                            </div>
                          </div>
                          <div class="form-group action_fields video_upload" name="feature_action_video" style="display:none">
                            ...
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="left_video_file_new[]" id="customFile" accept=".mp4">
                              <label class="custom-file-label" for="customFile">Upload Video</label>
                            </div>
                          </div>
                          <div class="form-group action_fields action_forms" style="display:none">
                            <select class="myinput2" name="left_action_button_customform_new[]" id="customforms">
                              <?php if (count($customForms) > 0) { ?>
                                <?php foreach ($customForms as $singlecf) { ?>
                                  <option value="<?= $singlecf->id ?>"><?= $singlecf->title ?></option>
                                <?php } ?>
                          ...
                          <div class="form-group action_fields action_address" style="display:none">
                            <label for="addressbtn1">Select an Address</label>
                            <select name="left_action_button_address_id_new[]" class="myinput2">
                              <?php
                              foreach ($addresses as $address) {
                              ?>
                                <option value="<?= $address->id ?>"><?= $address->address_title ?>
                        ...
                        <div class="form-group action_fields action_map" style="display:none">
                          <label for="address">Enter Address</label>
                          <input type="text" class="myinput2 " name="left_action_button_map_address_new[]" value="" placeholder=" 105 Krome Ave, Miami, FL, 3700 USA">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="bannertext">Right Side Action button active</label><br>
                        <label class="switch">
                          <input type="checkbox" class="notificationswitch" name="right_action_button_active_new[]">
                          <span class="slider round"></span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="right_action_button_name">Action Button Name</label>
                        <input type="text" class="myinput2" name="right_action_button_name_new[]" id="right_action_button_name" value="" placeholder="Type here...">
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label for="right_action_button_text_color">Action Button Text Color</label>
                        <input type="color" class="myinput2" name="right_action_button_text_color_new[]" id="right_action_button_text_color" value="" placeholder="#ffffff">
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label for="right_action_button_bg_color">Action Button Color</label>
                        <input type="color" class="myinput2" name="right_action_button_bg_color_new[]" id="right_action_button_bg_color" value="" placeholder="#000000">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="right_action_button_link">Action Button Application</label>
                        <select class="myinput2 news_post_action_button action_button_selection" id="right_action_button_link" name="right_action_button_link_new[]">
                          <option value="link">Link to Outside Site</option>
                          <option value="call">Call</option>
                          <option value="sms">SMS Text</option>
                          <option value="email">Email</option>
                        ...
                        <div class="form-group action_fields image_upload" name="feature_action_video2" style="display:none">
                            <label for="customFile">Upload Images</label>
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="right_popup_action_images_new[][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                              <label class="custom-file-label" for="customFile">Choose files</label>
                            </div>
                          </div>
                        <div class="form-group action_fields phone_no_calls" style="display:none">
                          <label for="">Phone number for calls</label>
                          <input type="text" class="myinput2" name="right_action_button_phone_no_calls_new[]" value="">
                        </div>
                        <div class="form-group action_fields phone_no_sms" style="display:none">
                          <label for="">Phone number for sms</label>
                          <input type="text" class="myinput2" name="right_action_button_phone_no_sms_new[]" value="">
                        </div>
                        <div class="form-group action_fields action_email" style="display:none">
                          <label for="">Email</label>
                          <input type="text" class="myinput2" name="right_action_button_action_email_new[]" value="">
                        </div>
                        <div class="form-group quilleditor-div action_fields  action_textpopup" style="display:none">
                          <label>Popup Text </label>
                          <textarea class="myinput2 editordata hidden" name="right_action_button_textpopup_new[]"></textarea>
                          <div class="quilleditor"></div>
                        </div>
                        <div class="form-group action_fields action_link">
                          <input type="text" class="myinput2 news_post_link" name="right_action_button_link_text_new[]" id="news_post_link" value="" placeholder="http://google.com">
                        </div>
                        <div class="form-group action_fields audio_upload" name="right_feature_action_audio" style="display:none">
                          <label for="customFile">Select File</label>
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="right_audio_file_new[]" id="customFile" accept=".mp3">
                            <label class="custom-file-label" for="customFile">Select File</label>
                          </div>
                        </div>
                        <div class="form-group action_fields audio_icon_feature" name="right_audio_icon_feature" style="display:none">
                          <label for="customFile">Select File</label>
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="right_audio_icon_file_new[]" id="customFile" accept=".mp3">
                            <label class="custom-file-label" for="customFile">Select File</label>
                          </div>
                        </div>
                        <div class="form-group action_fields video_upload" name="feature_action_video" style="display:none">
                          <label for="customFile">Upload Video</label>
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="right_video_file_new[]" id="customFile" accept=".mp4">
                            <label class="custom-file-label" for="customFile">Upload Video</label>
                          </div>

                        </div>
                        <div class="form-group action_fields action_forms" style="display:none">
                          <select class="myinput2" name="right_action_button_customform_new[]" id="customforms">
                            <?php if (count($customForms) > 0) { ?>
                              <?php foreach ($customForms as $singlecf) { ?>
                                <option value="<?= $singlecf->id ?>"><?= $singlecf->title ?></option>
                              <?php } ?>
                        ...
                        <div class="form-group action_fields action_address" style="display:none">
                          <label for="addressbtn1">Select an Address</label>
                          <select name="right_action_button_address_id_new[]" class="myinput2">
                            <?php
                            foreach ($addresses as $address) {
                            ?>
                              <option value="<?= $address->id ?>"><?= $address->address_title ?>
                      ...
                      <div class="form-group action_fields action_map" style="display:none">
                        <label for="address">Enter Address</label>
                        <input type="text" class="myinput2 " name="right_action_button_map_address_new[]" value="" placeholder=" 105 Krome Ave, Miami, FL, 3700 USA">
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group action_fields image_upload" name="feature_action_video2" style="display:none">
                          <label for="customFile">Upload Images</label>
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="popup_action_images[<?= $content_count - 1 ?>][]" id="customFile" accept=".jpg,.jpeg,.png" multiple>
                            <label class="custom-file-label" for="customFile">Choose files</label>
                          </div>
                        </div>
                        <div class="form-group action_fields phone_no_calls" style="display:none">
                        ...
                        <div class="form-group action_fields action_event_forms" style="display:none;">
                          <select class="myinput2" style="display:none;" name="left_action_button_event_form[]" id="customeventforms<?= $content_count ?>">
                            <?php if (count($event_forms) > 0) { ?>
                              <?php foreach ($event_forms as $singlecf) { ?>
                                <option value="<?= $singlecf->id ?>" <?= isset($single->left_action_button_event_form) && $single->left_action_button_event_form == $singlecf->id ? 'selected' : '' ?>><?= $singlecf->title ?></option>
                              <?php } ?>
                            <?php } ?>
                          </select>
                        </div>
            ...
            <div class="content2" id="title_banner_attenhub_block">
                    ...
                    <div class="form-group switchOverHeadCenter">
                      <div class="title-banner-toggle-container">
                        ...
                        <label class="switch ml-2">
                          <input type="checkbox" class="notificationswitch titleEnable" data-slug="attenhub_title" <?= $attenhub_title->enable == '1' ? 'checked' : '' ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      <div class="tagswitch ml-10" data-slug="attenhub_title">
                        <div class="title-2 h1tag <?= $attenhub_title->tag == 'h1' ? 'active' : '' ?>" data-value="0">H1 Tag</div>
                        <div class="title-2 h3tag ml-2  <?= $attenhub_title->tag == 'h3' ? 'active' : '' ?>" data-value="1">H3 Tag</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div id="">
                  <div class="row">
                    <?php if (check_auth_permission(['title_banner_text_input'])) { ?>
                      <div class="col-md-4" id="attenhub_title_text">
                        <div class="form-group">
                          <label>Attenhub Title</label>
                          <input type="text" class="myinput2" name="attenhub_title_text" value="<?= $attenhub_title->text ?>" placeholder="Title">
                        </div>
                      </div>
                    <?php } ?>
                    <?php if (check_auth_permission('title_banners')) { ?>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="myinput2 width-50px" name="attenhub_title_font_size_web" value="<?= $attenhub_title->size_web ?>" placeholder="12">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Text Size on Mobile</label><br>
                          <input type="text" class="myinput2 width-50px" name="attenhub_title_font_size_mobile" value="<?= $attenhub_title->size_mobile ?>" placeholder="12">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="title_font_size">Attenhub Title Font</label>
                          <select class="myinput2" name="attenhub_title_font">
                            <?php if (count($font_family) > 0) { ?>
                              <?php foreach ($font_family as $single) { ?>
                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>" <?= $attenhub_title->fontfamily == $single->id ? 'selected' : ''; ?>><?= $single->name ?></option>
                              <?php } ?>
                            <?php } ?>
                          </select>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label> Text Color</label>
                          <input type="color" class="myinput2" name="attenhub_title_color" value="<?= $attenhub_title->color ?>" placeholder="#000000">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <?php if (isset($attenhub_title_setting) && property_exists($attenhub_title_setting, 'enable_theme_bg')): ?>
                          <div class="form-group attenhub_title_banner_color" style="<?php echo $attenhub_title_setting->enable_theme_bg == '1' ? 'display:none' : ''; ?>">
                          <?php else: ?>
                            <div class="form-group attenhub_title_banner_color">
                            <?php endif; ?>
                            <!-- Your content here -->
                            </div>
                            <label> Banner Color</label>
                            <input type="color" class="myinput2" name="attenhub_title_background" value="<?= $attenhub_title->bg_color ?>" placeholder="#000000">
                          </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <label class="switch">
                            <input type="checkbox" class="notificationswitch blog_bg_color title-banner-toggle" name="attenhub_title_setting" data-slug='blog_title' <?= isset($attenhub_title_setting->enable_theme_bg) && $attenhub_title_setting->enable_theme_bg == '1' ? 'checked' : '' ?>>
                            <span class="slider round"></span>
                          </label>
                        </div>
                      </div>
              ...
              <div class="titles-jump-div sticky-buttons-list">
                <div class="pb-2  pt-2 mb-1 jump-to-buttons make-jumto-sticky" align="center">
                  <div data-value="title_banner_attenhub_block" class="title-jump-btns">Attenhub</div>
            ...
            <div class="row">
              <div class="col-md-12 text-right">
                <div class="form-group align-all-right ">
                  <div for="" class="title-9 text-black">Tutorial Website <br>outline color</div>
                  <input type="color" id="build-site-color" readonly class=" updateoutlinecolor" disabled name="outline_color" value="<?= $master_feature_settings->outline_color ?>" placeholder="#000000" data-slug="master_feature_settings">
                </div>
              </div>
            </div>
          </div>
...
<div class="contentblocktrmplatediv" style="display:none;">
  <div class="single-cb">
    ...
    <div class="row">
      ...
      <div class="col-md-12"><br /></div>
      <div class="col-md-12 p-0" style="width: 100%;">
        <div class="col-md-12 content4">
          <div class="row">
            <div class="col-md-12">
...
<input type="hidden" id="fontData" value='@json($font_family)'>
<input type="hidden" id="starsData" value='@json($stars)'>
<input type="hidden" id="sectionsData" value='@json($front_sections)'>
...
<script>
  ...
  $(document).on('click', '.btnaddnewcontentblock', function() {
    let templateHtml = $('.contentblocktrmplatediv').html();

    // Get all existing values of content_block_inputs and find the max one
    let maxIndex = 0;
    $('.content_block_inputs').each(function() {
    ...
    templateHtml = templateHtml.replace(/image_index/g, "0"); // Replace image_index with 0

    $('.allcontentblockdiv').append(templateHtml);
  });
  ...
  function add_div() {
    ...
    <?php if (check_auth_permission('review_staff')) { ?>
      ...
      review_html += '</select> </div></div> <div class="col-md-2 col-xs-12"><div class="form-group"> <label>Number of Stars/Rating</label><br> <select class="myinput2 width-60px" name="reviews_stars[]">';
