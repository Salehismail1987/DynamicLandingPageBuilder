                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link" name="btn_link">
                        <option value="link" @if(old('btn_link') =='link') selected @endif>Link to Outside Site</option>
                        <option value="call"  @if(old('btn_link') =='call') selected @endif>Call</option>
                        <option value="sms"  @if(old('btn_link') =='sms') selected @endif>SMS Text</option>
                        <option value="email"  @if(old('btn_link') =='email') selected @endif>Email</option>
                        <option value="address"  @if(old('btn_link') =='address') selected @endif>Business Address</option>
                        <option value="customforms"  @if(old('btn_link') =='customforms') selected @endif>Link to Form</option>
                        <option value="image_popup"  @if(old('btn_link') =='customforms') selected @endif>Popup - Image</option>
                        <option value="text_popup"  @if(old('btn_link') =='text_popup') selected @endif>Popup - Text</option>
                        <option value="video"  @if(old('btn_link') =='video') selected @endif>Popup - Video</option>
                        <option value="stripe"  @if(old('btn_link') =='stripe') selected @endif>Popup - Payment</option>
                        <option value="audioiconfeature"  @if(old('btn_link') =='audioiconfeature') selected @endif>Audio File with Icon</option>
