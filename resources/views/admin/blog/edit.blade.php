                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link" name="btn_link">
                                        <option value="link" <?= $detail_info->btn_link == 'link' ? 'selected' : '' ?>>Link to Outside Site</option>
                                        <option value="call" <?= $detail_info->btn_link == 'call' ? 'selected' : '' ?>>Call</option>
                                        <option value="sms" <?= $detail_info->btn_link == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                        <option value="email" <?= $detail_info->btn_link == 'email' ? 'selected' : '' ?>>Email</option>
                                        <option value="address" <?= $detail_info->btn_link == 'address' ? 'selected' : '' ?>>Business Address</option>
                                        <option value="customforms" <?= $detail_info->btn_link == 'customforms' ? 'selected' : '' ?>>Link to Form</option>
                                        <option value="image_popup" <?= $detail_info->btn_link == 'image_popup' ? 'selected' : '' ?>>Popup - Image</option>
                                        <option value="text_popup" <?= $detail_info->btn_link == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                        <option value="video" <?= $detail_info->btn_link == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                        <option value="stripe" <?= $detail_info->btn_link == 'stripe' ? 'selected' : '' ?>>Popup - Payment</option>
                                        <option value="audioiconfeature" <?= $detail_info->btn_link == 'audioiconfeature' ? 'selected' : '' ?>>Audio File with Icon</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $detail_info->btn_link == 'image_popup' ? 'display:block' : 'display:none' ?>">
                                ...
                                <div class="form-group action_fields action_event_forms" style="<?= $detail_info->btn_link == 'attendhub' ? 'display:block' : 'display:none' ?>">
                                    <label for="title">Select Event Form</label>
                                    <select class="myinput2 customforms" name="action_button_eventform">
                                        <?php if (count($event_forms) > 0) { ?>
                                            <?php foreach ($event_forms as $single) { ?>
                                                <option value="<?= $single->id ?>" <?= $detail_info->action_button_eventform == $single->id ? 'selected' : '' ?>><?= $single->title ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                </div>
