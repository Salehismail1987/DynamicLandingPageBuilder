              ...
              <div class="row desc_content">
                <div class="col-md-12">
                  <div class="form-group quilleditor-div">
                    ...
                    <textarea class="myinput2 editordata hidden" name="gallery_post_desc"><?php echo $detail_info->post_desc; ?></textarea>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" class="myinput2 width-50px" name="post_image_size" value="<?= isset($detail_info->post_image_size) ? $detail_info->post_image_size : ''  ?>" placeholder="e.g 275">
                </div>
              </div>
              <div class="col-md-12">
                <div class="card mb-4">
