            ...
            <div class="d-flex">
              <div class="form-group  text-center">
                ...
                <label class="myswitchdiv">
                  <input type="checkbox" class="myswitch" name="tippopups" onchange="toggleSectionTips('settings',sub_sections)">
              ...
              <div class="form-group text-center  ml-4">
                ...
                <label class="myswitchdiv switch_disabled">
                  <input type="checkbox" class="myswitch" name="notificationswitch" data-module="notification_settings" <?= $notificationSettings->notification_switch ? 'checked' : '' ?>>
            ...
            <div class="dropdown-list-div">
              <ul>
                ...
                <?php if (check_auth_permission(['seo_block'])) { ?>
                  <li data-value="seo_block_bluebar">SEO Blk</li>
                <?php } ?>
              ...
              <div class="align-all-right d-flex align-items-end">
                <div class="form-group  d-flex align-items-center">
                  ...
                  <label class="switch ml-7">
                    <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="contact_forms_outline" <?php echo  $contact_forms_outline->active ? 'checked' : '' ?>>
              ...
              <div class="col-md-12 text-right">
                <div class="align-all-right d-flex align-items-end">
                  <div class="form-group  d-flex align-items-center">
                    <div for="" class="title-9 text-black">Turn On Outline</div>
                    <label class="switch ml-7">
                      <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="contact_boxes_outline" <?php echo  $contact_boxes_outline->active ? 'checked' : '' ?>>
                      <span class="slider round"></span>
                    </label>
                  </div>
                  <div class="form-group ml-34">
              ...
              <div class="col-md-12 text-right">
                <div class="align-all-right d-flex align-items-end">
                  <div class="form-group  d-flex align-items-center">
                    <div for="" class="title-9 text-black">Turn On Outline</div>
                    <label class="switch ml-7">
                      <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="seo_settings_outline" <?php echo  $seo_settings_outline->active ? 'checked' : '' ?>>
                      <span class="slider round"></span>
                    </label>
                  </div>
                  <div class="form-group ml-34">
                    <div for="" class="title-9 text-black">Color of outline</div>
                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $seo_settings_outline->outline_color ?>" placeholder="#000000" data-slug="seo_settings_outline">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12 text-right">
                <div class="align-all-right d-flex align-items-end">
                  <div class="form-group  d-flex align-items-center">
                    <div for="" class="title-9 text-black">Turn On Outline</div>
                    <label class="switch ml-7">
                      <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="seo_block_outline" <?php echo  $seo_block_outline->active ? 'checked' : '' ?>>
                      <span class="slider round"></span>
                    </label>
                  </div>
                  <div class="form-group ml-34">
                    <div for="" class="title-9 text-black">Color of outline</div>
                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $seo_block_outline->outline_color ?>" placeholder="#000000" data-slug="seo_block_outline">
                  </div>
                </div>
              </div>
            </div>
            ...
            <?php if (check_auth_permission('master_notifications')) { ?>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <label class="switch">
                    <input type="checkbox" name="notificationswitch" <?= $notificationSettings->notification_switch ? 'checked' : '' ?>>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
              ...
              <?php //} 
              ?>
              <?php //if (check_auth_permission('email_notifications')) { 
              ?>
              <div class="col-md-12">
                <div class="form-group">
              ...
              <?php //} 
              ?>
              <?php //if (check_auth_permission('step_notifications')) { 
              ?>
              <div class="col-md-5">
                <div class="form-group">
                  <label for="bannertext">Activate 1-Step Buttons Notifications</label>
                  <label class="switch">
                    <input type="checkbox" name="step_notifications" <?= $notificationSettings->step_notifications ? 'checked' : '' ?>>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
                          ...
                          <div class="">
                            <div class="row mb-2">
                              ...
                              <div class="col-md-8">
                                <div class="form-group">
                                  <label class="switch">
                                    <input type="checkbox" class="enableswitch" name="enableswitch" <?= $row->section_enabled ? 'checked' : '' ?>>
                                    <span class="slider round"></span>
                                  </label>
                                </div>
                              </div>
                            ...
                            <div class="">
                              <div class="row mb-2">
                                ...
                                <div class="col-md-7">
                                  <div class="form-group">
                                    <label class="switch">
                                      <input type="checkbox" class="enableswitch" name="enableswitch" <?= $row->edit_section_enabled ? 'checked' : '' ?>>
                                      <span class="slider round"></span>
                                    </label>
                                  </div>
                                </div>
                  ...
                  <div class="col-md-6 pl-0">
                    <div class="">
                      ...
                      <div class=" d-flex  text-center align-items-center" style="justify-content: space-evenly">
                        <div class="vertical-middle">
                          <div class="label-sort label-sort-grey">Published features only</div>
                        </div>
        ...
        <div class="content2">
          ...
          <div class="editcontent2 pl-2">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="d-flex align-items-center mb-3">
                  <div class="title-1 text-color-blue ">On Tutorial Website only</div>
                </div>
                <div class="">
                  <div class="row">
                    <?php if (count($front_edit_sections) > 0) { ?>
                      ...
                      foreach ($front_edit_sections as $row) {
                        ...
                        $i++; ?>
                        <div class="col-md-12 sections_edit_frontend" data-sectionid="<?= $row->id ?>">
                          <div class="">
                            <div class="row mb-2">
                              <div class="col-md-4 display-table">
                                <div class="vertical-middle">
            ...
            <div class="col-md-12 text-right">
              <div class="align-all-right d-flex align-items-end">
                <div class="form-group  d-flex align-items-center">
                  <div for="" class="title-9 text-black">Turn On Outline</div>
                  <label class="switch ml-7">
                    <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="pulldown_menu_outline" <?php echo  $pulldown_menu_outline->active ? 'checked' : '' ?>>
                    <span class="slider round"></span>
                  </label>
                </div>
                <div class="form-group ml-34">
              ...
              <?php if (count($front_menu) > 0) { ?>
                ...
                foreach ($front_menu as $row) {
                  ...
                  <tr class="menusections" data-sectionid="<?= $row->id ?>" onclick="showMenuPulldownActionModal(<?= $row->id ?>)" style="<?= $row->front_section && $row->front_section->section_enabled =='0'? 'background:lightgrey;':'';?>">
                    ...
                    <td style="width:30%"><?php echo $row->front_section && $row->front_section->name ? $row->front_section->name : ''; ?> <?php echo $row->link_type && $row->link_type != "" ? $row->link_type == 'customforms' ? 'Forms' : $row->link_type : ''; ?></td>
                    <td style="width:30%">
                      <a href="<?php echo base_url('editmenu/' . $row->id); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit</a>
                      <a href="<?php echo base_url('deletemenu/' . $row->id); ?>" class="btn btn-sm btn-primary" onclick="return confirm('Are You Sure?');"><i class="fa fa-trash-o"></i> Delete</a>
    ...
    <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'nav_bar_bluebar' ? 'display:block;' : '' ?>">
          ...
          <div class="col-md-12 text-right">
            <div class="align-all-right d-flex align-items-end">
              <div class="form-group  d-flex align-items-center">
                <div for="" class="title-9 text-black">Turn On Outline</div>
                <label class="switch ml-7">
                  <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="nav_bar_outline" <?php echo  $nav_bar_outline->active ? 'checked' : '' ?>>
                  <span class="slider round"></span>
                </label>
              </div>
              <div class="form-group ml-34">
      ...
      <div class="content2">
        ...
        <div class="editcontent2 pl-2" style="<?php echo  $navBarSettings->enable ? 'display: block;' : '' ?>">
          <form action="{{url('savenavbar')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-2">
  ...
  <div class="contentdiv">
    ...
    <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'footer_bluebar' ? 'display:block;' : '' ?>">
      <form action="{{url('savefooter')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12 text-right">
              <div class="align-all-right d-flex align-items-end">
                <div class="form-group  d-flex align-items-center">
                  <div for="" class="title-9 text-black">Turn On Outline</div>
                  <label class="switch ml-7">
                    <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="footer_outline" <?php echo  $footer_outline->active ? 'checked' : '' ?>>
                    <span class="slider round"></span>
                  </label>
                </div>
                <div class="form-group ml-34">
        ...
        <?php } ?>
        <div class="row">
          <?php if (check_auth_permission(['footer_text'])) { ?>
            <div class="col-md-3">
              <div class="form-group">
          ...
          <?php } ?>
          <?php if (check_auth_permission(['footer_link'])) { ?>
            <div class="col-md-3">
              <div class="form-group">
                <label>Link</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="image-wrapper imgrcroperdiv-favicon">
          <img class="image-rcroper-favicon" src="https://demo.webhound.tech/assets/uploads/898417-09-2021.png">
        </div>
      </div>
