...
?>
    <div id="content">
                            ...
                            <div>
                                <div class="form-group m-0 text-center">
                                    ...
                                    <label class="myswitchdiv">
                                        <input type="checkbox" class="myswitch" name="tippopups"
                                            onchange="toggleSectionTips('quick_settings',sub_sections)">
                            ...
                            <div class="ml-4">
                                <div class="form-group m-0 text-center">
                                    ...
                                    <label class="myswitchdiv switch_disabled">
                                        <input type="checkbox" class="notificationswitch myswitch" name="alltipspopup" data-module="notification_quick_setting"
                        ...
                        <div class="dropdown-list-main-div">
                            ...
                            <div class="dropdown-list-div">
                                <ul>
                                    ...
                                    <li data-value="header_text">Header Text</li>
                                    <?php } ?>
        ...
        @if (check_auth_permission(['alert_banner', 'alert_banner_text']))
            <div class="contentdiv">
                <div class="btnedit openEditContent" id="alert_banner_bluebar" data-top="alert_banner_top" data-bottom="alert_banner_bottom"
                    data-tip_section="alert_banner">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex  align-items-center">
                            ...
                            <div class=" ml-20">
                                <img src="{{ url('assets') }}/admin2/img/arrow-right-big.png" class="setion-arrows"
                                    alt="" width="21px" class="">
                            </div>
                        </div>
                    </div>

                </div>
                <form action="{{ url('updatealertbanner') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="editcontent mb-13"
                        style="<?= isset($_GET['block'])  && $_GET['block'] == 'alert_banner_bluebar' ? 'display:block;' : '' ?>">
                            <div class="row mb-17">
                                <div class="col-md-3">
                                    <div class="form-group d-flex">
                                        <label>Override Background <br>Color in Settings, Theme</label>
                                        <label class="switch ml-7">
                                            <input type="checkbox" class="notificationswitch override_bg_enable alert_banner_override_bg" name="alert_banner_override_bg" data-slug="alert_banner_bg_picker"
                                                <?php echo  $alert_banner_setting->alert_banner_override_bg ? 'checked' : '' ?>>
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $banner_text->bg_color ?>"></div>
                                                    <input type="color" class="colorinput"
                                                        name="banner_background_color" id="bannerbackgroundcolor"
                                                        value="<?= $banner_text->bg_color ?>" placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php if (check_auth_permission(['build_site_Content'])) { ?>
                                    ...
                                    <?php $alert_banner_outline = get_outline_settings('alert_banner_outline');?>
                                    <div class="col-md-6 text-right">
                                        <div class="align-all-right d-flex align-items-end">
                                            <div class="form-group  d-flex align-items-center">
                                                <div for="" class="title-9 text-black">Turn On Outline</div>
                                                <label class="switch ml-7">
                                                    <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="alert_banner_outline"
                                                        <?php echo  $alert_banner_outline->active ? 'checked' : '' ?>>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                            <div class="form-group ml-34">
                                                <div for="" class="title-9 text-black">Color of outline</div>
                                                <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $alert_banner_outline->outline_color ?>" placeholder="#000000" data-slug="alert_banner_outline">
                                            </div>
                                        </div>
                                    </div>                                
                                <?php } ?>
                                ...
                                <div class="row mb-22">
                                    @if (check_auth_permission('alert_banner_text'))
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="myinput2" name="banner_text" id="bannertext"
                                                value="<?= $banner_text->text ?>" placeholder="Banner Text" maxlength="75">
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $banner_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="banner_color"
                                                            id="bannertextcolor" value="<?= $banner_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-22">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" class="notificationswitch" name="banner_action_enable"
                                                        <?= $alert_banner_action->active ? 'checked' : '' ?>>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="myinput2" name="banner_text_2" id="bannertext2"
                                                value="<?= $banner_action_text->text ?>" placeholder="Banner Text">
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $banner_action_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="banner_color_2"
                                                            id="bannertextcolor2"
                                                            value="<?= $banner_action_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $banner_action_text->bg_color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="banner_background_color_2" id="bannertextcolor2"
                                                            value="<?= $banner_action_text->bg_color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="myinput2 action_button_selection"
                                                    name="alert_banner_action_button_link">
                                                    <option value="link" >
                                                        Link</option>
                                                    <option value="call" <?= $alert_banner_action->action_type == 'call' ? 'selected' : '' ?>>Call</option>
                                                    <option value="sms"
                                                        <?= $alert_banner_action->action_type == 'sms' ? 'selected' : '' ?>>
                                                        SMS</option>
                                                    <option value="email"
                                                        <?= $alert_banner_action->action_type == 'email' ? 'selected' : '' ?>>
                                                        Email</option>
                                                    <option value="google_map"
                                                        <?= $alert_banner_action->action_type == 'google_map' ? 'selected' : '' ?>>
                                                        Map</option>
                                                    <option value="address"
                                                        <?= $alert_banner_action->action_type == 'address' ? 'selected' : '' ?>>
                                                        Address</option>
                                                    <option value="customforms"
                                                        <?= isset($alert_banner_action->action_type) && $alert_banner_action->action_type == 'customforms' ? 'selected' : '' ?>>
                                                        Forms</option>
                                                    <?php foreach ($front_sections as $single) { ?>
                                                    <option value="<?= $single->slug ?>"
                                                        <?= $alert_banner_action->action_type == $single->slug ? 'selected' : '' ?>>
                                                        <?= $single->name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            ...
                                            style="<?= $alert_banner_action->action_type == 'link' ? 'display:block' : 'display:none' ?>">
                                                <label>Alert Banner Action Button Text Link</label>
                                                <input type="text" class="myinput2" name="banner_link_2"
                                                    id="bannertextlink2" value="<?= $alert_banner_action->link ?>"
                                                    placeholder="http://google.com">
                                            </div>
                                        
                                            <div class="form-group action_fields action_forms"
                                            style="<?= isset($alert_banner_action->action_type) && $alert_banner_action->action_type == 'customforms' ? 'display:block' : 'display:none' ?>">
                                                <label>Alert Banner Action Button Custom Forms</label>
                                                <select class="myinput2" name="banner_customforms" id="customforms">
                                                    <?php if(count($custom_forms)>0){ ?>
                                                    <?php foreach($custom_forms as $singlecf){ ?>
                                                    <option value="<?= $singlecf->id ?>"
                                                        <?= isset($alert_banner_action->custom_form_id) && $alert_banner_action->custom_form_id == $singlecf->id ? 'selected' : '' ?>>
                                            ...
                                            <div class="form-group action_fields action_address"
                                            style="display:<?= $alert_banner_action->action_type == 'address'  ? 'block' : 'none' ?>">
                                                    ...
                                                    foreach($addresses as $address){
                                                        ?>
                                                                                    <option value="<?= $address->id ?>"
                                                                                        <?= $alert_banner_action->address_id == $address->id ? 'selected' : '' ?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 alert_banner_logo_div">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ url('assets/uploads/'.get_current_url() . $alert_banner_logo->file_name) }}"
                                                    width="100%">
                                                <button type="button" class="btn btn-primary btnimgdel"
                                                    onclick="delete_front_image('{{ $alert_banner_logo->file_name }}','alert_banner_logo','alert_banner_logo_div','images','0','true')">X</button>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <div class="col-md-4">
                                            <div class="uploadImageDiv">
                                                <div class="upload-file-div display-table  btnuploadimagenew mb-2"
                                                    data-toggle="modal" data-target="#modalImagesforUploads">
                                                ...
                                                <div class="col-md-6 imgdiv" style="display:none">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btnimgdel btnimgremove">X</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="myinput2 width-50px"
                                                    name="alert_banner_logo_min_width" id="alert_banner_logo_min_width"
                                                    value="<?= $alert_banner_logo->min_width ?>" placeholder="100">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="myinput2 width-50px"
                                                    name="alert_banner_logo_max_width" id="alert_banner_logo_max_width"
                                                    value="<?= $alert_banner_logo->max_width ?>" placeholder="100">
                                            </div>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="row">
                                <div class="col-md-5" id="action_button-text">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2" name="menu_icon_text" id="menu_icon_text"
                                            value="<?= $menu_icon_text->text ?>" placeholder="Menu Icon Text">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2 width-50px" name="menu_icon_text_size_web"
                                            id="menu_icon_text_size_web" value="<?= $menu_icon_text->size_web ?>"
                                            placeholder="18px">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2 width-50px" name="menu_icon_text_size_mobile"
                                            id="menu_icon_text_size_mobile" value="<?= $menu_icon_text->size_mobile ?>"
                                            placeholder="18px">
                                    </div>
                                </div>
                                <!-- Switching (End) -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            <div>
                                                <img src="{{ url('assets') }}/admin2/img/dismiss-color.svg" alt=""
                                                    width="" class="dismiss-color">
                                            </div>
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor" style="background:<?= $menu_icon_text->color ?>">
                                                    </div>
                                                    <input type="color" class="colorinput" name="menu_icon_text_color"
                                                        id="bannertextcolor" value="<?= $menu_icon_text->color ?>"
                                                        placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="myinput2" name="menu_icon_text_font">
                                            ...
                                            <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                <?= $menu_icon_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                                <?= $single->name ?></option>
                                            <?php } ?>
                                            <?php } ?>
                                        </select>
    ...
    <?php if (check_auth_permission([
        ...
        <div class="contentdiv">
                            ...
                            <div class="position-relative switchoverhead">
                                <div class="switchbtns">
                                    <div class="form-group ml-20">
                                        <div class="title-2 text-color-blue">Popup Active</div>
                                        <label class="switch">
                                            <input type="checkbox" class="notificationswitch updatepopup" name="popup_active"
                                                <?= $alert_popup_setting->popup_active ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
            ...
            <div class="editcontent"
                style="<?= isset($_GET['block'])  && $_GET['block'] == 'popup_alert_bluebar' ? 'display:block;' : '' ?>">
                <form class="data-form" action="{{ url('updatealertpopup') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <?php if (check_auth_permission(['build_site_Content'])) { ?>
                        <div class="row mb-17">
                            <?php $popup_alert_outline = get_outline_settings('popup_alert_outline');?>
                            <div class="col-md-12 text-right">
                                <div class="align-all-right d-flex align-items-end">
                                    <div class="form-group  d-flex align-items-center">
                                        <div for="" class="title-9 text-black">Turn On Outline</div>
                                        <label class="switch ml-7">
                                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="popup_alert_outline"
                                                <?php echo  $popup_alert_outline->active ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="form-group ml-34">
                                        <div for="" class="title-9 text-black">Color of outline</div>
                                        <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $popup_alert_outline->outline_color ?>" placeholder="#000000" data-slug="popup_alert_outline">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 popup_image_div">
                                        <div class="form-group mb-3">
                                            ...
                                            <button type="button" class="btn btn-primary btnimgdel"
                                                onclick="delete_front_image('<?= $popup_image->file_name ?>','alert_popup_image','popup_image_div','images','0','true')">X</button>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="col-md-4">
                                        <div class="uploadImageDiv">
                                            <div class="upload-file-div display-table  btnuploadimagenew mb-2" data-toggle="modal"
                                                data-target="#modalImagesforUploads">
                                                <div class="vertical-middle">
                                        ...
                                        <div class="row nopadding datetimediv_popup">
                                            <div class="col-md-6 nopadding">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="popup_image_width"
                                                        class="myinput2" id="popup_image_width" placeholder="width in px"
                                                        value="<?= $popup_image->max_width ?>" onblur="updateWidth(this.value)">
                                                    <input type="hidden" id="width_modified" name="width_modified"
                                                        initial-width="{{ $popup_image->max_width }}" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-group m-0 ml-3">
                                                <label class="switch m-0">
                                                    <input type="checkbox" class="notificationswitch timeimagesswitch"
                                                        name="enable_timed_popup_image"
                                                        <?= $timed_popup_image->enable ? 'checked' : '' ?>>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?php if (isset($timed_image->file_name) && $timed_image->file_name) { ?>
                                                <div class="timed_popup_image_div">
                                                    ...
                                                    <button type="button" class="btn btn-primary btnimgdel"
                                                        onclick="delete_front_image('<?= $timed_image->file_name ?>','timed_popup_image','timed_popup_image_div','images','0','true')">X</button>
                                                </div>
                                            <?php }else{ ?>
                                            <div class="uploadImageDiv">
                                                <div class="upload-file-div display-table  btnuploadimagenew mb-2"
                                            ...
                                            <div class="timed_type_divs days_div" style="<?=$timed_popup_image->type=='days'?'display:block;':'display:none;'?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="myinput2 multiselectlist h-auto" name="days[]" multiple>
                                                        <option value="mon"
                                                            <?= is_array($days) && in_array('mon', $days) ? 'selected' : '' ?>>Monday
                                                        </option>
                                                        <option value="tue"
                                                            <?= is_array($days) && in_array('tue', $days) ? 'selected' : '' ?>>Tuesday
                                                        </option>
                                                        <option value="wed"
                                                            <?= is_array($days) && in_array('wed', $days) ? 'selected' : '' ?>>Wednesday
                                                        </option>
                                                        <option value="thu"
                                                            <?= is_array($days) && in_array('thu', $days) ? 'selected' : '' ?>>Thursday
                                                        </option>
                                                        <option value="fri"
                                                            <?= is_array($days) && in_array('fri', $days) ? 'selected' : '' ?>>Friday
                                                        </option>
                                                        <option value="sat"
                                                            <?= is_array($days) && in_array('sat', $days) ? 'selected' : '' ?>>Saturday
                                                        </option>
                                                        <option value="sun"
                                                            <?= is_array($days) && in_array('sun', $days) ? 'selected' : '' ?>>Sunday
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <div class="content2">
                            ...
                            <div class="editcontent2">
                                    ...
                                    <div class="form-group m2-20">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" class="notificationswitch updatepopup"
                                                name="popup_show_always"
                                                <?= $alert_popup_setting->popup_show_always ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px" name="popup_title_fontsize"
                                                id="popup_text_color2" value="<?= $popup_alert_title->size_web ?>"
                                                placeholder="18px">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $popup_alert_title->color ?>"></div>
                                                        <input type="color" class="colorinput" name="popup_title_color"
                                                            id="bannertextcolor2" value="<?= $popup_alert_title->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $popup_alert_title->bg_color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="popup_title_background_color" id="bannertextcolor2"
                                                            value="<?= $popup_alert_title->bg_color ?>" placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="popup_title_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $popup_alert_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7" id="popup_alert_message">
                                        <div class="form-group  quilleditor-div">
                                            ...
                                            <textarea name="popupalert" class="myinput2 h-auto editordata hidden" id="popupalert1" cols="30"
                                                rows="4"><?= $popup_alert_text->text ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $popup_alert_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="popup_text_color"
                                                            id="bannertextcolor2" value="<?= $popup_alert_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <label class="switch ml-7">
                                                <input type="checkbox" class="notificationswitch override_bg_enable popup_alert_override_bg" name="popup_alert_override_bg" data-slug="alert_popup_bg_picker"
                                                    <?php echo  $alert_popup_setting->popup_alert_override_bg ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group alert_popup_bg_picker" style="display:  <?php echo  $alert_popup_setting->popup_alert_override_bg ? 'block' : 'none' ?>">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $popup_alert_text->bg_color ?>"></div>
                                                        <input type="color" class="colorinput" name="popup_background_color"
                                                            id="bannertextcolor2" value="<?= $popup_alert_text->bg_color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                                        ...
                                        <img src="{{ url('assets') }}/admin2/img/arrow-down-grey.png" alt="" width="12px"
                                            class="">
                                    </div>
                                </div>
                            </div>
                            <div class="editcontent2">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="notificationswitch" name="featureActionButton"
                                                    <?= $alert_popup_feature_action_button->active ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2" name="feature_action_button_desc"
                                            id="feature_action_button_desc"
                                            value="<?= $alert_popup_feature_action_button_text->text ?>" placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $alert_popup_feature_action_button_text->color ?>">
                                                    </div>
                                                    <input type="color" class="colorinput"
                                                        name="feature_action_button_desc_color" id="bannertextcolor2"
                                                        value="<?= $alert_popup_feature_action_button_text->color ?>"
                                                        placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $alert_popup_feature_action_button_text->bg_color ?>">
                                                    </div>
                                                    <input type="color" class="colorinput"
                                                        name="feature_action_button_background_desc_color"
                                                        id="bannertextcolor2"
                                                        value="<?= $alert_popup_feature_action_button_text->bg_color ?>"
                                                        placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="myinput2 header_btn2_section action_button_selection"
                                            name="feature_action_button_link">
                                            <option value="link"  <?= $alert_popup_feature_action_button->action_type == 'link' ? 'selected' : '' ?>>Link</option>
                                            <option value="call"
                                                <?= $alert_popup_feature_action_button->action_type == 'call' ? 'selected' : '' ?>>
                                                Call</option>
                                            <option value="sms"
                                                <?= $alert_popup_feature_action_button->action_type == 'sms' ? 'selected' : '' ?>>
                                                SMS</option>
                                            <option value="email"
                                                <?= $alert_popup_feature_action_button->action_type == 'email' ? 'selected' : '' ?>>
                                                Email</option>
                                            <option value="google_map"
                                                <?= $alert_popup_feature_action_button->action_type == 'google_map' ? 'selected' : '' ?>>
                                                Map</option>
                                            <option value="address"
                                                <?= $alert_popup_feature_action_button->action_type == 'address' ? 'selected' : '' ?>>
                                                Address</option>
                                            <option value="customforms"
                                                <?= isset($alert_popup_feature_action_button->action_type) && $alert_popup_feature_action_button->action_type == 'customforms' ? 'selected' : '' ?>>
                                                Forms</option>
                                            <?php foreach ($front_sections as $single) { ?>
                                            <option value="<?= $single->slug ?>"
                                                <?= $alert_popup_feature_action_button->action_type == $single->slug ? 'selected' : '' ?>>
                                                <?= $single->name ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group action_fields phone_no_calls" style="<?= $alert_popup_feature_action_button->action_type == 'call' ? 'display:block' : 'display:none' ?>">
                                        <label for="">Phone number for calls</label>
                                        <input type="text" class="myinput2" name="feature_action_phone_no_calls" value="<?= $alert_popup_feature_action_button->action_button_phone_no_calls ?>">
                                    </div>
                                    <div class="form-group action_fields phone_no_sms" style="<?= $alert_popup_feature_action_button->action_type == 'sms' ? 'display:block' : 'display:none' ?>">
                                        <label for="">Phone number for sms</label>
                                        <input type="text" class="myinput2" name="feature_action_phone_no_sms" value="<?= $alert_popup_feature_action_button->action_button_phone_no_sms ?>">
                                    </div>
                                    <div class="form-group action_fields action_email" style="<?= $alert_popup_feature_action_button->action_type == 'email' ? 'display:block' : 'display:none' ?>">
                                        <label for="">Email</label>
                                        <input type="text" class="myinput2" name="feature_action_email" value="<?= $alert_popup_feature_action_button->action_button_action_email ?>">
                                    </div>
                                    <div class="clearfix">
                                    <div class="form-group action_fields action_link" style="<?= $alert_popup_feature_action_button->action_type == 'link' ? 'display:block' : 'display:none' ?>"">
                                        <input type="text"
                                            class="myinput2 btn0link" name="feature_button_text_link" id="btn0link"
                                            value="<?= $alert_popup_feature_action_button->link ?>" placeholder="http://google.com">
                                        </div>
                                    </div>

                                    <div class="clearfix action_fields action_forms" id="feature_customforms"
                                        style="<?= isset($alert_popup_feature_action_button->action_type) && $alert_popup_feature_action_button->action_type == 'customforms' ?  'display:block' : 'display:none' ?>">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="feature_customforms" id="customforms">
                                                ...
                                                <?php foreach($custom_forms as $singlecf){ ?>
                                                <option value="<?= $singlecf->id ?>"
                                                    <?= isset($alert_popup_feature_action_button->custom_form_id) && $alert_popup_feature_action_button->custom_form_id == $singlecf->id ? 'selected' : '' ?>>
                                                    <?= $singlecf->title ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class=" action_fields action_map" style="<?= $alert_popup_feature_action_button->action_type == 'google_map' ? 'display:block' : 'display:none' ?>">
                                        <div class="form-group " >
                                            <label for="address">Enter Address</label>
                                    ...
                                    <div class="clearfix action_fields action_address" id="address-list-alert-1"
                                        style="display:<?= $alert_popup_feature_action_button->address_id == 'address' ? 'block' : 'none' ?>">
                                        <div class="form-group">
                                            <label for="addressbtn1">Select an Address</label>
                                            <select name="feature_action_button_address" class="myinput2">
                                                <?php foreach($addresses as $address){?>
                                                <option value="<?= $address->id ?>"
                                                    <?= $alert_popup_feature_action_button->address_id == $address->id ? 'selected' : '' ?>>
                                                    <?= $address->address_title ?>
                                                <?php } ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="notificationswitch" name="newactionbuttonactive"
                                                    <?= $alert_popup_new_action_button->active ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="new_action_button_desc"
                                                id="new_action_button_desc" value="<?= $alert_popup_new_action_button_text->text ?>"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_new_action_button_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="new_action_button_desc_color"
                                                            id="bannertextcolor2"
                                                            value="<?= $alert_popup_new_action_button_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_new_action_button_text->bg_color ?>">
                                                        </div>
                                                        <input type="color" class="colorinput"
                                                            name="new_action_button_background_desc_color" id="bannertextcolor2"
                                                            value="<?= $alert_popup_new_action_button_text->bg_color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2 header_btn2_section action_button_selection"
                                                name="new_action_button_link">
                                                <option value="link"  <?= $alert_popup_new_action_button->action_type == 'link' ? 'selected' : '' ?>>Link</option>
                                                <option value="call"
                                                    <?= $alert_popup_new_action_button->action_type == 'call' ? 'selected' : '' ?>>
                                                    Call</option>
                                                <option value="sms"
                                                    <?= $alert_popup_new_action_button->action_type == 'sms' ? 'selected' : '' ?>>
                                                    SMS</option>
                                                <option value="email"
                                                    <?= $alert_popup_new_action_button->action_type == 'email' ? 'selected' : '' ?>>
                                                    Email</option>
                                                <option value="google_map"
                                                    <?= $alert_popup_new_action_button->action_type == 'google_map' ? 'selected' : '' ?>>
                                                    Map</option>
                                                <option value="address"
                                                    <?= $alert_popup_new_action_button->action_type == 'address' ? 'selected' : '' ?>>
                                                    Address</option>
                                                <option value="customforms"
                                                    <?= isset($alert_popup_new_action_button->action_type) && $alert_popup_new_action_button->action_type == 'customforms' ? 'selected' : '' ?>>
                                                    Forms</option>
                                                <?php foreach ($front_sections as $single) { ?>
                                                <option value="<?= $single->slug ?>"
                                                    <?= $alert_popup_new_action_button->action_type == $single->slug ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group action_fields action_link" style="<?= $alert_popup_new_action_button->action_type == 'link' ? 'display:block' : 'display:none' ?>"">
                                            <input type="text"
                                                class="myinput2 btn0link" name="new_button_text_link" id="btn0link"
                                                value="<?= $alert_popup_new_action_button->link ?>" placeholder="http://google.com">
                                            </div>
                                        </div>

                                        <div class="clearfix action_fields action_forms" id="new_customforms"
                                            style="<?= isset($alert_popup_new_action_button->action_type) && $alert_popup_new_action_button->action_type == 'customforms' ?  'display:block' : 'display:none' ?>">
                                            <div class="form-group">
                                                ...
                                                <select class="myinput2" name="new_customforms" id="customforms">
                                                    ...
                                                    <?php foreach($custom_forms as $singlecf){ ?>
                                                    <option value="<?= $singlecf->id ?>"
                                                        <?= isset($alert_popup_new_action_button->custom_form_id) && $alert_popup_new_action_button->custom_form_id == $singlecf->id ? 'selected' : '' ?>>
                                                        <?= $singlecf->title ?></option>
                                                    <?php } ?>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="clearfix action_fields action_address" id="address-list-alert-1"
                                            style="display:<?= $alert_popup_new_action_button->action_type == 'address'  ? 'block' : 'none' ?>">
                                            <div class="form-group">
                                                <label for="addressbtn1">Select an Address</label>
                                                <select name="new_action_button_address" class="myinput2">
                                                    <?php foreach($addresses as $address){?>
                                                    <option value="<?= $address->id ?>"
                                                        <?= $alert_popup_new_action_button->address_id == $address->id ? 'selected' : '' ?>>
                                                        <?= $address->address_title ?>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="notificationswitch" name="proceedactionbuttonactive"
                                                    <?= $alert_popup_proceed_action_button->active ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="proceed_action_button_desc"
                                                id="proceed_action_button_desc"
                                                value="<?= $alert_popup_proceed_action_button_text->text ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_proceed_action_button_text->color ?>">
                                                        </div>
                                                        <input type="color" class="colorinput" name="proceed_action_button_desc_color"
                                                            id="bannertextcolor2"
                                                            value="<?= $alert_popup_proceed_action_button_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_proceed_action_button_text->bg_color ?>">
                                                        </div>
                                                        <input type="color" class="colorinput"
                                                            name="proceed_action_button_background_desc_color" id="bannertextcolor2"
                                                            value="<?= $alert_popup_proceed_action_button_text->bg_color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="notificationswitch" name="terminate_action_button_activate"
                                                    <?= $alert_popup_terminate_action_button->active ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="terminate_action_button_desc"
                                                id="terminate_action_button_desc"
                                                value="<?= $alert_popup_terminate_action_button_text->text ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_terminate_action_button_text->color ?>">
                                                        </div>
                                                        <input type="color" class="colorinput" name="terminate_action_button_color"
                                                            id="bannertextcolor2"
                                                            value="<?= $alert_popup_terminate_action_button_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $alert_popup_terminate_action_button_text->bg_color ?>">
                                                        </div>
                                                        <input type="color" class="colorinput"
                                                            name="terminate_action_button_background_color" id="bannertextcolor2"
                                                            value="<?= $alert_popup_terminate_action_button_text->bg_color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <?php if (check_auth_permission(['news_feed'])) { ?>
        <div class="contentdiv">
            ...
            <div class="editcontent"
                style="<?=isset($_GET['block'])  && $_GET['block'] == 'newsfeed_bluebar' ? 'display:block;' : '' ?>">
                <?php if (check_auth_permission(['build_site_Content'])) { ?>
                    <div class="row mb-17">
                        <?php $news_feed_outline = get_outline_settings('news_feed_outline');?>
                        <div class="col-md-12 text-right">
                            <div class="align-all-right d-flex align-items-end">
                                <div class="form-group  d-flex align-items-center">
                                    <div for="" class="title-9 text-black">Turn On Outline</div>
                                    <label class="switch ml-7">
                                        <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="news_feed_outline"
                                            <?php echo  $news_feed_outline->active ? 'checked' : '' ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group ml-34">
                                    <div for="" class="title-9 text-black">Color of outline</div>
                                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $news_feed_outline->outline_color ?>" placeholder="#000000" data-slug="news_feed_outline">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody class='sort_news_feed'>
                                        ...
                                        foreach ($news_feeds as $row) {
                                            $i++; ?>
                                            <tr id="newsSectionDiv<?= $row->id ?>" class="newssections"
                                                data-sectionid="<?= $row->id ?>" onclick="showNewsFeedActionModal(<?= $row->id ?>)">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="dropdown-toggle mydropdown"
                                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Action
                                                        </button>
                                                        <div class="dropdown-menu" x-placement="bottom-start">
                                                            <a href="<?php echo url('editnewsfeed/' . $row->id . '/'); ?>" class="dropdown-item">Edit</a>
                                                            <a href="<?php echo url('deletenewsfeed/' . $row->id . '/?sec=newsfeed_bluebar'); ?>" class="dropdown-item"
                                                    ...
                                                    <div class="modal  fade" id="newsFeedModal<?= $row->id ?>" tabindex="-1"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <center>
                                                                        ...
                                                                        <a href="<?php echo url('admin/newsfeed/edit/' . $row->id . '/'); ?>"
                                                                            class="btn btn-sm btn-primary"><i
                                                                                class="fa fa-pencil"></i> Edit</a>
                                                                        &nbsp;&nbsp;&nbsp;
                                                                        <a href="<?php echo url('admin/newsfeed/delete/' . $row->id . '/?sec=newsfeed_bluebar'); ?>" class="btn btn-sm btn-primary"
                                                                            onclick="return confirm('Are You Sure?');"><i
                                                                                class="fa fa-trash-o"></i> Delete</a>
                                                                        <br />
                                                                        <a href="<?php echo url('send_notification/' . $row->id . '/'); ?>"
                                                                            class="btn btn-sm btn-primary"><i
                                                                                class="fa fa-envelope"></i> Teaser Notification</a>
                                                                        <?php } ?>
                                                                    </center>
                                                                </div>
                                                            </div>
                ...
                <?php if (check_auth_permission(['news_feed'])) { ?>
                    <div class="content2">
                        ...
                        <div class="editcontent2">
                            <form action="{{ url('updatenewsfeedsettings') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Override Background</label>
                                            <label class="switch ml-7">
                                                <input type="checkbox" class="notificationswitch override_bg_enable " name="news_feed_override_bg" data-slug="news_feed_override_bg"
                                                    <?php echo  $news_feed_setting->news_feed_override_bg ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group news_feed_override_bg" style="display:<?= $news_feed_setting->news_feed_override_bg =='1' ? 'block':'none'?>">
                                            <label for="popup_background_color">Newsfeed background color</label>
                                            <div class="d-flex align-items-center color-main-div">
                                                <div>
                                                    <img src="{{ url('assets') }}/admin2/img/dismiss-color.svg" alt=""
                                                        width="" class="dismiss-color">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $news_feed_setting->news_feed_bg ?>"></div>
                                                        <input type="color" class="colorinput" name="news_feed_bg"
                                                            id="bannertextcolor2" value="<?= $news_feed_setting->news_feed_bg ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 nf_image_div">
                                        <div class="form-group">
                                            ...
                                            <img src="<?= url('assets/uploads/'.get_current_url() . $news_feed_logo->file_name) ?>"
                                                width="100%">
                                            <button type="button" class="btn btn-primary btnimgdel"
                                                onclick="delete_front_image('{{ $news_feed_logo->file_name }}','news_feed_logo','nf_image_div','images','0','true')">X</button>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="newsfeed_from_name"
                                                id="newsfeed_from_name" value="<?= $news_feed_setting->from_name ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="newsfeed_from_email"
                                                id="newsfeed_from_email" value="<?= $news_feed_setting->from_email ?>"
                                                placeholder="Sample Email ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="myinput2" name="newsfeed_reply_to"
                                                id="newsfeed_reply_to" value="<?= $news_feed_setting->reply_to ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="myinput2" name="newsfeed_optout_email"
                                                id="newsfeed_optout_email" value="<?= $news_feed_setting->optout_email ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="preheader" id="preheader"
                                                value="<?= $news_feed_setting->preheader ?>" placeholder="Preheader">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $newsfeed_teaser_title->color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="newsfeed_teaser_title_text_color" id="bannertextcolor"
                                                            value="<?= $newsfeed_teaser_title->color ?>" placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="newsfeed_teaser_title_text_size" value="<?php echo $newsfeed_teaser_title->size_web; ?>"
                                                placeholder="18">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="newsfeed_teaser_title_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $newsfeed_teaser_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row  make-sticky">
                                    <div class="col-md-12">
                                        <button type="submit" name="save_newsfeed_email_settings" class="btn btn-primary"
                    ...
                    <div class="content2">
                                ...
                                <div class="grey-div d-flex justify-content-between align-items-center editbtn2 generic-settings">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="switch ml-3">
                                            <input type="checkbox" class="notificationswitch saveGeneric" data-table="newsFeedSetting"  data-column="use_generic_newsfeed_setting"
                                                name="use_generic_newsfeed_setting"
                                                <?= $news_feed_setting->use_generic_newsfeed_setting ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <img src="{{ url('assets') }}/admin2/img/arrow-down-grey.png" alt=""
                        ...
                        <div class="editcontent2">
                            ...
                            <form action="{{ url('updatenewsfeedgenericsettings') }}" method="post"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $generic_newsfeed_title->color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="generic_newsfeed_title_color" id="bannertextcolor"
                                                            value="<?= $generic_newsfeed_title->color ?>" placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="generic_newsfeed_title_size" value="<?php echo $generic_newsfeed_title->size_web; ?>"
                                                placeholder="18">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="generic_newsfeed_title_size_mobile" value="<?php echo $generic_newsfeed_title->size_mobile; ?>"
                                                placeholder="18">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="generic_newsfeed_title_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $generic_newsfeed_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $generic_newsfeed_desc->color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="generic_newsfeed_desc_color" id="bannertextcolor"
                                                            value="<?= $generic_newsfeed_desc->color ?>" placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="generic_newsfeed_desc_size" value="<?php echo $generic_newsfeed_desc->size_web; ?>"
                                                placeholder="16">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="generic_newsfeed_desc_size_mobile" value="<?php echo $generic_newsfeed_desc->size_mobile; ?>"
                                                placeholder="16">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="generic_newsfeed_desc_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $generic_newsfeed_desc->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row  make-sticky">
                                    <div class="col-md-12">
                                        <button type="submit" name="save_generic_newsfeed_settings" class="btn btn-primary"
                                            value="save">Save</button>
                                        <button type="submit" name="save_generic_newsfeed_settings" class="btn btn-primary"
                                            value="savereminders">Save & send reminder</button>
    ...
    <?php if (check_auth_permission(['news_posts', 'add_news_post', 'news_post_actions'])) { ?>
        <div class="contentdiv">
            ...
            <div class="editcontent "
                style="<?= isset($_GET['block'])  && $_GET['block'] == 'news_posts_bluebar' ? 'display:block;' : '' ?>">
                <?php if (check_auth_permission('news_posts')) { ?>
                <form action="{{ url('updatenewspostsettings') }}" method="post" enctype="multipart/form-data"
                    style="margin-bottom: 10px;">
                    @csrf
                    <?php if (check_auth_permission(['build_site_Content'])) { ?>
                        <div class="row mb-17">
                            <?php $news_post_outline = get_outline_settings('news_post_outline');?>
                            <div class="col-md-12 text-right">
                                <div class="align-all-right d-flex align-items-end">
                                    <div class="form-group  d-flex align-items-center">
                                        <div for="" class="title-9 text-black">Turn On Outline</div>
                                        <label class="switch ml-7">
                                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="news_post_outline"
                                                <?php echo  $news_post_outline->active ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="form-group ml-34">
                                        <div for="" class="title-9 text-black">Color of outline</div>
                                        <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $news_post_outline->outline_color ?>" placeholder="#000000" data-slug="news_post_outline">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content2">
                            ...
                            <div class="col-md-12">
                                <div class="grey-div d-flex justify-content-between align-items-center editbtn2 generic-settings">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="switch ml-3">
                                            <input type="checkbox" class="notificationswitch saveGeneric" data-table="newsPostSetting"  data-column="use_generic_news_post_setting"
                                                name="use_generic_news_post_setting"
                                                <?= $news_post_setting->use_generic_news_post_setting ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <img src="{{ url('assets') }}/admin2/img/arrow-down-grey.png" alt=""
                        ...
                        <div class="editcontent2"> 
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" class="notificationswitch"
                                                name="generic_news_post_show_date"
                                                <?= $news_post_setting->generic_news_post_show_date ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $generic_news_post_title->color ?>"></div>
                                                    <input type="color" class="colorinput"
                                                        name="generic_news_post_title_color" id="bannertextcolor"
                                                        value="<?= $generic_news_post_title->color ?>"
                                                        placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2 width-50px"
                                            name="generic_news_post_title_size" value="<?php echo $generic_news_post_title->size_web; ?>"
                                            placeholder="18">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="myinput2" name="generic_news_post_title_font_family">
                                            ...
                                            <?php foreach ($font_family as $single) { ?>
                                            <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                <?= $generic_news_post_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                                <?= $single->name ?></option>
                                            <?php } ?>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $generic_news_post_desc->color ?>"></div>
                                                    <input type="color" class="colorinput"
                                                        name="generic_news_post_desc_color" id="bannertextcolor"
                                                        value="<?= $generic_news_post_desc->color ?>" placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2 width-50px"
                                            name="generic_news_post_desc_size" value="<?php echo $generic_news_post_desc->size_web; ?>"
                                            placeholder="16">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="myinput2" name="generic_news_post_desc_font_family">
                                            ...
                                            <?php foreach ($font_family as $single) { ?>
                                            <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                <?= $generic_news_post_desc->fontfamily == $single->id ? 'selected' : '' ?>>
                                                <?= $single->name ?></option>
                                            <?php } ?>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="row form-bottom make-sticky">
                                <div class="col-md-12">
                                    <button type="submit" name="save_generic_news_post_settings" class="btn btn-primary"
                                        value="save">Save</button>
                                    <button type="submit" name="save_generic_news_post_settings" class="btn btn-primary"
                                        value="savereminders">Save & send reminder</button>
                ...
                <div class="content2">
                    ...
                    <div class="editcontent2">
                        ...
                        $i++; ?>
                                    <tr class="newssections" data-sectionid="<?= $row->id ?>"
                                        onclick="showNewsActionModal(<?= $row->id ?>)">
                                        <td> 
                                            <?php  if ($row->image) { ?>
                                            ...
                                            <?php if (check_auth_permission('news_post_actions')) { ?>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo base_url('deletenewspost/' . $row->id . '/?sec=news_posts_bluebar'); ?>"
                                                            onclick="return confirm('Are You Sure?');">Delete</a>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div class="modal  fade" id="newsPostModal<?= $row->id ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <center>
                                                                <?php if (check_auth_permission('news_post_actions')) { ?>
                                                                <a href="<?php echo base_url('admin/newspost/edit/' . $row->id . '/'); ?>"
                                                                    class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit</a>
                                                                &nbsp;&nbsp;&nbsp;
                                                                <a href="<?php echo base_url('admin/newspost/delete/' . $row->id . '/?sec=news_posts_bluebar'); ?>"
    ...
    <div class="contentdiv">
        <div class="btnedit openEditContent" id="header_images_bluebar" data-top="header_block_top" data-bottom="header_block_bottom"
        data-tip_section="header_images">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex  align-items-center">
        ...
        <div class="editcontent"
            style="<?= isset($_GET['block'])  && $_GET['block'] == 'header_images_bluebar' ? 'display:block;' : '' ?>">
            <form action="{{ url('updateheaderimages') }}" method="post" enctype="multipart/form-data" id="form_header_settings">
                    ...
                    <div class="row mb-17">
                        <div class="col-md-3">
                            <div class="form-group d-flex">
                                <label>Override Background <br>Color in Settings, Theme</label>
                                <label class="switch ml-7">
                                    <input type="checkbox" class="notificationswitch override_bg_enable header_block_override_bg" name="header_block_override_bg" data-slug="header_block_bg_picker"
                                        <?php echo  $header_images_settings->header_block_override_bg ? 'checked' : '' ?>>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput"
                                                name="header_background_color" id="bannertextcolor"
                                                value="<?= $header_images_settings->header_background_color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php if (check_auth_permission(['build_site_Content'])) { ?>
                            <?php $header_images_outline = get_outline_settings('header_images_outline');?>
                            <div class="col-md-6 text-right">
                                <div class="align-all-right d-flex align-items-end">
                                    <div class="form-group  d-flex align-items-center">
                                        <div for="" class="title-9 text-black">Turn On Outline</div>
                                        <label class="switch ml-7">
                                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="header_images_outline"
                                                <?php echo  $header_images_outline->active ? 'checked' : '' ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="form-group ml-34">
                                        <div for="" class="title-9 text-black">Color of outline</div>
                                        <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $header_images_outline->outline_color ?>" placeholder="#000000" data-slug="header_images_outline">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row" id="header_logo">
                                    ...
                                    <div class="col-md-3 header_block_logo_div">
                                        <div class="form-group">
                                            ...
                                            <img src="<?= base_url('assets/uploads/'.get_current_url() . $header_images_settings->header_logo) ?>"
                                                width="150">
                                            <button type="button" class="btn btn-primary btnimgdel"
                                                onclick="delete_front_image('<?= $header_images_settings->header_logo ?>','header_logo','header_block_logo_div','header_images','<?= $header_images_settings->id ?>')">X</button>
                                        </div>
                                        <br>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="header_title_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $header_image_title_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px" name="header_logo_width"
                                                id="headerlogowidth" value="<?= $header_images_settings->header_logo_width ?>"
                                                placeholder="50px">
                                        </div>
                                    </div>
                                </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2" name="header_title" id="headertitle"
                                            value="<?= $header_image_title_text->text ?>" placeholder="Logo Title Text">
                                    </div>
                                </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Text Size</label><br>
                                            <input type="text" class="myinput2 width-50px" name="header_title_fontsize"
                                                value="<?= $header_image_title_text->size_web ?>" placeholder="12px">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $header_image_title_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="header_title_color"
                                                            id="bannertextcolor" value="<?= $header_image_title_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                                    <div class="d-flex align-items-center titlediv d-flex">
                                        ...
                                        <div class="form-group  switchoverhead2">
                                            <label class="switch m-0">
                                                <input type="checkbox" name="enable_timed_header_logo"
                                                    class="timeimagesswitch"
                                                    <?= $timed_header_logo->enable ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row nopadding datetimediv_popup">
                                                    ...
                                                    <div class="col-md-6 nopadding">
                                                        ...
                                                        <div class="timed_type_divs days_div" style="<?=$timed_header_logo->type=='days'?'display:block;':'display:none;'?>">
                                                            <div class="form-group">
                                                                <label for="start_time">Start Time</label>
                                                                <input type="time" name="header_logo_start_time"
                                                                    class="myinput2" id="start_time"
                                                                    value="<?php echo $start_time->format('H:i'); ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="end_time">End Time</label>
                                                                <input type="time" name="header_logo_end_time"
                                                                    class="myinput2" id="end_time"
                                                                    value="<?php echo $end_time->format('H:i'); ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Select Days</label>
                                                                <select class="myinput2 multiselectlist" name="days[]" multiple>
                                                                    <option value="mon"
                                                                        <?= is_array($days) && in_array('mon', $days) ? 'selected' : '' ?>>
                                                                        Monday</option>
                                                                    <option value="tue"
                                                                        <?= is_array($days) && in_array('tue', $days) ? 'selected' : '' ?>>
                                                                        Tuesday</option>
                                                                    <option value="wed"
                                                                        <?= is_array($days) && in_array('wed', $days) ? 'selected' : '' ?>>
                                                                        Wednesday</option>
                                                                    <option value="thu"
                                                                        <?= is_array($days) && in_array('thu', $days) ? 'selected' : '' ?>>
                                                                        Thursday</option>
                                                                    <option value="fri"
                                                                        <?= is_array($days) && in_array('fri', $days) ? 'selected' : '' ?>>
                                                                        Friday</option>
                                                                    <option value="sat"
                                                                        <?= is_array($days) && in_array('sat', $days) ? 'selected' : '' ?>>
                                                                        Saturday</option>
                                                                    <option value="sun"
                                                                        <?= is_array($days) && in_array('sun', $days) ? 'selected' : '' ?>>
                                                                        Sunday</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-3 timed_header_block_logo_div">
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?= base_url('assets/uploads/'.get_current_url() . $timed_header_logo_image->file_name) ?>"
                                                        width="100%">
                                                    <button type="button" class="btn btn-primary btnimgdel"
                                                        onclick="delete_front_image('<?= $timed_header_logo_image->file_name ?>','timed_header_logo','timed_header_block_logo_div','images','0','true')">X</button>
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2" name="header_title2" id="headertitle2"
                                                value="<?= $header_text_2->text ?>" placeholder="Banner Text">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Text Size</label><br>
                                            <input type="text" class="myinput2 width-50px" name="header_title_fontsize2"
                                                value="<?= $header_text_2->size_web ?>" placeholder="12px">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        ...
                                                        <input type="color" class="colorinput" name="header_title_color2"
                                                            id="bannertextcolor" value="<?= $header_text_2->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="header_title_2_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $header_text_2->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row" id="header_image">
                                    ...
                                    <div class="col-md-3 header_block_image_div">
                                        <div class="form-group">
                                            ...
                                            <img src="<?= base_url('assets/uploads/'.get_current_url() . $header_images_settings->header_img) ?>"
                                                width="100%">
                                            <button type="button" class="btn btn-primary btnimgdel"
                                                onclick="delete_front_image('<?= $header_images_settings->header_img ?>','header_img','header_block_image_div','header_images','<?= $header_images_settings->id ?>')">X</button>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px" name="header_img_width"
                                                id="headerimgwidth" value="<?= $header_images_settings->header_img_width ?>"
                                                placeholder="50px">
                                        </div>
                                    </div>
                                    <?php } ?>
                            ...
                            <?php if (check_auth_permission('header_image_title')) { ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label> Text Size</label><br>
                                            <input type="text" class="myinput2 width-50px" name="header_img_desc_font_size"
                                                value="<?= $header_image_desc_text->size_web ?>" placeholder="12">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $header_image_desc_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="header_img_desc_color"
                                                            id="bannertextcolor" value="<?= $header_image_desc_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="header_image_desc_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $header_image_desc_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                            ...
                            <?php if (check_auth_permission('header_image_description')) { ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label> Text Size</label><br>
                                            <input type="text" class="myinput2 width-50px" name="image_title_text_below_text_size"
                                                value="<?= $image_title_text_below_text->size_web ?>" placeholder="12">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $image_title_text_below_text->color ?>"></div>
                                                        <input type="color" class="colorinput" name="image_title_text_below_text_color"
                                                            id="bannertextcolor" value="<?= $image_title_text_below_text->color ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="image_title_text_below_text_font_family">
                                                ...
                                                <?php foreach ($font_family as $single) { ?>
                                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                                    <?= $image_title_text_below_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div id="timed_header_image">
                                    <div class="timedimages <?= $timed_header_image_settings->enable ? '' : 'hidden' ?>">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row nopadding datetimediv_popup">
                                                    ...
                                                    <div class="col-md-6 nopadding">
                                                        ...
                                                        <div class="timed_type_divs days_div" style="<?=$timed_header_image_settings->type=='days'?'display:block;':'display:none;'?>">
                                                            <div class="form-group">
                                                                <label for="start_time">Start Time</label>
                                                                <input type="time" name="header_image_start_time"
                                                                    class="myinput2" id="start_time"
                                                                    value="<?php echo $start_time->format('H:i'); ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="end_time">End Time</label>
                                                                <input type="time" name="header_image_end_time"
                                                                    class="myinput2" id="end_time"
                                                                    value="<?php echo $end_time->format('H:i'); ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Select Days</label>
                                                                <select class="myinput2 multiselectlist" name="header_image_days[]"
                                                                    multiple>
                                                                    <option value="mon"
                                                                        <?= is_array($days) && in_array('mon', $days) ? 'selected' : '' ?>>
                                                                        Monday</option>
                                            ...
                                            <div class="col-md-2">
                                                <div class="uploadImageDiv">
                                                    <button type="button" class="btn btn-primary btnuploadimagenew"
                                                        data-toggle="modal" data-target="#modalImagesforUploads">Upload
                                                        image</button>
                                                    <input type="hidden" name="imagefromgallery"
                                            ...
                                            <div class="col-md-3 timed_header_block_image_div">
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?= base_url('assets/uploads/'.get_current_url() . $timed_header_image->file_name) ?>"
                                                        width="100%">
                                                    <button type="button" class="btn btn-primary btnimgdel"
                                                        onclick="delete_front_image('<?= $timed_header_image->file_name ?>','timed_header_image','timed_header_block_image_div','images','0','true')">X</button>
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="myinput2 width-50px" name="header_scrollbar_width"
                                            value="<?= $header_images_settings->header_scrollbar_width ?>" placeholder="10">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center color-main-div">
                                            ...
                                            <div class="ml-10">
                                                <div class="inputcolordiv">
                                                    <div class="inputcolor"
                                                        style="background:<?= $header_images_settings->header_scrollbar_color ?>">
                                                    </div>
                                                    <input type="color" class="colorinput" name="header_scrollbar_color"
                                                        id="bannertextcolor"
                                                        value="<?= $header_images_settings->header_scrollbar_color ?>"
                                                        placeholder="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center titlediv">
                                        ...
                                        <div class="form-group ml-5 frontend">
                                            ...
                                            <label class="switch mb-2">
                                                <input type="checkbox" name="is_video" class="is_video_toggle" 
                                                    <?= $header_images_settings->is_video ? 'checked' : '' ?>>
                                                <span class="slider round "></span>
                                            </label>
                                        </div>
                                        <div class="form-group ml-5 ">
                                            ...
                                            <label class="switch mb-2">
                                                <input type="checkbox" name="is_autoplay" class="is_autoplay_toggle" 
                                                    <?= $header_images_settings->is_autoplay ? 'checked' : '' ?>>
                                                <span class="slider round "></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div id="header_slider">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $header_images_settings->header_slider_background ?>">
                                                        </div>
                                                        <input type="color" class="colorinput"
                                                            name="header_slider_background" id="bannertextcolor"
                                                            value="<?= $header_images_settings->header_slider_background ?>"
                                                            placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="slideronoff"
                                                    <?= $header_images_settings->slideronoff ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="slider_top_mobile"
                                                    <?= $header_images_settings->slider_top_mobile ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="header_slider_text" class="myinput2"
                                                value="<?= $header_slider_text->text ?>" placeholder="Slider Text here..">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center color-main-div">
                                                ...
                                                <div class="ml-10">
                                                    <div class="inputcolordiv">
                                                        <div class="inputcolor"
                                                            style="background:<?= $header_slider_text->color ?>"></div>
                                                        <input type="color" class="colorinput"
                                                            name="header_slider_text_color" id="bannertextcolor"
                                                            value="<?= $header_slider_text->color ?>" placeholder="#000000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="header_slider_text_font_size"
                                                value="<?= $header_slider_text->size_web ?>" placeholder="12">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="myinput2 width-50px"
                                                name="header_slider_text_font_size_mobile"
                                                value="<?= $header_slider_text->size_mobile ?>" placeholder="12">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="header_slider_text_font_family">
                                                ...
                                                <option style="font-family: <?= $single->value ?>;"
                                                    value="<?= $single->id ?>"
                                                    <?= $header_slider_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                                    <?= $single->name ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2" name="header_slider_text_position">
                                                <option value="centered-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'centered-text' ? 'selected' : '' ?>>
                                                    Centered</option>
                                                <option value="top-center-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'top-center-text' ? 'selected' : '' ?>>
                                                    Top Center</option>
                                                <option value="bottom-center-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'bottom-center-text' ? 'selected' : '' ?>>
                                                    Bottom Center</option>
                                                <option value="top-left-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'top-left-text' ? 'selected' : '' ?>>
                                                    Top Left</option>
                                                <option value="top-right-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'top-right-text' ? 'selected' : '' ?>>
                                                    Top Right</option>
                                                <option value="bottom-right-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'bottom-right-text' ? 'selected' : '' ?>>
                                                    Bottom Right</option>
                                                <option value="bottom-left-text"
                                                    <?= $header_images_settings->header_slider_text_position == 'bottom-left-text' ? 'selected' : '' ?>>
                                                    Bottom Left</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <?php foreach ($header_slider as $single) { ?>
                                            <?php if ($single->image) { ?>
                                                <div class="col-md-3 imgdiv{{ $single->id }}" style="margin-bottom:10px;">
                                                    ...
                                                    <button type="button" class="btn btn-primary btnimgdel delete-slider-image"
                                                        onclick="delete_front_image('<?= $single->image ?>','image','imgdiv{{ $single->id }}','header_sliders',<?= $single->id ?>)">X</button>
                                                    <?php } ?>
                                                </div>
                                            <?php } ?>
                                        <?php } ?>
                                ...
                                <div class="row" id="header_block_bottom">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 15px;">
                                        <div class="uploadImageDiv">
                                            <div class="upload-file-div display-table  btnuploadimagenew mb-2"
                                                data-toggle="modal" data-target="#modalImagesforUploads" data-ratio="landscape_new,landscape">
                                                <div class="vertical-middle">
                                                    <div class="title-3 text-color-grey2 text-center">Upload Default Image
                                                    </div>
                                                    <div class="title-5 text-color-grey2 text-center">Upload Image Here</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="header_slider_video_container">
                                        @if($header_slider_video && isset($header_slider_video->video)) 
                                                ...
                                                <button type="button" class="btn btn-primary btnimgdel "
                                                        onclick="delete_header_slider_video('<?= $header_slider_video->id ?>')">X</button>
                ...
                <div class="row form-bottom make-sticky">
                    <div class="col-md-12">
                        <button type="button" onclick="saveSettingHeader('save')" name="saveheader" class="btn btn-primary"
                            value="save">Save</button>
    ...
    <div class="contentdiv">
        ...
        <div class="editcontent"
            style="<?= isset($_GET['block'])  && $_GET['block'] == 'header_text_bluebar' ? 'display:block;' : '' ?>">
            <form action="{{ url('updateheadertext') }}" method="post" enctype="multipart/form-data">
                @csrf
                <?php if (check_auth_permission(['build_site_Content'])) { ?>
                    <div class="row mb-17">
                        <?php $header_text_outline = get_outline_settings('header_text_outline');?>
                        <div class="col-md-12 text-right">
                            <div class="align-all-right d-flex align-items-end">
                                <div class="form-group  d-flex align-items-center">
                                    <div for="" class="title-9 text-black">Turn On Outline</div>
                                    <label class="switch ml-7">
                                        <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="header_text_outline"
                                            <?php echo  $header_text_outline->active ? 'checked' : '' ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group ml-34">
                                    <div for="" class="title-9 text-black">Color of outline</div>
                                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $header_text_outline->outline_color ?>" placeholder="#000000" data-slug="header_text_outline">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_phone_title" id="bannertext"
                                    value="<?= $header_phone_title->text ?>" placeholder="Header phone Title">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_phone_title_color"
                                                id="bannertextcolor" value="<?= $header_phone_title->color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2" name="header_phone_title_font_family">
                                    ...
                                    <?php foreach ($font_family as $single) { ?>
                                    <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                        <?= $header_phone_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                        <?= $single->name ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="myinput2 width-50px"
                                    name="current_header_phone_call_title_font_size" id="btn2color"
                                    value="<?= $header_phone_title->size_web ?>" placeholder="16">
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_text_7_phone" id="bannertext"
                                    value="<?= $header_phone_text->text ?>" placeholder="Header phone">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_text_7_phone_color"
                                                id="bannertextcolor" value="<?= $header_phone_text->color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2" name="current_header_phone_call_font_family">
                                    ...
                                    <?php foreach ($font_family as $single) { ?>
                                    <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                        <?= $header_phone_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                        <?= $single->name ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="myinput2 width-50px"
                                    name="current_header_phone_call_font_size" id="btn2color"
                                    value="<?= $header_phone_text->size_web ?>" placeholder="16">
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_phonr_text_title" id="bannertext"
                                    value="<?= $header_phonr_text_title->text ?>" placeholder="Header phone text Title">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            <div class="inputcolor"
                                                style="background:<?= $header_phonr_text_title->color ?>"></div>
                                            <input type="color" class="colorinput" name="header_phone_text_title_color"
                                                id="bannertextcolor" value="<?= $header_phonr_text_title->color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2" name="header_text_title_font_family">
                                    ...
                                    <?php foreach ($font_family as $single) { ?>
                                    <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                        <?= $header_phonr_text_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                        <?= $single->name ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="myinput2 width-50px"
                                    name="current_header_phone_text_title_size" id="btn2color"
                                    value="<?= $header_phonr_text_title->size_web ?>" placeholder="16">
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_phone_text" id="bannertext"
                                    value="<?= $header_phone_text_2->text ?>" placeholder="Header phone">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_phone_text_color"
                                                id="bannertextcolor" value="<?= $header_phone_text_2->color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2" name="current_header_phone_text_font_family">
                                    ...
                                    <?php foreach ($font_family as $single) { ?>
                                    <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                        <?= $header_phone_text_2->fontfamily == $single->id ? 'selected' : '' ?>>
                                        <?= $single->name ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="myinput2 width-50px"
                                    name="current_header_phone_text_font_size" id="btn2color"
                                    value="<?= $header_phone_text_2->size_web ?>" placeholder="16">
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_address_title" id="bannertext"
                                    value="<?= $header_address_title->text ?>" placeholder="Header text">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_address_title_color"
                                                id="bannertextcolor" value="<?= $header_address_title->color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2 width-50px" name="header_address_title_fontsize"
                                    id="btn2color" value="<?= $header_address_title->size_web ?>" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2" name="header_address_title_font_family">
                                    ...
                                    <?php foreach ($font_family as $single) { ?>
                                    <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                        <?= $header_address_title->fontfamily == $single->id ? 'selected' : '' ?>>
                                        <?= $single->name ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_address2_street" id="bannertext"
                                value="<?= $header_address2_street->text ?>">
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_address2_citystatezipcode"
                                id="bannertext" value="<?= $header_address2_citystatezipcode->text ?>">
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_address2_comment" id="bannertext"
                                value="<?= $header_address2_comment->text ?>">
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2 width-50px" name="header_address_text_size2"
                                id="btn2color" value="<?= $header_address2_street->size_web ?>" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        <div class="inputcolor"
                                            style="background:<?= $header_address2_street->color ?>"></div>
                                        <input type="color" class="colorinput" name="header_address_text_color2"
                                            id="bannertextcolor" value="<?= $header_address2_street->color ?>"
                                            placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="myinput2" name="current_header_address_font_family">
                                ...
                                <?php foreach ($font_family as $single) { ?>
                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                    <?= $header_address2_street->fontfamily == $single->id ? 'selected' : '' ?>>
                                    <?= $single->name ?></option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                ...
                <div class="row form-bottom make-sticky">
                    <div class="col-md-12">
                        <button type="submit" name="savebusniessinfo" class="btn btn-primary"
                            value="save">Save</button>
                        <button type="submit" name="savebusniessinfo" class="btn btn-primary"
                            value="savereminders">Save & send reminder</button>
    ...
    <div class="contentdiv">
        ...
        <div class="editcontent"
            style="<?= isset($_GET['block'])  && $_GET['block'] == 'action_btns_bluebar' ? 'display:block;' : '' ?>">
            <form action="{{ url('updateheaderbuttons') }}" method="post" enctype="multipart/form-data">
                @csrf
                <?php if (check_auth_permission(['build_site_Content'])) { ?>
                    <div class="row mb-17">
                        <?php $header_buttons_outline = get_outline_settings('header_buttons_outline');?>
                        <div class="col-md-12 text-right">
                            <div class="align-all-right d-flex align-items-end">
                                <div class="form-group  d-flex align-items-center">
                                    <div for="" class="title-9 text-black">Turn On Outline</div>
                                    <label class="switch ml-7">
                                        <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="header_buttons_outline"
                                            <?php echo  $header_buttons_outline->active ? 'checked' : '' ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group ml-34">
                                    <div for="" class="title-9 text-black">Color of outline</div>
                                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $header_buttons_outline->outline_color ?>" placeholder="#000000" data-slug="header_buttons_outline">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4" id="header_text">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_text" id="headertext2"
                                value="<?= $header_text->text ?>" placeholder="Banner Text">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        ...
                                        <input type="color" class="colorinput" name="header_text_color"
                                            id="bannertextcolor" value="<?= $header_text->color ?>"
                                            placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2 width-50px" name="header_text_font_size"
                                value="<?= $header_text->size_web ?>" placeholder="12">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="myinput2" name="header_text_font_family">
                                ...
                                <?php foreach ($font_family as $single) { ?>
                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>"
                                    <?= $header_text->fontfamily == $single->id ? 'selected' : '' ?>>
                                    <?= $single->name ?></option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                ...
                <div class="row action-1">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="notificationswitch" name="header_btn1_enable"
                                    <?= $header_btn_1->active ? 'checked' : '' ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_btn1_text" id="btn1text"
                                value="<?= $header_btn_1->text ?>" placeholder="Leave blank to remove Button">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        ...
                                        <input type="color" class="colorinput" name="header_btn1_text_color"
                                            id="bannertextcolor" value="<?= $header_btn_1->text_color ?>"
                                            placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="myinput2 header_btn1_section width-145px action_button_selection" name="header_btn1_section">
                                ...
                                <option value="sms" <?= $header_btn_1->action_type == 'sms' ? 'selected' : '' ?>>SMS
                                </option>
                                <option value="email" <?= $header_btn_1->action_type == 'email' ? 'selected' : '' ?>>
                                    Email</option>
                                <option value="google_map"
                                    <?= $header_btn_1->action_type == 'google_map' ? 'selected' : '' ?>>Map</option>
                                <option value="address" <?= $header_btn_1->action_type == 'address' ? 'selected' : '' ?>>
                                    Address</option>
                                <option value="customforms"
                                    <?= $header_btn_1->action_type == 'customforms' ? 'selected' : '' ?>>Forms</option>
                                <?php foreach ($front_sections as $single) { ?>
                                <option value="<?= $single->slug ?>"
                                    <?= $header_btn_1->action_type == $single->slug ? 'selected' : '' ?>>
                                    <?= $single->name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                            ...
                            <div class="form-group action_fields action_link" <?= $header_btn_1->action_type != 'link' ? 'style="display:none;"' : '' ?>>
                                <input type="text"
                                    class="myinput2 btn1link " name="header_btn1_text_link" id="btn1link"
                                    value="<?= $header_btn_1->link ?>" placeholder="http://google.com">
                            </div>
                            <div class="form-group action_fields action_forms" <?= $header_btn_1->action_type != 'customforms' ? 'style="display:none;"' : '' ?>>
                                <select
                                    class="myinput2  width-145px" name="header_btn1_customforms" id="btn1customforms">
                                    <?php if(count($custom_forms)>0){ ?>
                                    <?php foreach($custom_forms as $single){ ?>
                                    <option value="<?= $single->id ?>"
                                        <?= $header_btn_1->custom_form_id == $single->id ? 'selected' : '' ?>>
                                        <?= $single->title ?></option>
                                    <?php } ?>
                                    <?php } ?>
                                </select>
                            ...
                            <div class=" action_fields action_map" style="<?= $header_btn_1->action_type == 'google_map' ? 'display:block' : 'display:none' ?>">
                                ...
                                <div class="form-group action_fields action_address" style="display:<?= $header_btn_1->address_id != '' && ( $header_btn_1->action_type == 'address') ? 'block' : 'none' ?>">
                                    ...
                                    <select name="header_btn1_address" class="myinput2">
                                        <?php foreach($addresses as $address){ ?>
                                            <option value="<?= $address->id ?>"
                                            <?= $header_btn_1->address_id == $address->id ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        <div class="inputcolor"
                                            style="background:<?= $header_btn_1->bg_color ?>"></div>
                                        <input type="color" class="colorinput" name="header_btn1_back_color"
                                            id="bannertextcolor" value="<?= $header_btn_1->bg_color ?>"
                                            placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php if (check_auth_permission(['action_buttons', 'action_button_text'])) { ?>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="bannertext">Enable</label><br>
                                <label class="switch">
                                    <input type="checkbox" class="notificationswitch" name="header_btn2_enable"
                                        <?= $header_btn_2->active ? 'checked' : '' ?>>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_btn2_text" id="bannertext"
                                    value="<?= $header_btn_2->text ?>" placeholder="Leave blank to remove Button">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    <div>
                                        <img src="{{ url('assets') }}/admin2/img/dismiss-color.svg" alt="" width=""
                                            class="dismiss-color">
                                    </div>
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            <div class="inputcolor" style="background:<?= $header_btn_2->text_color ?>"></div>
                                            <input type="color" class="colorinput" name="header_btn2_text_color"
                                                id="bannertextcolor" value="<?= $header_btn_2->text_color ?>"
                                                placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 header_btn2_section  width-145px action_button_selection" name="header_btn2_section" >
                                    ...
                                    <option value="sms" <?= $header_btn_2->action_type == 'sms' ? 'selected' : '' ?>>SMS</option>
                                    ...
                                    <option value="address" <?= $header_btn_2->action_type == 'address' ? 'selected' : '' ?>>Address
                                    </option>
                                    <option value="customforms" <?= $header_btn_2->action_type == 'customforms' ? 'selected' : '' ?>>
                                        Forms</option>
                                    <?php foreach ($front_sections as $single) { ?>
                                    <option value="<?= $single->slug ?>"
                                        <?= $header_btn_2->action_type == $single->slug ? 'selected' : '' ?>><?= $single->name ?>
                                    </option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group action_fields action_link">
                                <input type="text" <?= $header_btn_2->action_type != 'link' ? 'style="display:none;"' : '' ?>
                                    class="myinput2 btn2link" name="header_btn2_text_link" id="btn2link"
                                    value="<?= $header_btn_2->link ?>" placeholder="http://google.com">
                            </div>
                            <div class="form-group action_fields action_forms">
                                <select <?= $header_btn_2->action_type != 'customforms' ? 'style="display:none;"' : '' ?>
                                    class="myinput2  width-145px" name="header_btn2_customforms" id="btn2customforms">
                                    <?php if(count($custom_forms)>0){ ?>
                                        <?php foreach($custom_forms as $single){ ?>
                                            <option value="<?= $single->id ?>"
                                                <?= $header_btn_2->custom_form_id == $single->id ? 'selected' : '' ?>><?= $single->title ?>
                                            </option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group action_fields action_address" style="display:<?= $header_btn_2->address_id != '' && ( $header_btn_2->action_type == 'address') ? 'block' : 'none' ?>">
                                ...
                                <select name="header_btn2_address" class="myinput2">
                                    <?php foreach($addresses as $address){ ?>
                                        <option value="<?= $address->id ?>"
                                            <?= $header_btn_2->address_id == $address->id ? 'selected' : '' ?>>
                                            <?= $address->address_title ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_btn2_back_color"
                                                id="bannertextcolor" value="<?= $header_btn_2->bg_color ?>" placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row action-3">
                    <?php if (check_auth_permission(['action_buttons', 'action_button_text'])) { ?>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="bannertext">Enable</label><br>
                                <label class="switch">
                                    <input type="checkbox" class="notificationswitch" name="header_btn3_enable"
                                        <?= $header_btn_3->active ? 'checked' : '' ?>>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="myinput2" name="header_btn3_text" id="btn3text"
                                value="<?= $header_btn_3->text ?>" placeholder="Leave blank to remove Button">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        <div class="inputcolor" style="background:<?= $header_btn_3->text_color ?>"></div>
                                        <input type="color" class="colorinput" name="header_btn3_text_color"
                                            id="bannertextcolor" value="<?= $header_btn_3->text_color ?>" placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="myinput2 header_btn3_section width-145px action_button_selection" name="header_btn3_section">
                                <option value="link">Link</option>
                                <option value="call" <?= $header_btn_3->action_type == 'call' ? 'selected' : '' ?>>Call</option>
                                <option value="sms" <?= $header_btn_3->action_type == 'sms' ? 'selected' : '' ?>>SMS</option>
                                <option value="email" <?= $header_btn_3->action_type == 'email' ? 'selected' : '' ?>>Email</option>
                                <option value="google_map" <?= $header_btn_3->action_type == 'google_map' ? 'selected' : '' ?>>Map
                                </option>
                                <option value="address" <?= $header_btn_3->action_type == 'address' ? 'selected' : '' ?>>Address
                                </option>
                                <option value="customforms" <?= $header_btn_3->action_type == 'customforms' ? 'selected' : '' ?>>Forms
                                </option>

                                <?php foreach ($front_sections as $single) { ?>
                                <option value="<?= $single->slug ?>"
                                    <?= $header_btn_3->action_type == $single->slug ? 'selected' : '' ?>><?= $single->name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group action_fields phone_no_calls" style="<?= $header_btn_3->action_type == 'call' ? 'display:block' : 'display:none' ?>">
                            <label for="">Phone number for calls</label>
                            <input type="text" class="myinput2" name="header_btn3_action_phone_no_calls" value="<?= $header_btn_3->action_button_phone_no_calls ?>">
                        </div>
                        <div class="form-group action_fields phone_no_sms" style="<?= $header_btn_3->action_type == 'sms' ? 'display:block' : 'display:none' ?>">
                            <label for="">Phone number for sms</label>
                            <input type="text" class="myinput2" name="header_btn3_action_phone_no_sms" value="<?= $header_btn_3->action_button_phone_no_sms ?>">
                        </div>
                        <div class="form-group action_fields action_email" style="<?= $header_btn_3->action_type == 'email' ? 'display:block' : 'display:none' ?>">
                            <label for="">Email</label>
                            <input type="text" class="myinput2" name="header_btn3_action_email" value="<?= $header_btn_3->action_button_action_email ?>">
                        </div>
                        <div class=" action_fields action_link"  style="<?= $header_btn_3->action_type == 'link' ? 'display:block' : 'display:none' ?>"">
                            <input type="text" 
                            class="myinput2 btn3link" name="header_btn3_text_link" id="btn3link"
                            value="<?= $header_btn_3->link ?>" placeholder="http://google.com">
                        </div>
                        <div class=" action_fields action_forms"  style="<?= $header_btn_3->action_type == 'customforms' ? 'display:block' : 'display:none' ?>"">
                            <select 
                                class="myinput2  width-145px" name="header_btn3_customforms" id="btn3customforms">
                                <?php if(count($custom_forms)>0){ ?>
                                <?php foreach($custom_forms as $single){ ?>
                                <option value="<?= $single->id ?>"
                                    <?= $header_btn_3->custom_form_id == $single->id ? 'selected' : '' ?>><?= $single->title ?></option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                        </div>
                        <div class=" action_fields action_map" style="<?= $header_btn_3->action_type == 'google_map' ? 'display:block' : 'display:none' ?>">
                            <div class="form-group " >
                                <label for="address">Enter Address</label>
                        ...
                        <div class="form-group action_fields action_address" style="display:<?= $header_btn_3->address_id != '' && ( $header_btn_3->action_type == 'address') ? 'block' : 'none' ?>">
                            <label for="addressbtn1">Select an Address</label>
                            <select name="header_btn3_address" class="myinput2">
                                <?php foreach($addresses as $address){  ?>
                                    <option value="<?= $address->id ?>" <?= $header_btn_3->address_id == $address->id ? 'selected' : '' ?>><?= $address->address_title ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center color-main-div">
                                ...
                                <div class="ml-10">
                                    <div class="inputcolordiv">
                                        <div class="inputcolor" style="background:<?= $header_btn_3->bg_color ?>"></div>
                                        <input type="color" class="colorinput" name="header_btn3_back_color"
                                            id="bannertextcolor" value="<?= $header_btn_3->bg_color ?>" placeholder="#000000">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="contentdiv">
        ...
        <div class="editcontent"
            style="<?= isset($_GET['block'])  && $_GET['block'] == 'audio_files_bluebar' ? 'display:block;' : '' ?>">
            <form action="{{ url('updateaudiofiles') }}" method="post" enctype="multipart/form-data">
                @csrf
                <?php if (check_auth_permission(['build_site_Content'])) { ?>
                    <div class="row mb-17">
                        <?php $audio_files_outline = get_outline_settings('audio_files_outline');?>
                        <div class="col-md-12 text-right">
                            <div class="align-all-right d-flex align-items-end">
                                <div class="form-group  d-flex align-items-center">
                                    <div for="" class="title-9 text-black">Turn On Outline</div>
                                    <label class="switch ml-7">
                                        <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="audio_files_outline"
                                            <?php echo  $audio_files_outline->active ? 'checked' : '' ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group ml-34">
                                    <div for="" class="title-9 text-black">Color of outline</div>
                                    <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $audio_files_outline->outline_color ?>" placeholder="#000000" data-slug="audio_files_outline">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="notificationswitch" name="audio_auto_play"
                                    <?= $audio_files->audio_auto_play ? 'checked' : '' ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="notificationswitch" name="audio_repeat"
                                    <?= $audio_files->audio_repeat ? 'checked' : '' ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                        ...
                        if(!empty($single->title)){?>
                            <div class="col-md-6 imgdiv">
                                ...
                                <button type="button" class="btn btn-primary btnaudiofiledel"
                                    data-imgname="<?= $single->file ?>">X</button>
                            </div>
                    <?php 
                        }
                    } ?>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="audio_files[]" id="customFile"
                                    accept=".mp3,.mp4">
                ...
                <div class="row form-bottom make-sticky">
                    <div class="col-md-12">
                        <button type="submit" name="saveaudiosection" class="btn btn-primary"
                            value="save">Save</button>
                        <button type="submit" name="saveaudiosection" class="btn btn-primary"
                            value="savereminders">Save & send reminder</button>
