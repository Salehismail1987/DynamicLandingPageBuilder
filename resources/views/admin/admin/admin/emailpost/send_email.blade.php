        ...
        <div class="card-body">
            ...
            @csrf
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="teaser_title">Select Receiving Contacts <span style="font-size:12px;font-weight:bold">(multiple emails seperated by comma , )</span></label>
                            <input type="text" class="myinput2 customemail" name="select_contact" placeholder="Enter email addresses" required>
                        </div>
                        </div>
                    <div class="col-md-5">
                        <div class="form-group">
