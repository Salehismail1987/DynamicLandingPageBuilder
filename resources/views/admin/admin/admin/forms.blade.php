            ...
            <div class="d-flex">
              <div class="form-group  text-center">
                ...
                <label class="myswitchdiv">
                  <input type="checkbox" class="myswitch" name="tippopups" onchange="toggleSectionTips('custom_forms_maker',sub_sections)">
              ...
              <div class="form-group text-center ml-4">
                ...
                <label class="myswitchdiv switch_disabled">
                  <input type="checkbox" class="myswitch" name="notificationswitch" data-module="notification_form"
          ...
          <div class="form-group d-flex justify-content-end align-items-center m-3">
              ...
              <div class="mx-1">
                <form action="{{ url('forms') }}" method="GET">
                  <select class="form-control form-control-sm" name="form_list_per_page" id="form_list_per_page" onchange="this.form.submit()">
                    <option value="5" {{ $customForms->perPage() == 5 ? 'selected' : '' }}>5</option>
                    <option value="10" {{ $customForms->perPage() == 10 ? 'selected' : '' }}>10</option>
                    <option value="25" {{ $customForms->perPage() == 25 ? 'selected' : '' }}>25</option>
                    <option value="100" {{ $customForms->perPage() == 100 ? 'selected' : '' }}>100</option>
                  </select>
                </form>
              </div>
              <div>
                            ...
                            <td>
                              <div class="btn-group mb-1">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                  ...
                                  <a class="dropdown-item btncopyurl" href="javascript:void(0);" data-url="{{base_url('?pop='.$customForm->id)}}">Copy URL</a>
                                  @if(false)
                                  <a class="dropdown-item" href="javascript:void(0);"  data-toggle="modal" data-is_custom_modal='YES' data-target="#modalcustomforms{{$customForm->id}}">Open Form</a>
                                  @endif
                                </div>
                              </div>  
                            </td>
          ...
          <table class="w-100">
            <tbody class="sortableformsresponses">
              <?php foreach($customFormsAll as $singleform){ ?>
                ...
                <?php $formdata = get_custom_user_form_data($singleform->id,0); ?>
                        ...
                        <div class="col-md-12">
                          <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                            ...
                            <div>
                              ...
                              <?php if($formdt && is_array($formdt) && count($formdt)>0){?>
                                  {{count($formdt)}}
                              <?php }else {?>
                                0
                              <?php }?> - Responses
                      ...
                      <div class="editcontent2 tr-vetical-middle">
                        ...
                        <div class="table-responsive" data-subtable="custom_user_forms" style="max-height:400px"> <!-- (Hassan) Form name -->
                          <table id="<?=$dataunseen?'custom-form-table-'.$singleform->id:'example-'.$singleform->id?>"  class="table align-items-center table-flush dataTable" width="100%" cellspacing="0">
                              <?php if($formdata){ $fieldsshow = array();?>
                                    <thead class="thead-light">
                                        <tr>
                                          <th><input name="select_all" value="1" type="checkbox"></th>
                                          <th></th>
                                  ...
                                  <?php foreach($formdata as $single){ ?>
                                      ...
                                      ?>
                                          <tr   class="singleformResponseSections" data-sectionid="{{$single->id}}" >
                                            ...
                                            <td><div class="response-read @if ($single->seen=='0') response-read-not @endif"></div></td>
                                                          ...
                                                          if(is_array($form_feilds_unfied[strtolower($key)])){
                                                            foreach($form_feilds_unfied[strtolower($key)] as $sg){
                                                               ...
                                                               if(!validateTime($sg) && isDate($sg) && $sg !='01-01-1970'){
                                                                ...
                                                                echo date('d-m-Y',strtotime($sg)).'<br>';
                                                            ...
                                                            if(!validateTime($fs) && isDate($fs) && $fs !='01-01-1970'){
                                                                ...
                                                                echo date('d-m-Y',strtotime($fs)).'<br>';
                                              ...
                                              <td>
                                                <div class="btn-group mb-1 responses-action">
                                                  ...
                                                  <div class="dropdown-menu response-div{{$single->id}}" x-placement="bottom-start"   style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                    @if(false)
                                                      <a href="javascript:void(0);" class="dropdown-item" data-toggle="modal" data-is_custom_modal='YES' data-target="#modalcustomforms<?=$single->form_id?>">Open Form</a><br>
                                                    @endif
        ...
        <div class="contentdiv">
          ...
          <div class="editcontent" style="<?=(isset($_GET['block']) && $_GET['block']==cleanString($response_folder->title))?'display:block;':''?>">
              <?php foreach($customFormsAll as $singleform){ ?>
                <?php $formfieldsdata = get_custom_form_data($singleform->id); ?>  
                <?php $formfields = json_decode($formfieldsdata->fields);?>  
                <?php $formdata = get_custom_user_form_data($singleform->id,$response_folder->id); ?>
                            ...
                            <table id="example" class="table align-items-center table-flush dataTable" width="100%" cellspacing="0">
                                <?php if($formdata){ $fieldsshow = array();?>
                                    ...
                                    <?php foreach($formdata as $single){ ?>
                                        ...
                                        ?>
                                            <tr   class="singleformResponseSections" data-sectionid="{{$single->id}}" >
                                              <td><div class="response-read @if ($single->seen=='0') response-read-not @endif">
...
$(document).on('click', '.btnMultipleRead', function() {
    ...
    if(rows!=""){
      $.ajax({
          ...
          data: {_token: "{{ csrf_token() }}",rows: rows, seen:'1'},
          error: function (res) {
          },
          success: function(res) {
            window.location.href="forms?block=custom_forms_responses_list";
  ...
  $(document).on('click', '.btnMultipleUnRead', function() {
    ...
    if(rows!=""){
      $.ajax({
          type: "post",
          url: "<?php echo url('readmultipleuserform'); ?>" ,
          data: {_token: "{{ csrf_token() }}",rows: rows, seen:'0'},
          error: function (res) {
          },
          success: function(res) {
            window.location.href="forms?block=custom_forms_responses_list";
