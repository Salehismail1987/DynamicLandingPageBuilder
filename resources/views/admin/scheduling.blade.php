...
<div id="content">
  <div class="fixJumButtons mb-18">
    <div class="d-sm-flex justify-content-between align-items-center">
      <div class="title-1 text-color-blue2">Business Hours</div>
              ...
              <div class="col-md-3">
                <div class="form-group d-flex">
                  ...
                  <label class="switch ml-7">
                    <input type="checkbox" class="notificationswitch override_bg_enable scheduling_override_bg" name="scheduling_override_bg" data-slug="scheduling_bg_picker" <?php echo  $setHoursSettings->scheduling_override_bg ? 'checked' : '' ?>>
                    ...
                    <div class="form-group  d-flex align-items-center">
                        ...
                        <label class="switch ml-7">
                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="set_schedule_outline"
                                <?php echo  $set_schedule_outline->time != null ? 'checked' : '' ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="myinput2 width-50px" name="hour_image_desc_text_font_size" value="<?= isset($schedule_image_desc_text->size_web) ? $schedule_image_desc_text->size_web : '' ?>" placeholder="18">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>Schedule Image Description Text Color</label>
                        <input type="color" class="myinput2" name="hour_image_desc_text_color" value="<?= isset($schedule_image_desc_text->color) ? $schedule_image_desc_text->color : '' ?>" placeholder="#FFFFF">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
              ...
              <div class="content2">
                ...
                <div class="editcontent2">
                  <div class="row">
                    ...
                    <div class=" d-flex  text-center align-items-center col-md-3" style="justify-content: space-evenly">
                      <div class="vertical-middle">
                        <div class="label-sort label-sort-grey">3 letter Days</div>
                      </div>
                      <div class="form-group frontend">
                        <label class="switch">
                          <input type="checkbox" class="enableswitch_all_features" name="day_settings" <?= isset($setHoursSettings->day_settings) && $setHoursSettings->day_settings == 1 ? 'checked' : '' ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      <div class="vertical-middle">
                        <div class="label-sort label-sort-grey">Full Days</div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Sub-Title Text Size on Mobile</label><br>
        ...
        <?php if (check_auth_permission(['build_site_Content'])) { ?>
            ...
            <div class="row mb-17">
              <div class="col-md-3">
                <div class="form-group d-flex">
                  <label>Override Background <br>Color in Settings, Theme</label>
                  <label class="switch ml-7">
                    <input type="checkbox" class="notificationswitch override_bg_enable busniess_hours_override_bg" name="busniess_hours_override_bg" data-slug="busniess_hours_bg_picker" <?php echo  $rotatingScheduleSettings->busniess_hours_override_bg ? 'checked' : '' ?>>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group busniess_hours_bg_picker" style="display:<?php echo  $rotatingScheduleSettings->busniess_hours_override_bg ? 'block' : 'none' ?>">
                  <label>Feature's Background color</label>
                  <input type="color" class="myinput2" name="rotating_hours_background" value="<?= $rotatingScheduleSettings->background ? $rotatingScheduleSettings->background : '#000000' ?>">
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  <label>Day Tiles Background color</label>
                  <input type="color" class="myinput2" name="day_tile_bg_color" value="<?= $rotatingScheduleSettings->day_tile_bg_color ? $rotatingScheduleSettings->day_tile_bg_color : '#000000' ?>">
                </div>
              </div>
                    ...
                    <div class="form-group  d-flex align-items-center">
                        ...
                        <label class="switch ml-7">
                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="rotating_schedule_outline"
                                <?php echo  $rotating_schedule_outline->time != null ? 'checked' : '' ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="form-group ml-34">
          ...
          <div class="row p-2 sticky-buttons-list mb-2">
            <div class="col-12 pb-2  pt-2 mb-1 jump-to-buttons make-jumto-sticky" style="    background: #E3F3FF;" align="center">
              ...
              <?php
              $last_day = null;
              foreach ($rotatingSchedule as $key => $row) {
                if ($key > 6) {
                  break;
                }
              ?>
                <button type="button" data-value2="rotating_schedule_<?= $row->date ?>" data-value="rotat_<?= date('D_M_d_Y', strtotime($row->date)) ?>" class="btn ml-1 btn-jump mb-1 mt-1 btn-primary btn-sm  text-bold">
                  <?= strtoupper(date('D', strtotime($row->date))) ?>
                  <span style="font-weight:normal">
                    <?= strtoupper(date('M-d', strtotime($row->date))) ?>
                  </span>
                </button>
              <?php
            ...
            <div class="col-12 pb-2  pt-2 jump-to-buttons make-jumto-sticky" style="    background: #E3F3FF;" align="center">
              ...
              for ($i = 0; $i <= 6; $i++) { ?>
                <!--<button type="button" data-value2="rotating_schedule_<?= date('D', strtotime($last_day . ' +' . $i . ' days')) ?>" data-value="rotat_<?= date('D_M_d_Y', strtotime($last_day . ' +' . $i . ' days')) ?>" class="btn ml-1 btn-jump mb-1 mt-1 btn-primary btn-sm  text-bold-->
                <!--">-->
                <!--  <?= strtoupper(date('D', strtotime($last_day . ' +' . $i . ' days'))) ?>-->
                <!--  <span style="font-weight:normal">-->
                <!--    <?= strtoupper(date('M-d', strtotime($last_day . ' +' . $i . ' days'))) ?>-->
                <!--  </span>-->
                <!--</button>-->
              <?php
              }
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="myinput2 width-50px" name="day_master_image_description_text_size" value="<?= $master_image_description->size_web ?>" placeholder="18">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Master Image Description Text Color</label>
                      <input type="color" class="myinput2" name="day_master_image_description_text_color" value="<?= $master_image_description->color ?>" placeholder="#FFFFF">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
          ...
          if (check_auth_permission(['rotating_schedule', 'rotating_hours_time_settings'])) {
            ...
            $dailyhoursarray2 = array();
            if (count($rotatingSchedule)) {
              foreach ($rotatingSchedule as $key => $value) {
                $dailyhoursarray2[$value->date] = $value;
                $d[] = $value->duplicate_for_next_week_day;
              }
              ksort($dailyhoursarray2);
            }
          ?>
            <?php $date = date("Y-m-d") ?>
            <?php
            ...
            for ($i = 0; $i <= 13; $i++) {
              ...
              if (($index2 || $index2 == 0) && $index2 !== false) {
                ...
                $dailyhoursarray[$date] = isset($rotatingSchedule[$index2]) ? $rotatingSchedule[$index2] : $dailyhoursarray2[$date];
                $is_duplicated =  isset($rotatingSchedule[$index2]) ? true : false;
              } else {

                // if(!isset($dailyhoursarray2[$next_date]))
                // {
                ...
                if (!isset($dailyhoursarray2[$date])) {

                  // echo "<pre>";
                  // print_r($next_date.'-----'.$date);
                  // echo "<pre>";
                  $next_date = date("Y-m-d", strtotime("+1 day", strtotime($next_date)));
                  $date = date("Y-m-d", strtotime("+1 day", strtotime($date)));
                  // echo "<pre>";
                ...
                $dailyhoursarray[$date] = $dailyhoursarray2[$date];
              }
              // exit;
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="rotatinghoursid[{{$date}}]" value="<?= isset($dailyhoursarray2[$date]) ? $dailyhoursarray2[$date]->id : '' ?>">
                          <input type="hidden" name="duplication[{{$date}}]" value="<?= $d[$i] ?>">
                          <input type="hidden" name="dailyhours[{{$date}}]" value="<?= $dailyhoursarray[$date] ?>">
                          <input type="hidden" name="day[{{$date}}]" value="<?= date('D', strtotime($date)) ?>">
                          <input type="hidden" name="date[{{$date}}]" value="<?= date('Y-m-d', strtotime($date)) ?>">
                          <input type="hidden" name="is_duplicated[{{$date}}]" value="<?= $is_duplicated ? 'YES' : 'NO' ?>">
                        </div>
                      </div>
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            <label class="switch">
                              ...
                              <input type="checkbox" class="dailyhours repeat_hours" id="{{$dailyhoursarray[$date]->id}}" value="<?= date('D', strtotime($date)); ?>" name="duplications[<?= $date ?>]" <?= (isset($dailyhoursarray[$date]) && $dailyhoursarray[$date]->duplicate_for_next_week_day == '1') ? 'checked' : '' ?>>
                              <span class="slider round"></span>
                            </label>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_start[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->start : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label>End/Sub-Title #1 or Time #1</label>
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_end[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->end : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>#1 Comments</label>
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_comments[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->comments : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                    </div>
                    <br>
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_start2[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->start_2 : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label>End/Sub-Title #2 or Time #2</label>
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_end2[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->end_2 : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>#2 Comments</label>
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="daily_hours_comments2[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) ? $dailyhoursarray[$date]->comments_2 : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12" style="margin-bottom:15px;">
                        <div class="uploadImageDiv">
                          ...
                          <input type="hidden" name="imagefromgallery" class="imagefromgallery">
                          <input class="dataimage" type="hidden" name="day_image[<?= $date ?>]">
                          ...
                          <div class="col-md-4 imgdiv" style="display:none">
                            <br>
                            <img src='' width="100%" class="imagefromgallerysrc">
                            <button type="button" class="btn btn-primary btnimgdel btnimgremove" @if($is_duplicated && $d[$i]==0) disabled @endif>X</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <?php if (isset($dailyhoursarray[$date]) && !empty($dailyhoursarray[$date]->image)) {

                    ?>
                      <input type="hidden" name="old_day_image[<?= $date ?>]" value="<?= $dailyhoursarray[$date]->image ?>">
                      <div class="row">
                        <div class="col-md-4 day_image_div<?= $dailyhoursarray[$date]->id ?>">
                          <div class="form-group">
                            <img src="<?= base_url('assets/uploads/' . get_current_url() . $dailyhoursarray[$date]->image) ?>" width="100%">
                            <button type="button" class="btn btn-primary btnimgdel header_logo_delete" onclick="delete_front_image('<?= $dailyhoursarray[$date]->image  ?>','image','day_image_div<?= $dailyhoursarray[$date]->id ?>','rotating_schedules','<?= $dailyhoursarray[$date]->id ?>')" @if($is_duplicated && $d[$i]==0) readonly @endif>X</button>
                          </div>
                        </div>
                      </div>
                    <?php } ?>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="day_image_description_text[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) && isset($dailyhoursarray[$date]->image_description) ? $dailyhoursarray[$date]->image_description : '' ?>" placeholder="" @if($is_duplicated && $d[$i]==0) readonly @endif>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="myinput2 width-50px @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="day_image_description_text_font_size[{{$date}}]" value="<?= isset($dailyhoursarray[$date]) && isset($dailyhoursarray[$date]->description_font_size) ? $dailyhoursarray[$date]->description_font_size : '' ?>" placeholder="18">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="title_font_size">Day Image Description Font</label>
                          <select class="myinput2 @if($is_duplicated && $d[$i] == 0) readonly-input @endif" name="description_font_family[{{$date}}]" @if($is_duplicated && $d[$i]==0) readonly @endif>
                            <?php if (count($font_family) > 0) { ?>
                              <?php foreach ($font_family as $single) { ?>
                                <option style="font-family: <?= $single->value ?>;" value="<?= $single->id ?>" <?= isset($dailyhoursarray[$date]->description_font_family) && $dailyhoursarray[$date]->description_font_family == $single->id ? 'selected' : ''; ?>><?= $single->name ?></option>
                              <?php } ?>
                            <?php } ?>
                          </select>
                        </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      popupStatus();
      //     var dailyhours_json = <?php echo json_encode($dailyhoursarray2); ?>;
      //     for (var date in dailyhours_json) {
      //     if (dailyhours_json.hasOwnProperty(date)) {
      //         var duplicateForNextWeek = dailyhours_json[date].duplicate_for_next_week_day;
      //         if(duplicateForNextWeek === '1')
      //         {
      //           console.log('asdasd')
      ...
      //           var formattedDate = "rotat_" + dayOfWeek + "_" + month + "_" + dateObj.getDate().toString().padStart(2, '0')+ "_" + dateObj.getFullYear();
      //           var selector = '.' + formattedDate.replace(/ /g, "_") + ' input';
      //           $(selector).prop('readonly', true);        
      //           var selector = '.' + formattedDate.replace(/ /g, "_") + ' input[readonly]';
      //           $(selector).addClass('readonly-input');
      //         }
      //     }
      // }
