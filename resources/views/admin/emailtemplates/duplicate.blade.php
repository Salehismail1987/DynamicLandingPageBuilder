...
@section('content')
  <div class="container-fluid" id="container-wrapper">
      ...
      <h1 class="h3 mb-0 text-gray-800">Duplicate {{ $controller_name }}</h1>
      <a href="{{ url('crmcontrols?block=email_management') }}" class="btn btn-info " >
          Back
      </a>
      </div>
      <form class="data-form" role="form" method="post" enctype="multipart/form-data" action="{{ url('saveDuplicateEmailTemplate') }}/{{$edit_id}}">
        @csrf
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group quilleditor-div">
                        <label for="logo_text">Descriptive Text</label>
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php if (count($font_family) > 0) { ?>
                                    ...
                                    <?= $detail_info->content_title_font_family == $single->id ? 'selected' : ''; ?>
                                    ><?= $single->name ?></option>
                                    <?php } ?>
                                <?php } ?>
                                </select>
            ...
            <div class="content2">
                ...
                <div class="editcontent2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link" name="action_button_link">
                                    ...
                                    <option value="call" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == 'call' ? 'selected' : '' ?>>Call</option>
                                    <option value="sms" <?= isset($single->left_action_button_link) && $single->left_action_button_link == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                    <option value="email" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == 'email' ? 'selected' : '' ?>>Email</option>
                                    <option value="address" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == "address" ? 'selected' : '' ?>>Business Address</option>
                                    <option value="customforms" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link ==  "customforms" ? 'selected' : '' ?>>Link to Form</option>
                                    ...
                                    <option value="text_popup" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                    <option value="video" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                    ...
                                    <option value="google_map" <?= isset( $detail_info->action_button_link) &&  $detail_info->action_button_link == 'google_map' ? 'selected' : '' ?>>Map</option>
                            ...
                            <div class="form-group" style="display:<?= $detail_info->action_button_link == 'address'  ? 'block' : 'none' ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link_2" name="action_button_link_2">
                                    ...
                                    <option value="call" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == 'call' ? 'selected' : '' ?>>Call</option>
                                    <option value="sms" <?= isset($single->action_button_link_2) && $single->action_button_link_2 == 'sms' ? 'selected' : '' ?>>SMS Text</option>
                                    <option value="email" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == 'email' ? 'selected' : '' ?>>Email</option>
                                    <option value="address" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == "address" ? 'selected' : '' ?>>Business Address</option>
                                    <option value="customforms" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 ==  "customforms" ? 'selected' : '' ?>>Link to Form</option>
                                    <option value="image_popup" <?= isset($single->action_button_link_2) && $single->action_button_link_2 ==  "image_popup" ? 'selected' : '' ?>>Popup - Image</option>
                                    <option value="text_popup" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == 'text_popup' ? 'selected' : '' ?>>Popup - Text</option>
                                    <option value="video" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == 'video' ? 'selected' : '' ?>>Popup - Video</option>
                                    <option value="stripe" <?= isset($single->action_button_link_2) && $single->action_button_link_2 == "stripe" ? 'selected' : '' ?>>Popup - Payment</option>
                                    <option value="google_map" <?= isset( $detail_info->action_button_link_2) &&  $detail_info->action_button_link_2 == 'google_map' ? 'selected' : '' ?>>Map</option>
                                    <?php foreach ($front_sections as $single) { ?>
                    ...
                    <div class="row img-upload-container" style="margin-bottom: 15px;" >
                        ...
                        <div class="uploadImageDiv">
                            <button type="button" class="btn btn-primary btnuploadimagenew" data-toggle="modal" data-target="#modalImagesforUploads">Upload another image</button>
                            <input type="hidden" name="imagefromgallery" class="imagefromgallery">
