                ...
                <div class="col-lg-12">
                  ...
                  <div class="form-group">
                      ...
                      <select class="myinput2 header_btn3_section action_button_selection" name="btnsection" onchange="check_selction(this.value)">
                        ...
                        <option value="stripe" <?= $detail_info->btn_section == 'stripe' ? 'selected' :'' ?>>Stripe</option>
                        <option value="video" <?= $detail_info->btn_section == 'video' ? 'selected' : '' ?>>Video</option>
                        <option value="audioiconfeature" <?= $detail_info->btn_section == 'audioiconfeature' ? 'selected' : '' ?>>Audio Icon Feature</option>
                        <option value="google_map" <?= $detail_info->btn_section == 'google_map' ? 'selected' : '' ?>>Map</option>
                        <option value="text_popup" <?= $detail_info->btn_section == 'text_popup' ? 'selected' : '' ?>>Text Popup</option>
                        ...
                        <?php } ?>
                        <option value="eventForms" <?= $detail_info->btn_section == "eventForms" ? 'selected' : '' ?>>Event Forms</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group quilleditor-div action_fields  action_textpopup"  style="<?= $detail_info->btn_section == 'text_popup' ? 'display:block' : 'display:none' ?>">
                    ...
                    <div class="form-group action_fields audio_icon_feature" name="headerbtn3_audio_icon_feature"  style="<?= $detail_info->btn_section == 'audioiconfeature' ? 'display:block' : 'display:none' ?>">
                                ...
                                <div class="row">
                                <?php if ($detail_info->btn_section == 'audioiconfeature' && $detail_info->action_button_audio_icon_feature) {
                    ...
                    <div class="form-group action_fields video_upload" name="action_button_video1"  style="<?= $detail_info->btn_section == 'video' ? 'display:block' : 'display:none' ?>">
                        ...
                        @if(isset($detail_info->action_button_video) && $detail_info->action_button_video !='')
                            <div class=" position-relative d-flex newsfeed_action_button">
                            ...
                            <div class="remove_video_action btn btn-primary  " title="Click to Remove" data-type='newsfeed_action_button' data-id="{{$detail_info->id}}" data-file="{{$detail_info->action_button_video}}">X
                            </div> 
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="form-group action_fields audio_upload" name="feature_action_audio"  style="<?= $detail_info->btn_section == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                        <label for="customFile">Select File</label>
                        <div class="custom-file">
                    ...
                    <div class="form-group action_fields action_event_forms" style="<?= $detail_info->btn_section == 'eventForms' ? 'display:block' : 'display:none' ?>">
