...
<div class="container-fluid" id="container-wrapper">
    ...
    <form class="data-form" role="form" method="post" enctype="multipart/form-data" action="{{ url('saveDuplicateEmailPost') }}/{{$edit_id}}">
        @csrf
        <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link" name="action_button_link">
                                    ...
                                    <option value="image_popup" <?= isset($detail_info->action_button_link) && $detail_info->action_button_link ==  "image_popup" ? 'selected' : '' ?>>Popup - Image</option>
                                    ...
                                    <option value="stripe" <?= isset($detail_info->action_button_link) && $detail_info->action_button_link == "stripe" ? 'selected' : '' ?>>Popup - Payment</option>
                                    ...
                                    <option value="leftaudioiconfeature" <?= isset($detail_info->action_button_link) && $detail_info->action_button_link == "leftaudioiconfeature" ? 'selected' : '' ?>>Audio File with Icon</option>
                                ...
                                <select class="myinput2" name="action_button_event_form" id="customforms">
                                    <?php if (count($event_forms) > 0) { ?>
                                        <?php foreach ($event_forms as $singlecf) { ?>
                                            <option value="<?= $singlecf->id ?>" <?= isset($single->action_button_event_form) && $single->action_button_event_form == $singlecf->id ? 'selected' : '' ?>><?= $singlecf->title ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 news_post_action_button action_button_selection" id="action_button_link_2" name="action_button_link_2">
                                    <option value="link" <?= $detail_info->action_button_link_2 == 'link' ? 'selected' : '' ?>>Link</option>
                                    <option value="call" <?= $detail_info->action_button_link_2 == 'call' ? 'selected' : '' ?>>Call</option>
                                    <option value="sms" <?= $detail_info->action_button_link_2 == 'sms' ? 'selected' : '' ?>>SMS</option>
                                    <option value="email" <?= $detail_info->action_button_link_2 == 'email' ? 'selected' : '' ?>>Email</option>
                                    <option value="video" <?= $detail_info->action_button_link_2 == 'video' ? 'selected' : '' ?>>Video</option>
                                    <option value="google_map" <?= $detail_info->action_button_link_2 == 'google_map' ? 'selected' : '' ?>>Map</option>
                                    <option value="customforms" <?= $detail_info->action_button_link_2 == 'customforms' ? 'selected' : '' ?>>Forms</option>
                                    <?php foreach ($front_sections as $single) { ?>
                            ...
                            <div class="form-group action_fields action_event_forms" style="<?= $detail_info->action_button_link == 'attendhub' ? 'display:block' : 'display:none' ?>">
                                <select class="myinput2" name="action_button_event_form2" id="customforms">
                                    <?php if (count($event_forms) > 0) { ?>
                                        <?php foreach ($event_forms as $singlecf) { ?>
                                            <option value="<?= $singlecf->id ?>" <?= isset($single->action_button_event_form2) && $single->action_button_event_form2 == $singlecf->id ? 'selected' : '' ?>><?= $singlecf->title ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
