                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="section" class="myinput2 link_section_option action_button_selection" >
                            <option value="link" <?= $detail_info->link_type == 'link' ? 'selected' :'' ?>>Link to Outside Site</option>
                            <option value="call" <?= $detail_info->link_type == 'call' ? 'selected' :'' ?>>Call</option>
                            <option value="sms" <?= $detail_info->link_type == 'sms' ? 'selected' :'' ?>>SMS Text</option>
                            <option value="email" <?= $detail_info->link_type == 'email' ? 'selected' :'' ?>>Email</option>
                            <option value="address" <?= $detail_info->link_type == 'address' ? 'selected' : '' ?>>Business Address</option>
                            <option value="customforms" <?= $detail_info->link_type == "customforms" ? 'selected' : '' ?>>Forms</option>
                            <option value="text_popup" <?= $detail_info->link_type == 'text_popup' ? 'selected' :'' ?>>Popup - Text</option>
                            <option value="video" <?= $detail_info->link_type == 'video' ? 'selected' :'' ?>>Popup - Video</option>
