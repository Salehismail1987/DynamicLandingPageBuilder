...
$form2_setting = $frontSections->where('slug', 'contactForm2')->first();
$form3_setting = $frontSections->where('slug', 'contactForm3')->first();
...
if ($contact_info_block_title->enable == '1' || $contactBoxSettings->enable_texting_box || $contactBoxSettings->enable_address_box || $contactBoxSettings->enable_email_box || ($contactForms && count($contactForms) > 0) || isset($_GET['editwebsite'])) { ?>
  ...
  <div id="contact">
    <section class="contact nopadding">
      <?php if ($contact_info_block_title->enable == '1' && isset($contact_box_setting) && $contact_box_setting->section_enabled == 1 || ($frontSectionSetting->all_feature_for_edit_website && isset($_GET['editwebsite']))) { ?>
      ...
      <?php } ?>
      <?php if (isset($contact_box_setting) && $contact_box_setting->section_enabled == 1 || ($frontSectionSetting->all_feature_for_edit_website && isset($_GET['editwebsite']))) { ?>
      ...
      <?php } ?>
      <?php if ((isset($form1_setting) && $form1_setting->section_enabled == 1 || ($frontSectionSetting->all_feature_for_edit_website && isset($_GET['editwebsite']))) || (isset($form2_setting) && $form2_setting->section_enabled == 1 || ($frontSectionSetting->all_feature_for_edit_website && isset($_GET['editwebsite']))) || (isset($form3_setting) && $form3_setting->section_enabled == 1 || ($frontSectionSetting->all_feature_for_edit_website && isset($_GET['editwebsite'])))) { ?>
            ...
            <?php if (count($contactFormTitle->toArray()) > 0) { ?>
              <div class="section-title">
                ...
                foreach ($frontSections as $obj) {
                  if ($obj->slug == 'contactForm1' || $obj->slug == 'contactForm2' || $obj->slug == 'contactForm3') {
                    if ((!isset($_GET['editwebsite']) && $obj->section_enabled) || (isset($_GET['editwebsite']) && (($obj->section_enabled && !$frontSectionSetting->all_feature_enable_on_edit) || ($obj->section_enabled == 0 && $frontSectionSetting->all_feature_enable_on_edit == 1) || ($frontSectionSetting->all_feature_enable_on_edit == 1 && $obj->section_enabled)))) {
                            ...
                            <div class="<?= $form_class ?>">
                              <form action="<?= base_url('contactform') ?>" method="post" enctype="multipart/form-data" role="form" class="php-email-form">
                                ...
                                <div class="form-row">
                                  ...
                                  <div class="row">
                                    <div class="{{ ($single->show_map && !empty($single->form_google_map)) ? 'col-md-6' : 'col-md-4' }}">
                                      @if($single->permission)
                                      <label>
                                        <input type="checkbox" name="terms" required> <?= $single->tos_chkbox_text ?>
                                      </label>
                                      <div class="text-center"><button class="tos-btn" type="button">Terms of Service</button></div>
                                      @endif
                                    </div>
                                    <div class="{{ ($single->show_map && !empty($single->form_google_map)) ? 'col-md-6' : 'col-md-4' }}">
                                      <?php
    ...
    <?php }
      ...
      <?php } ?>
      <div class="modal" id="tosModal" tabindex="-1" role="dialog" style="z-index: 999999; display: none;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="    min-height: 200px;max-height: 350px; overflow-y: scroll; height: max-content;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="z-index: 19;">
