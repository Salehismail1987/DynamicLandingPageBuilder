                    ...
                    ?>
                                    ...
                                    <div class="<?=$contentcolumn?> pl-0  pr-0">
                                        ...
                                        <?php if (isset($single->action_button_active) && $single->action_button_active == '1') {
                                            ...
                                            elseif($single->action_button_link == "video" ){
                                                ...
                                                ?>
                                                <div style="display:none" id="actGalleryPostPopupText<?=$single->id?>">
                                        ...
                                        @if($single->action_button_link == "audioiconfeature" && isset($single->action_button_audio_icon_feature)) 
                                            <span class="descpostgall_icon_<?= $single->id ?>" onclick="playPauseAudio('gallpostAudio_<?=$single->id ?>')" >
                                                ...
                                                <a href="<?= $input_link ?>" 
                                                style="" class="btn btn-default text-bold new-action-btn btn-adjustable {{$class}} gallery-post-action-button-{{$single->id}} {{$audioclass}} " style=""><span style="position:absolute;left:10px;">
                          ...
                          <span class="text"><?= $single->action_button_discription ?></span></a>
                                        ...
                                        @else 
                                            ...
                                            onclick="openPopupText('actGalleryPostPopupText<?=$single->id?>')" 
                                            <?php }?>
                                    ...
                                    <?php if ($post_iamges && count($post_iamges) > 0) { ?>
                                        <div id="myCarouselpost<?= $single->id ?>" class="carousel slide gallery_post_slider_container" data-ride="carousel" <?php if($galleriesSettings->gallery_post_autoplay=='0'){ ?>data-interval="false"<?php }else{?> data-interval="<?= $interval ?>" <?php } ?>>
                                            <div class="carousel-inner">
                                                ...
                                                <?php } ?>
                                                @if($galleriesSettings->gallery_post_autoplay=='0' && count($post_iamges) > 1)
                                            ...
                                            <?= $single->post_title ?></h3>
                                                ...
                                                @if($single->action_button_link == "audioiconfeature" && isset($single->action_button_audio_icon_feature)) 
                                                    <span class="descpostgall_icon_<?= $single->id ?>" onclick="playPauseAudio('gallpostAudio_<?=$single->id ?>')" >
                                                        ...
                                                        <a href="<?= $input_link ?>" 
                                                        style="" class="btn btn-default btn-adjustable text-bold new-action-btn gallery-post-action-button-{{$single->id}} {{$audioclass}} " style=""><span style="position:absolute;left:10px;">
                          <i class="fa fa-volume-up" aria-hidden="true"></i></span>
                          <span class="text"><?= $single->action_button_discription ?></span></a>
                                                <div class="info-text">Click to hear Text</div>
                                                        <br>
                                        ...
                                        <h3 id="galleryposttitle<?= $single->id ?>" class="titlefontfamily galleryposttitle">
                                            ...
                                            @if($single->action_button_link == "audioiconfeature" && isset($single->action_button_audio_icon_feature)) 
                                                <span class="descpostgall_icon_<?= $single->id ?>" onclick="playPauseAudio('gallpostAudio_<?=$single->id ?>')" >
                                                    ...
                                                    <a href="<?= $input_link ?>" 
                                                    style="" class="btn btn-default text-bold new-action-btn gallery-post-action-button-{{$single->id}} {{$audioclass}} " style=""><span style="position:absolute;left:10px;">
                                                    <i   class="fa fa-volume-up descpostgall_icon_<?= $single->id ?>" style="margin-top:6px;"  aria-hidden="true"></i></span>
                          <span class="text"><?= $single->action_button_discription ?></span></a>
                                                <div class="info-text">Click to hear Text</div>
                                                    <br>
                                                </span>
                                            @else 
                                                ...
                                                <?php if ($single->action_button_link == "image_popup") 
