<div id="action-buttons-container">
    ...
    <div class="col-md-12 d-flex action-button-template">
        ...
        <input type="hidden" name="unique_slug[]" value="{{$button->unique_slug}}">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="myinput2 news_post_action_buttoncontent_count_number action_button_selection_learning" id="action_button_link" name="action_button_link[]">
                    ...
                    <option value="image_popup" {{ $button->action_type == 'image_popup' ? 'selected' : '' }}>Image Popup</option>
        ...
        <div class="col-md-3">
            ...
            <div class="form-group action_fields image_upload" name="feature_action_video2" style="display: {{ $button->action_type == 'image_popup' ? 'block' : 'none' }};">
            ...
            <div class="uploadImageDiv action_fields image_upload" style="display: {{ $button->action_type == 'image_popup' ? 'block' : 'none' }};">
                ...
                <input class="dataimage" type="hidden" name="popup_action_images[][]">
    ...
    <div class="col-md-12 d-flex action-button-template">
        ...
        <input type="hidden" name="unique_slug[]" value="">
        <div class="col-md-4">
            <div class="form-group">
                <label for="action_button_link">Action Button Application</label>
                <select class="myinput2 news_post_action_buttoncontent_count_number action_button_selection_learning" id="action_button_link" name="action_button_link[]">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group action_forms action_address" style="display:none">
                <label for="addressbtn1">Select an Address</label>
                <select name="action_button_address_id[]" class="myinput2">
                    @foreach ($addresses as $address)
