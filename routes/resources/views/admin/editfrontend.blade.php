...
<?php if (check_auth_permission(['build_site_Content'])) { ?>
  <div class="contentdiv">
    ...
    <div class="editcontent" style="<?= isset($_GET['block']) && $_GET['block'] == 'build_site_content_bluebar' ? 'display:block;' : '' ?>">
      ...
      <div class="content2">
        <form class="data-form" action="{{url('updateActionButton')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                <div class="title-2">Outlines & Features</div>
                <img src="{{url('assets')}}/admin2/img/arrow-down-grey.png" alt="" width="12px" class="">
              </div>
            </div>
          </div>
          <div class="editcontent2 action-buttons-container" id="action-buttons-container-1">
            ...
            <div class="col-md-12 text-center duplicate-row">
              <input type="hidden" name="featureSlug" value="outline_feature">
              <x-action-buttons :saveText="'Update Alert'" :featureSlug="'navbar'" :resetText="'Reset'" :frontSections="$front_sections" :buttonName="$alert_popup_feature_action_button_text" :customForms="$customForms" :addresses="$addresses" :allButtons="$outline_feature_buttons" customClass="popup-alert-buttons" />
            </div>
      ...
      <div class="content2">
        <form class="data-form" action="{{url('updateActionButton')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                <div class="title-2">Audio File<Section></Section>
                </div>
                <img src="{{url('assets')}}/admin2/img/arrow-down-grey.png" alt="" width="12px" class="">
              </div>
            </div>
          ...
          <div class="editcontent2 action-buttons-container" id="action-buttons-container-6">
            ...
            <div class="col-md-12 text-center duplicate-row">
              <input type="hidden" name="featureSlug" value="footer_audio">
              <x-action-buttons :saveText="'Update Alert'" :resetText="'Reset'" :frontSections="$front_sections" :buttonName="$alert_popup_feature_action_button_text" :customForms="$customForms" :addresses="$addresses" :allButtons="$audio_file_buttons" customClass="popup-alert-buttons" />
            </div>
      ...
      <div class="content2">
        <form class="data-form" action="{{url('updateActionButton')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
                <div class="title-2">Titles & Banners<Section></Section>
                </div>
                <img src="{{url('assets')}}/admin2/img/arrow-down-grey.png" alt="" width="12px" class="">
              </div>
            </div>
          ...
          <div class="editcontent2 action-buttons-container" id="action-buttons-container-6">
            ...
            <div class="col-md-12 text-center duplicate-row">
              <input type="hidden" name="featureSlug" value="title_banner">
              <x-action-buttons :saveText="'Update Alert'" :resetText="'Reset'" :frontSections="$front_sections" :buttonName="$alert_popup_feature_action_button_text" :customForms="$customForms" :addresses="$addresses" :allButtons="$title_banner_buttons" customClass="popup-alert-buttons" />
            </div>
      ...
      <div class="content2">
        <form class="data-form" action="{{url('updateBusinessCoach')}}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="grey-div d-flex justify-content-between align-items-center editbtn2">
        ...
        <form class="data-form staff_div" action="{{url('updateBusinessCoach')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="editcontent4 action-buttons-container" id="action-buttons-container-6">
            ...
            <div class="col-md-12 text-center duplicate-row">
              ...
              <x-action-buttons :saveText="'Update Alert'" :featureSlug="$category->name" :resetText="'Reset'" :frontSections="$front_sections" :buttonName="$alert_popup_feature_action_button_text" :customForms="$customForms" :addresses="$addresses" :allButtons="$buttons" customClass="popup-alert-buttons" />
            </div>
          </div>
        </form>
      </div>
