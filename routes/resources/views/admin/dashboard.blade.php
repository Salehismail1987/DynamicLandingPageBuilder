...
<div id="content">
  <div class="d-sm-flex justify-content-between mb-3">
    ...
    <!-- <div class="col-md-8 col-lg-6 col-sm-8 d-flex justify-content-end flex-row">
      <div class="row  d-flex justify-content-between" style="flex-wrap: nowrap;">
        <div class="col-md-3 col-lg-4 mt-4 tool_div_1">
          <div class="col-12 text-center">
            <div class="title-2 mb-1 text-center">Popup Activation</div>
          </div>
          <div class="col-12 text-center ">
          ...
          <div class="col-md-12">
          <div class="title-2 mb-1 popupOnOffStatus text-center">&nbsp;</div>
        </div>
        </div>
        <div class="col-md-3 col-lg-4 mt-4 tool_div_2">
          <div class="text-center">
            <div class="title-2 mb-1 text-center tipOnOffStatus">&nbsp;</div>
          </div>
          <div class="text-center">
        ...
        <div class="col-md-3 col-lg-4 mt-3 tool_div">
          <div class="col-12 text-center">
            <div class="title-2 mb-1 text-center">Controls in Settings</div>
            <div class="title-2 mb-1 text-center">Notifications</div>
          </div>
          <div class="col-12 text-center">
    ...
    <!-- <div class="col-md-7 col-lg-5 d-flex justify-content-between">
      <div class="mr-4 mt-4">
        <div class="form-group m-0 text-center">
          <div class="title-2 mb-1">Popup Activation</div>
          <label class="myswitchdiv popupTool">
            <input type="checkbox" class="notificationswitch myswitch updatepopup" name="popup_active" data-module="notification_quick_setting" <?= $alert_popup_setting->popup_active ? 'checked' : '' ?>>
            <img src="{{ url('assets/admin2/img/pop-up.svg') }}" alt="">
          </label>
