...
<head>
    ...
    <link href="{{ url('assets/admin') }}/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
                ...
                @endif
                    <ul class="list-unstyled components">
                        ...
                        <li class="@if($controller == 'quicksettings' || $controller == 'newsfeed' || $controller == 'frontend' || $controller == 'onestepbutton' || $controller == 'galleries' || $controller == 'scheduling' || $controller == 'blog'){{'active'}}@endif">
                            <a href="#websiteSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed">Tutorial Website</a>
                    ...
                    <div class="launch-website-div">
                        ...
                        <a href="{{ url('/home?editwebsite=true') }}" target="_blank" class="ml-10">Tutorial Website</a>
                    </diV>
                </diV>
            </nav>
