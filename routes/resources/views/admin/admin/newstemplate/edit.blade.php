...
<div class="container-fluid" id="container-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <form class="data-form" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('updatenewspost/' . $detail_info->id) ?>">
          @csrf
          <div class="row">
            <div class="col-lg-8">
              <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                value="<?php echo $detail_info->post_title_color; ?>" placeholder="#000000"
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                value="<?php echo $detail_info->post_title_size; ?>" placeholder="18"
                 <?php if($is_generic_setting_on){ ?> disabled <?php } ?>>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                value="<?php echo $detail_info->post_desc_color; ?>" placeholder="#000000"
                  <?php if($is_generic_setting_on){ ?> disabled <?php } ?>  
                  >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                value="<?php echo $detail_info->post_desc_font_size; ?>" placeholder="16"
                 <?php if($is_generic_setting_on){ ?> disabled <?php } ?>
                 >
              </div>
            </div>
                        ...
                        <div class="timed_type_divs timer_div" style="<?=$detail_info->timed_image_type=='timer'?'display:block;':'display:none;'?>">
                            <div class="form-group">
                                ...
                                <select name="image_timer" class="myinput2" id="image_timer">
                                    <option value="15" <?=$detail_info->image_timer=='15'?'selected':''?>>15 min</option>
                                    <option value="30" <?=$detail_info->image_timer=='30'?'selected':''?>>30 min</option>
                                    <option value="60" <?=$detail_info->image_timer=='60'?'selected':''?>>1 hour</option>
                                    <option value="120" <?=$detail_info->image_timer=='120'?'selected':''?>>2 hour</option>
                                    <option value="240" <?=$detail_info->image_timer=='240'?'selected':''?>>4 hour</option>
                                    <option value="360" <?=$detail_info->image_timer=='360'?'selected':''?>>6 hour</option>
                                    <option value="480" <?=$detail_info->image_timer=='480'?'selected':''?>>8 hour</option>
                                    <option value="720" <?=$detail_info->image_timer=='720'?'selected':''?>>12 hour</option>
                                    <option value="1440" <?=$detail_info->image_timer=='1440'?'selected':''?>>24 hour</option>
                                    <option value="2880" <?=$detail_info->image_timer=='2880'?'selected':''?>>48 hour</option>
                                  </select>
                            </div>
                        </div>
