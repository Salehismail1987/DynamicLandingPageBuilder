                      ...
                      <div class="form-group m-0 text-center">
                        <div class="title-2 mb-1 tipOnOffStatus">&nbsp;</div>
                          ...
                          <label class="myswitchdiv">
                            <input type="checkbox" class="myswitch" name="tippopups" onchange="toggleSectionTips('businessinfo',sub_sections)">
                      ...
                      <div class="form-group m-0 text-center">
                        <div class="title-2 mb-1">Controls in Settings</div>
                          ...
                          <label class="myswitchdiv switch_disabled">
                            <input type="checkbox" class="myswitch" name="alltipspopup" data-module="notification_busniess_info"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="myinput2" name="contact_email" id="contact_email" value="<?= $businessInfo->contact_email ?>" placeholder="example@gmail.com">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="contact_phoneno">Business Phone Number</label>
                  <input type="text" class="myinput2" name="contact_phoneno" id="contact_phoneno" value="<?= $businessInfo->contact_phoneno ?>" placeholder="+123456789">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="editcontent mb-13" style="<?=isset($_GET['block']) && $_GET['block']=='manager_recommendations'?'display:block;':''?>">
          <form action="{{url('updaterecommendations')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="product_info">App Manager's Recommendations and Notes</label>
                  <textarea rows="6" class="myinput2 p-2" name="app_manager_recommendations" id="app_manager_recommendations" placeholder="Enter comments"><?= $businessInfo->app_manager_recommendations ?></textarea>
                </div>
              </div>
            </div>
            <div class="row form-bottom make-sticky">
      ...
      <div class="editcontent mb-13" style="<?=isset($_GET['block']) && $_GET['block']=='social_media'?'display:block;':''?>">
        <form action="{{url('updatesocialmedia')}}" method="post" enctype="multipart/form-data">
          ...
          <?php if (check_auth_permission(['build_site_Content'])) { ?>
            <div class="row mb-17">
                <?php $social_media_outline = get_outline_settings('social_media_outline');?>
                    ...
                    <div class="align-all-right d-flex align-items-end">
                        <div class="form-group  d-flex align-items-center">
                            ...
                            <label class="switch ml-7">
                                <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="social_media_outline"
                                    <?php echo  $social_media_outline->time != null ? 'checked' : '' ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                        <div class="form-group ml-34">
                          <div for="" class="title-9 text-black">Color of outline</div>
                            <input type="color" class="myinput2 updateoutlinecolor" name="outline_color" value="<?php echo $social_media_outline->outline_color ?>" placeholder="#000000" data-slug="social_media_outline">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <tbody>
              <?php if (count($admin_users) > 0) { ?>
                ...
                foreach ($admin_users as $row) { 
                  if(Auth::user()->admin_type == '1' || $row->get_user_role->ranking > getUserRollRank()){
                  $i++; ?>
                  <tr>
                    <td>
                      @if($row->photo && file_get_contents(url("assets/uploads/".get_current_url().$row->photo)))
                    ...
                    <?php if (Auth::user()->admin_type == '1' || $row->user_role > Auth::user()->user_role) { ?>
                      <td>
                        <div class="btn-group">
  ...
  <?php if (check_auth_permission(['permissions'])) { ?>
    <div class="contentdiv">
      <div class="btnedit openEditContent" id="permissions" data-top="alert_banner_top" data-bottom="alert_banner_bottom" data-tip_section="permissions">
          <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex  align-items-center">
                  <div class="title-1 text-color-blue ">Permissions</div>
              </div>
              <div class="d-flex  align-items-center">
