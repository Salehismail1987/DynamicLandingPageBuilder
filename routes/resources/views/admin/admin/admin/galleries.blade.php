              ...
              <div class="d-flex">
                <div class="form-group  text-center">
                  ...
                  <label class="myswitchdiv">
                    <input type="checkbox" class="myswitch" name="tippopups" onchange="toggleSectionTips('gallaries',sub_sections)">
                ...
                <div class="form-group ml-4 text-center">
                  ...
                  <label class="myswitchdiv switch_disabled">
                    <input type="checkbox" class="myswitch" name="notificationswitch" data-module="notification_galleries"
            ...
            <div class="col-md-3">
                  <div class="form-group  d-flex">
                      ...
                      <label class="switch ml-7">
                          <input type="checkbox" class="notificationswitch override_bg_enable gallery_posts_override_bg" name="gallery_posts_override_bg" data-slug="gallery_posts_bg_picker"
                              <?php echo  $galleriesSettings->gallery_posts_override_bg ? 'checked' : '' ?>>
                        ...
                        <div class="ml-10">
                            <div class="inputcolordiv">
                                ...
                                <input type="color" class="colorinput"
                                    name="gallery_post_background" id="bannertextcolor"
                                    value="<?= $galleriesSettings->gallery_post_background ?>"
                                    placeholder="#000000">
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="form-group  d-flex align-items-center">
                          ...
                          <label class="switch ml-7">
                              <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="gallery_post_outline"
                                  <?php echo  $gallery_post_outline->active ? 'checked' : '' ?>>
                              <span class="slider round"></span>
                          </label>
                      </div>
                  ...
                  <tbody class="sortablegalleryposttable">
                    <?php if (count($galleryPost) > 0) { ?>
                      ...
                      foreach ($galleryPost as $row) {
                        $i++; ?>
                        <tr id="galleryPostDiv<?= $row->id ?>" class="gallerypostsections" data-sectionid="<?= $row->id ?>"
                        onclick="showGalleryPostActionModal(<?=$row->id?>)"
                        >
                          <td>
            ...
            <div class="row mb-17">
              <div class="col-md-3">
                  <div class="form-group d-flex">
                      <label>Override Background <br>Color in Settings, Theme</label>
                      <label class="switch ml-7">
                          <input type="checkbox" class="notificationswitch override_bg_enable gallery_slider_override_bg" name="gallery_slider_override_bg" data-slug="gallery_slider_bg_picker"
                              <?php echo  $galleriesSettings->gallery_slider_override_bg ? 'checked' : '' ?>>
                          <span class="slider round"></span>
                      </label>
                  </div>
              </div>
              <div class="col-md-3">
                <div class="form-group gallery_slider_bg_picker" style="display:<?php echo  $galleriesSettings->gallery_slider_override_bg ? 'block' : 'none' ?>">
                  <label for="gallery_back_color">Gallery Slider Background Color</label>
                  <input type="color" class="myinput2" name="gallery_back_color" id="gallery_back_color" value="<?= $galleriesSettings->gallery_slider_background ?>" placeholder="#000000">
                </div>
              </div>  
                      ...
                      <div class="form-group  d-flex align-items-center">
                          ...
                          <label class="switch ml-7">
                              <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="gallery_slider_outline"
                                  <?php echo  $gallery_slider_outline->active ? 'checked' : '' ?>>
                              <span class="slider round"></span>
                          </label>
                      </div>
                      <div class="form-group ml-34">
                  ...
                  <tbody class="sortableslidertable">
                    <?php if (count($gallerySlider) > 0) { ?>
                      ...
                      foreach ($gallerySlider as $row) {
                        $i++; ?>
                        <tr class="imgdiv<?= $row->id ?> galleryslidersections" data-sectionid="<?= $row->id ?>"
                          onclick="showGallerySliderActionModal(<?=$row->id?>)"
                          >
                          <td>
                            <?php if ($row->image) { ?>
          ...
          <div class="row mb-17">
            <div class="col-md-3">
              <div class="form-group d-flex">
                  <label>Override Background <br>Color in Settings, Theme</label>
                  <label class="switch ml-7">
                      <input type="checkbox" class="notificationswitch override_bg_enable gallery_video_override_bg" name="gallery_video_override_bg" data-slug="gallery_video_bg_picker"
                          <?php echo  $galleriesSettings->gallery_video_override_bg ? 'checked' : '' ?>>
                      <span class="slider round"></span>
                  </label>
              </div>
            </div>
                    ...
                    <div class="form-group  d-flex align-items-center">
                        ...
                        <label class="switch ml-7">
                            <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="gallery_video_outline"
                                <?php echo  $gallery_video_outline->active ? 'checked' : '' ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="form-group ml-34">
                  ...
                  <tbody class="sortablegalleryvideostable">
                    <?php if (count($galleryVideo) > 0) { ?>
                      ...
                      foreach ($galleryVideo as $row) {
                        $i++; ?>
                        <tr class="galleryvideossections" data-sectionid="<?= $row->id ?>"
                        onclick="showGalleryVideoActionModal(<?=$row->id?>)"
                        >
                          <td class="hide-mobile">
          ...
          <div class="row mb-17">
              <div class="col-md-3">
                  <div class="form-group d-flex">
                      <label>Override Background <br>Color in Settings, Theme</label>
                      <label class="switch ml-7">
                          <input type="checkbox" class="notificationswitch override_bg_enable gallery_tiles_override_bg" name="gallery_tiles_override_bg" data-slug="gallery_tiles_bg_picker"
                              <?php echo  $galleriesSettings->gallery_tiles_override_bg ? 'checked' : '' ?>>
                          <span class="slider round"></span>
                      </label>
                  </div>
              </div>
                      ...
                      <div class="form-group  d-flex align-items-center">
                          ...
                          <label class="switch ml-7">
                              <input type="checkbox" class="notificationswitch updateoutlineactive" name="outline_enable" data-slug="gallery_tiles_outline"
                                  <?php echo  $gallery_tiles_outline->active ? 'checked' : '' ?>>
                              <span class="slider round"></span>
                          </label>
                      </div>
                      <div class="form-group ml-34">
                  ...
                  <tbody class="sortablegallerytiletable">
                    <?php if (count($galleryTiles) > 0) { ?>
                      ...
                      foreach ($galleryTiles as $row) {
                        $i++; ?>
                        <tr class="imgdiv<?= $row->id ?> gallerytilesections" data-sectionid="<?= $row->id ?>" 
                        <?php //if($user_agent){ ?>
                          onclick="showGalleryTileActionModal(<?=$row->id?>)"
                        <?php //} ?>
                        >
                          <td><?php
                              if ($row->image) {
