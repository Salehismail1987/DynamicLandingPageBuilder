            ...
            <div class="d-flex">
              <div class="form-group text-center">
                ...
                <label class="myswitchdiv">
                  <input type="checkbox" class="myswitch" name="tippopups" onchange="toggleSectionTips('blog',sub_sections)">
                  <img src="{{url('assets/admin2/img/tips.png')}}" alt="">
                </label>
              </div>
              <div class="form-group ml-43 text-center">
                ...
                <label class="myswitchdiv switch_disabled">
                  <input type="checkbox" class="myswitch" name="notificationswitch" data-module="notification_blog"
