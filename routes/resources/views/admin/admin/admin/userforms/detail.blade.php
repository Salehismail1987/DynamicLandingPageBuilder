        ...
        <div class="card mb-4 card-border">
            <div class="card-body card-body-padding-border">
              <div class="d-flex justify-content-between align-items-center">
                ...
                @if (false)
                    <button type="button" class="btn btn-sm btn-primary mb-10" data-toggle="modal" data-target="#modalcustomforms<?=$formdata->form_id?>">Open Form</button>
                @endif
            </div>
          </div>
        </div>
