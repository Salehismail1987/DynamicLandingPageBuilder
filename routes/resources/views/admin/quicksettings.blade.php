                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="notificationswitch" name="featureActionButton" <?= $alert_popup_feature_action_button->active ? 'checked' : '' ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2 header_btn2_section action_button_selection" name="feature_action_button_link">
                                                ...
                                                <option value="call" <?= $alert_popup_feature_action_button->action_type == 'call' ? 'selected' : '' ?>>
                                                    Call</option>
                                                <option value="sms" <?= $alert_popup_feature_action_button->action_type == 'sms' ? 'selected' : '' ?>>
                                                    SMS</option>
                                                <option value="email" <?= $alert_popup_feature_action_button->action_type == 'email' ? 'selected' : '' ?>>
                                                    Email</option>
                                                <option value="video" <?= $alert_popup_feature_action_button->action_type == 'video' ? 'selected' : '' ?>>
                                                    Video</option>
                                                <option value="audioiconfeature" <?= $alert_popup_feature_action_button->action_type == 'audioiconfeature' ? 'selected' : '' ?>>
                                                    Audio Icon Feature</option>
                                                <option value="google_map" <?= $alert_popup_feature_action_button->action_type == 'google_map' ? 'selected' : '' ?>>
                                                    Map</option>
                                                <option value="text_popup" <?= $alert_popup_feature_action_button->action_type == 'text_popup' ? 'selected' : '' ?>>
                                                    Text Popup</option>
                                                <option value="image_popup" <?= $alert_popup_feature_action_button->action_type == 'image_popup' ? 'selected' : '' ?>>
                                                    Image Popup</option>
                                                <option value="address" <?= $alert_popup_feature_action_button->action_type == 'address' ? 'selected' : '' ?>>
                                                    Address</option>
                                                ...
                                                <?php foreach ($front_sections as $single) { ?>
                                                    <option value="<?= $single->slug ?>" <?= $alert_popup_feature_action_button->action_type == $single->slug ? 'selected' : '' ?>>
                                                        <?= $single->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group quilleditor-div action_fields  action_textpopup" style="<?= $alert_popup_feature_action_button->action_type == 'text_popup' ? 'display:block' : 'display:none' ?>">
                                            <label>Popup Text </label>
                                            <textarea class="myinput2 editordata hidden" name="feature_action_button_textpopup"><?php echo $alert_popup_feature_action_button->action_button_textpopup; ?></textarea>
                                            <div class="quilleditor">
                                                <?php echo $alert_popup_feature_action_button->action_button_textpopup; ?>
                                            </div>
                                        </div>
                                        <div class="form-group action_fields audio_upload" name="feature_action_audio" style="<?= $alert_popup_feature_action_button->action_type == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                                        ...
                                        <div class="form-group action_fields audio_icon_feature" name="alertp_audio_icon_feature" style="<?= $alert_popup_feature_action_button->action_type == 'audioiconfeature' ? 'display:block' : 'display:none' ?>">
                                            <label for="customFile">Select File</label>
                                            <div class="custom-file">
                                            ...
                                            <div class="row">
                                                <?php if ($alert_popup_feature_action_button->action_type == 'audioiconfeature' && $alert_popup_feature_action_button->action_button_audio_icon_feature) {
                                        ...
                                        <div class="form-group action_fields video_upload" name="feature_action_video2" style="<?= $alert_popup_feature_action_button->action_type == 'video' ? 'display:block' : 'display:none' ?>">
                                        ...
                                        <div class="form-group action_fields image_upload" name="feature_action_video2" style="<?= $alert_popup_feature_action_button->action_type == 'image_popup' ? 'display:block' : 'display:none' ?>">
                                        ...
                                        <div class="clearfix">
                                            <div class="form-group action_fields action_link" style="<?= $alert_popup_feature_action_button->action_type == 'link' ? 'display:block' : 'display:none' ?>">
                                                <input type="text" class="myinput2 btn0link" name="feature_button_text_link" id="btn0link" value="<?= $alert_popup_feature_action_button->link ?>" placeholder="http://google.com">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <?php if ($alert_popup_feature_action_button->action_type == 'audiofeature' && $alert_banner_action->action_button_audio) {
                                        ...
                                        <div class="clearfix action_fields action_address" id="address-list-alert-1" style="display:<?= $alert_popup_feature_action_button->address_id == 'address' ? 'block' : 'none' ?>">
                                            <div class="form-group">
                                                <label for="addressbtn1">Select an Address</label>
                                                <select name="feature_action_button_address" class="myinput2">
                                                    <?php foreach ($addresses as $address) { ?>
                                                        <option value="<?= $address->id ?>" <?= $alert_popup_feature_action_button->address_id == $address->id ? 'selected' : '' ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="myinput2 header_btn2_section action_button_selection" name="new_action_button_link">
                                                ...
                                                <option value="call" <?= $alert_popup_new_action_button->action_type == 'call' ? 'selected' : '' ?>>
                                                    Call</option>
                                                <option value="sms" <?= $alert_popup_new_action_button->action_type == 'sms' ? 'selected' : '' ?>>
                                                    SMS</option>
                                                <option value="email" <?= $alert_popup_new_action_button->action_type == 'email' ? 'selected' : '' ?>>
                                                    Email</option>
                                                <option value="video" <?= $alert_popup_new_action_button->action_type == 'video' ? 'selected' : '' ?>>
                                                    Video</option>
                                                <option value="google_map" <?= $alert_popup_new_action_button->action_type == 'google_map' ? 'selected' : '' ?>>
                                                    Map</option>
                                                <option value="text_popup" <?= $alert_popup_new_action_button->action_type == 'text_popup' ? 'selected' : '' ?>>
                                                    Text Popup</option>
                                                <option value="image_popup" <?= $alert_popup_feature_action_button->action_type == 'image_popup' ? 'selected' : '' ?>>
                                                    Image Popup</option>
                                                <option value="audioiconfeature" <?= $alert_popup_new_action_button->action_type == 'audioiconfeature' ? 'selected' : '' ?>>
                                                    Audio Icon Feature</option>
                                                <option value="address" <?= $alert_popup_new_action_button->action_type == 'address' ? 'selected' : '' ?>>
                                                    Address</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="myinput2 header_btn1_section width-145px action_button_selection" name="header_btn1_section">
                                ...
                                <option value="video" <?= $header_btn_1->action_type == 'video' ? 'selected' : '' ?>>Video</option>
                                <option value="text_popup" <?= $header_btn_1->action_type == 'text_popup' ? 'selected' : '' ?>>Text Popup</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 header_btn2_section  width-145px action_button_selection" name="header_btn2_section">
                                    ...
                                    <option value="video" <?= $header_btn_2->action_type == 'video' ? 'selected' : '' ?>>Video
                                    </option>
                                    ...
                                    <option value="text_popup" <?= $header_btn_2->action_type == 'text_popup' ? 'selected' : '' ?>>Text Popup
                                    </option>
                ...
                <div class="row action-3">
                    <?php if (check_auth_permission(['action_buttons', 'action_button_text'])) { ?>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="bannertext">Enable</label><br>
                                <label class="switch">
                                    <input type="checkbox" class="notificationswitch" name="header_btn3_enable" <?= $header_btn_3->active ? 'checked' : '' ?>>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="myinput2" name="header_btn3_text" id="btn3text" value="<?= $header_btn_3->text ?>" placeholder="Leave blank to remove Button">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_btn3_text_color" id="bannertextcolor" value="<?= $header_btn_3->text_color ?>" placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php if (check_auth_permission(['action_buttons', 'action_button_link'])) { ?>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="myinput2 header_btn3_section width-145px action_button_selection" name="header_btn3_section">
                                    ...
                                    <option value="video" <?= $header_btn_3->action_type == 'video' ? 'selected' : '' ?>>Video
                                    </option>
                                    <option value="audioiconfeature" <?= $header_btn_3->action_type == 'audioiconfeature' ? 'selected' : '' ?>>
                                        Audio Icon Feature</option>
                                    <option value="google_map" <?= $header_btn_3->action_type == 'google_map' ? 'selected' : '' ?>>Map
                                    </option>
                                    <option value="text_popup" <?= $header_btn_3->action_type == 'text_popup' ? 'selected' : '' ?>>Text Popup
                                    </option>
                                    ...
                                    <?php foreach ($front_sections as $single) { ?>
                                        <option value="<?= $single->slug ?>" <?= $header_btn_3->action_type == $single->slug ? 'selected' : '' ?>><?= $single->name ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <input type=" text" class="myinput2 btn3link" name="header_btn3_text_link" id="btn3link" value="<?= $header_btn_3->link ?>" placeholder="http://google.com">
                            </div>
                            <div class="form-group action_fields audio_upload" name="feature_action_audio" style="display: none;">
                                <label for="customFile">Select File</label>
                                <div class="custom-file">
                            ...
                            <div class="row">
                                <?php if ($header_btn_3->action_type == 'audiofeature' && $header_btn_3->action_button_audio) {
                            ...
                            <br>
                            <div class="form-group action_fields audio_icon_feature" name="headerbtn3_audio_icon_feature" style="<?= $header_btn_3->action_type == 'audioiconfeature' ? 'display:block' : 'display:none' ?>">
                                <label for="customFile">Select File</label>
                                <div class="custom-file">
                                ...
                                <div class="row">
                                    <?php if ($header_btn_3->action_type == 'audioiconfeature' && $header_btn_3->action_button_audio_icon_feature) {
                            ...
                            <div class="form-group action_fields video_upload" name="header_action_video3" style="<?= $header_btn_3->action_type == 'video' ? 'display:block' : 'display:none' ?>">
                                <label for="customFile">Upload Video</label>
                                <div class="custom-file">
                            ...
                            <select 
                                ...
                                <?php if (count($custom_forms) > 0) { ?>
                                    <?php foreach ($custom_forms as $single) { ?>
                                        <option value="<?= $single->id ?>" <?= $header_btn_3->custom_form_id == $single->id ? 'selected' : '' ?>><?= $single->title ?></option>
                                    <?php } ?>
                                <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-12 d-flex justify-content-end">
                            <div class="col-md-6 col-sm-12 p-0">
                                <div class="form-group">
                                    <div class="form-group quilleditor-div action_fields  action_textpopup" style="<?= $header_btn_3->action_type == 'text_popup' ? 'display:block' : 'display:none' ?>">
                                        <label>Popup Text </label>
                                        <textarea class="myinput2 editordata hidden" name="header_btn3_action_button_textpopup"><?php echo $header_btn_3->action_button_textpopup; ?></textarea>
                                        <div class="quilleditor">
                                            <?php echo $header_btn_3->action_button_textpopup; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-center color-main-div">
                                    ...
                                    <div class="ml-10">
                                        <div class="inputcolordiv">
                                            ...
                                            <input type="color" class="colorinput" name="header_btn3_back_color" id="bannertextcolor" value="<?= $header_btn_3->bg_color ?>" placeholder="#000000">
                                        </div>
                                    </div>
                                </div>
                            </div>
