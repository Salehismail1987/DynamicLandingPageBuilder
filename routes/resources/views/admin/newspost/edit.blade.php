              ...
              <div class="row" id="replicate-action-button">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group action_fields phone_no_sms" style="<?= $detail_info->action_button_link == 'sms' ? 'display:block' : 'display:none' ?>">
                    ...
                    <input type="text" class="myinput2" name="action_button_phone_no_sms1" value="<?= $detail_info->action_button_phone_no_sms ?>">
                  </div>
                  <div class="form-group action_fields action_email" style="<?= $detail_info->action_button_link == 'email' ? 'display:block' : 'display:none' ?>">
                    ...
                    <input type="text" class="myinput2" name="action_button_action_email1" value="<?= $detail_info->action_button_action_email ?>">
                  </div>
                  <div class="form-group action_fields audio_upload" name="feature_action_audio1" style="<?= $detail_info->action_button_link == 'audiofeature' ? 'display:block' : 'display:none' ?>">
                    <label for="customFile">Select File</label>
                    <div class="custom-file">
                  ...
                  <div class="form-group action_fields action_link" style="<?= $detail_info->action_button_link == 'link' ? 'display:block' : 'display:none' ?>">
                    <input type="text" class="myinput2 news_post_link" name="action_button_link_text1" id="news_post_link" value="<?= $detail_info->action_button_link_text ?>" placeholder="http://google.com">
                  </div>
                  <div class="form-group action_fields action_forms" style="<?= $detail_info->action_button_link == 'customforms' ? 'display:block' : 'display:none' ?>">
                    <select class="myinput2 customforms" name="action_button_customform1">
                  ...
                  <div class=" action_fields action_map" style="<?= $detail_info->btn_section == 'google_map' ? 'display:block' : 'display:none' ?>">
                    <div class="form-group ">
                      ...
                      <input type="text" class="myinput2 " name="action_button_map_address1" value="<?= isset($detail_info->action_button_map_address) && $detail_info->action_button_map_address ? $detail_info->action_button_map_address : '' ?>" placeholder=" 105 Krome Ave, Miami, FL, 3700 USA">
                    </div>
                  </div>
                  <div class="form-group action_fields action_address" style="<?= $detail_info->action_button_link == 'address' ? 'display:block' : 'display:none' ?>">
                    ...
                    <select name="action_button_address_id1" class="myinput2">
                  ...
                  <div class="col-md-6 col-sm-12 p-0">
                    <div class="form-group">
                      <div class="form-group quilleditor-div action_fields  action_textpopup" style="<?= $detail_info->action_button_link == 'text_popup' ? 'display:block' : 'display:none' ?>">
                        ...
                        <textarea class="myinput2 editordata hidden" name="action_button_textpopup1"><?php echo $detail_info->action_button_textpopup; ?></textarea>
                        <div class="quilleditor">
