...
<div id="headersection">
                        ...
                        <div class="header-alternative-content" >
                                ...
                                <div class="frame0">
                                    <?php 
                                        ...
                                        if(isset($_GET['editwebsite'])){
                                            $backDashboard = '
                                                    <div class="back-dashboard-div">
                                                        <a href="'.url('quicksettings?block=header_images_bluebar').'" target="_blank">
                                                            <div class="d-flex align-items-center">
                            ...
                            <div class=" pl-50" style="padding-top:1rem">
                                ...
                                if(isset($_GET['editwebsite'])){
                                    $backDashboard = '
                                            <div class="back-dashboard-div">
                                                <a href="'.url('quicksettings?block=action_btns_bluebar').'" target="_blank">
                                                    <div class="d-flex align-items-center">
                            ...
                            <?php 
                                ...
                                if(isset($_GET['editwebsite'])){
                                    $backDashboard = '
                                            <div class="back-dashboard-div">
                                                <a href="'.url('quicksettings?block=header_text_bluebar').'" target="_blank">
                                                    <div class="d-flex align-items-center">
                                    ...
                                    <?php if ($header_phone_text->text) { ?>
                                        <div class="titlefontfamily headertitle">
                                            <?php if ($header_phone_title->text) { ?>
                                                <div class="mb-0 text-bold header-phone-text {{$header_phone_title->slug}}" ><?= $header_phone_title->text ?></div>
                                            <?php } ?>
                                            <h4>
                                ...
                                if(isset($_GET['editwebsite'])){
                                    $backDashboard = '
                                            <div class="back-dashboard-div">
                                                <a href="'.url('businessinfo?block=social_media').'" target="_blank">
                                                    <div class="d-flex align-items-center">
    ...
    <?php } else { ?>
        <div class="row myrow nopadding" style="margin-left: 0px">
                            ...
                            <ul>
                                @foreach ($navBarItems as $navBarItem)
                                    ...
                                    <li>
                                        ...
                                        target="<?= $target ?>" <?=$popupform?> class="my-nav-bar-item-{{$navBarItem->id}} {{$class}} {{$audioclass}}" style=''>
                                            {{$navBarItem->text}} 
                                        </a>
                                    </li>
                                @endforeach
            ...
            @endif
                <?php if (count($header_slider->toArray()) > 0) {
                    $active = 'active'; ?>
                            ...
                            @endif
                                ...
                                @else
                                    ...
                                    <div id="myCarousel" class="carousel slide headerslider <?= check_feature_enable_disable('headerslider') ? '' : 'hidden' ?>" data-ride="carousel" <?php if($headerImages->is_autoplay=='0'){ ?>data-interval="false"<?php } ?>>
                                        <!-- Wrapper for slides -->
