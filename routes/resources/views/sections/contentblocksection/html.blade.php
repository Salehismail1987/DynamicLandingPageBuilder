                          ...
                          ?>
                            <div class="col-md-12 " style="margin-top:10px;">
                              ...
                              if ($single->action_button_link == 'link') {
                                ...
                                $input_link = '#';
                                $target = "";
                                $popupform = 'data-toggle="modal" data-target="#modalcustomforms' . getCustomformEncodedID($single->action_button_custom_forms ). '"';
                              ...
                              <?php if($single->action_button_link == "audioiconfeature" && isset($single->action_button_audio_icon_feature)) { ?>
                                <span  onclick="playPauseAudio('contentAudio_<?=$single->id ?>')" class="desc-text-font-<?=$single->id?>">
                                  <span>
                                  ...
                                  <a href="<?= $input_link ?>" 
                                    ...
                                    <?php if($single->action_button_link == "video"){?> data-toggle="<?= $data_toggle ?>" data-target="<?= $data_target ?>" id="<?= $single->id . 'contentVideo' ?>" onclick="openVideo('<?= $single->id . 'contentVideo' ?>')" <?php }?>
                                    <?= isset($single->action_button_action_audio) && $single->action_button_link == "audiofeature" ?'onclick=playPauseAudio("contentAudio_'.$single->id.'")':(isset($single->action_button_audio_icon_feature) && $single->action_button_link == 'audioiconfeature'? 'onclick=playPauseAudio("contentAudio_'.$single->id.'")':'') ?> target="<?= $target ?>" <?= $popupform ?> class="btn btn-default text-bold new-action-btn action-button-content-{{$single->id}} {{$class}} {{$videoclass}} {{$audioclass}}" style=""><?= $single->action_button_discription ?></a>
                                ...
                                <?php }else{ ?>
                                  ...
                                  <a href="<?= $input_link ?>" 
                                  id="<?= $single->id . 'contentVideo' ?>"
                                  
                                  <?php if($single->action_button_link == 'text_popup'){ ?> 
                                    onclick="openPopupText('actCBText<?=$single->id?>')" 
                                  <?php }?>
                                  
                                
                                  <?php if($single->action_button_link == "video"){?>   data-toggle="<?= $data_toggle ?>" data-target="<?= $data_target ?>" onclick="openVideo('<?= $single->id . 'contentVideo' ?>')" <?php }?>
                                  <?= isset($single->action_button_action_audio) && $single->action_button_link == "audiofeature"?'onclick=playPauseAudio("contentAudio_'.$single->id.'")':'' ?> target="<?= $target ?>" <?= $popupform ?> class="btn btn-default text-bold new-action-btn action-button-content-{{$single->id}} {{$class}} {{$videoclass}} {{$audioclass}}" style=""><?= $single->action_button_discription ?></a>
