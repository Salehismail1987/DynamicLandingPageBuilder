                      ...
                      <?php 
                        if ($single->left_action_button_active == '1' && $single->left_action_button_name!='') {
                            ...
                            if ($single->left_action_button_link == 'link') {
                                ...
                                $popupform = 'data-toggle="modal" data-target="#modalcustomforms'.getCustomformEncodedID($single->left_action_button_customform).'"';
                        ...
                        <?php if(isset($single->left_audio_icon_file)) { ?>
                          <div onclick="playPauseAudio('contentAudioleft_'+<?=$single->id ?>)" style="<?php echo 'color:' . ($single->left_action_button_text_color ? $single->left_action_button_text_color . ';margin-top:6px;' : '#000;'); ?>">
                      ...
                      <?php 
                        if ($single->right_action_button_active == '1' && $single->right_action_button_name!='') {
                            ...
                            if ($single->right_action_button_link == 'link') {
                                ...
                                $popupform = 'data-toggle="modal" data-target="#modalcustomforms'.getCustomformEncodedID($single->right_action_button_customform).'"';
                                ...
                                <div>
                                  ...
                                  <?php if($single->right_action_button_link == "video"){?>  onclick="openVideo('<?= $single->id . 'videoright' ?>')" <?php }?> href="<?= $input_link ?>" >
